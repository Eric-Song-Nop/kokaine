...
// monadic lift
export function task_payload_fs__mlift_copy_10424(_this, payload_label, payload_portal, _c_x10143) /* forall<a,e> (task-payload<a,e>, payload-label : ? string, payload-portal : ? (kokaine/reactive/integration/internal/reentry/reentry<<ui|e>>), taskresume<e,a>) -> task-payload<a,e> */  {
  ...
  return Task_payload(_x2, _c_x10143, _x3);
}
...
export function task_payload_fs__copy(_this, payload_portal, payload_resume, payload_label) /* forall<a,e> (task-payload<a,e>, payload-portal : ? (kokaine/reactive/integration/internal/reentry/reentry<<ui|e>>), payload-resume : ? (taskresume<e,a>), payload-label : ? string) -> task-payload<a,e> */  {
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(_c_x10143 /* taskresume<613,612> */ ) {
      if (payload_portal !== undefined) {
      ...
      return Task_payload(_x4, _c_x10143, _x5);
    });
  }
  else {
    if (payload_portal !== undefined) {
...
// monadic lift
export function runtime_supervisor_fs__mlift_detach_10425(_c_x10147) /* (bool) -> () */  {
  return $std_core_types.Unit;
}
 
 
// monadic lift
export function runtime_supervisor_fs__mlift_detach_10426(supervisor, _c_x10148) /* forall<_e,_e1,e2> (supervisor : runtime-supervisor<e2>, ()) -> () */  {
...
export function runtime_supervisor_fs_detach(supervisor) /* forall<e> (supervisor : runtime-supervisor<e>) -> () */  {
  ...
  if (owner === null) {
    var x_10476 = $std_core_types.Unit;
  }
  else {
    ...
    if (_x37 === null) {
      ...
      var x_0_10479 = (maybe_10016 !== null);
    }
    if ($std_core_hnd._yielding()) {
      var x_10476 = $std_core_hnd.yield_extend(runtime_supervisor_fs__mlift_detach_10425);
    }
    else {
      var x_10476 = $std_core_types.Unit;
    }
  ...
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(_c_x10148 /* () */ ) {
      return runtime_supervisor_fs__mlift_detach_10426(supervisor, _c_x10148);
    });
  }
  else {
...
export function runtime_supervisor_fs_claim(supervisor, reason) /* forall<e> (supervisor : runtime-supervisor<e>, reason : kokaine/async/internal/one-shot-task/task-stop-reason) -> list<task-cancellation> */  {
  ...
  var _x33 = $kokaine_async_internal_cancellation_dash_supervisor.cancellation_supervisor_fs_claim_cancel(_x34);
  if (_x33 === null) {
...
// monadic lift
export function _mlift_new_runtime_supervisor_10427(supervisor, index_registration) /* forall<_e,e1> (supervisor : runtime-supervisor<e1>, index-registration : kokaine/internal/int-index/int-index-registration<runtime-supervisor<e1>>) -> <exn,div,kokaine/reactive/effects/signal-write,ui|e1> runtime-supervisor<e1> */  {
   
  var target_2_10299 = $std_core_hnd._open_none1(function(_this_3 /* runtime-supervisor<2571> */ ) {
      return _this_3.supervisor_index;
    }, supervisor);
   
  ((target_2_10299).value = ($std_core_types.Just(index_registration)));
  return supervisor;
}
 
 
// monadic lift
export function _mlift_new_runtime_supervisor_10428(family, scope, supervisor, family_registration) /* forall<_e,e1> (family : async-family<e1>, scope : kokaine/async/effects/async-scope, supervisor : runtime-supervisor<e1>, family-registration : kokaine/internal/registry/registry-registration<runtime-supervisor<e1>>) -> <exn,div,kokaine/reactive/effects/signal-write,ui|e1> runtime-supervisor<e1> */  {
   
  var target_1_10293 = $std_core_hnd._open_none1(function(_this_1 /* runtime-supervisor<2571> */ ) {
      return _this_1.supervisor_family;
    }, supervisor);
   
  ((target_1_10293).value = ($std_core_types.Just(family_registration)));
   
  var _x_x1_7_10371 = $std_core_hnd._open_none1(function(_this_2 /* async-family<2571> */ ) {
      return _this_2.family_index;
    }, family);
   
  var _x_x2_3_10372 = $std_core_hnd._open_none1(function(scope_0 /* kokaine/async/effects/async-scope */ ) {
  ...
  var x_1_10487 = $std_core_hnd._open_at3($std_core_hnd._evv_index($std_core_exn.exn_fs__tag), $kokaine_internal_int_dash_index.int_index_fs_insert, _x_x1_7_10371, _x_x2_3_10372, supervisor);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(index_registration /* kokaine/internal/int-index/int-index-registration<runtime-supervisor<2571>> */ ) {
      return _mlift_new_runtime_supervisor_10427(supervisor, index_registration);
    });
  }
  else {
    return _mlift_new_runtime_supervisor_10427(supervisor, x_1_10487);
  }
}
 
 
// monadic lift
export function _mlift_new_runtime_supervisor_10429(family, scope, supervisor, owner) /* forall<_e,e1> (family : async-family<e1>, scope : kokaine/async/effects/async-scope, supervisor : runtime-supervisor<e1>, owner : kokaine/reactive/internal/model/cleanup-registration<<ui|e1>>) -> <exn,div,kokaine/reactive/effects/signal-write,ui|e1> runtime-supervisor<e1> */  {
   
  var target_10287 = $std_core_hnd._open_none1(function(_this /* runtime-supervisor<2571> */ ) {
      return _this.supervisor_owner;
    }, supervisor);
   
  ((target_10287).value = ($std_core_types.Just(owner)));
   
  var _x_x1_3_10367 = $std_core_hnd._open_none1(function(_this_0 /* async-family<2571> */ ) {
      return _this_0.family_supervisors;
    }, family);
   
  var x_10489 = $std_core_hnd._open_at2($std_core_hnd._evv_index($std_core_exn.exn_fs__tag), function(target_0 /* kokaine/internal/registry/registry<runtime-supervisor<2571>> */ , value_4 /* runtime-supervisor<2571> */ ) {
  ...
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(family_registration /* kokaine/internal/registry/registry-registration<runtime-supervisor<2571>> */ ) {
      return _mlift_new_runtime_supervisor_10428(family, scope, supervisor, family_registration);
    });
  }
  else {
    return _mlift_new_runtime_supervisor_10428(family, scope, supervisor, x_10489);
  }
}
...
export function new_runtime_supervisor(root, family, scope) /* forall<e> (root : kokaine/reactive/internal/model/root<<ui|e>>, family : async-family<e>, scope : kokaine/async/effects/async-scope) -> <kokaine/reactive/effects/signal-write,pure,ui|e> runtime-supervisor<e> */  {
  ...
  var x_10491 = $std_core_hnd._open_at2($std_core_hnd._evv_index($std_core_exn.exn_fs__tag), $kokaine_reactive_internal_runtime.register_cleanup, root, function() {
       
      var actions_0 = $std_core_hnd._open_none2(function(supervisor_0 /* runtime-supervisor<2571> */ , reason /* kokaine/async/internal/one-shot-task/task-stop-reason */ ) {
           
          var _x35 = supervisor_0.supervisor_reason;
          ((_x35).value = reason);
          var _x36 = supervisor_0.supervisor_tasks;
          var _x35 = $kokaine_async_internal_cancellation_dash_supervisor.cancellation_supervisor_fs_claim_cancel(_x36);
          if (_x35 === null) {
            return $std_core_types.Nil;
          }
          else {
  ...
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(owner /* kokaine/reactive/internal/model/cleanup-registration<<ui|2571>> */ ) {
      return _mlift_new_runtime_supervisor_10429(family, scope, supervisor, owner);
    });
  }
  else {
    ...
    ((target_10287).value = ($std_core_types.Just(x_10491)));
     
    var _x_x1_3_10367 = $std_core_hnd._open_none1(function(_this_0 /* async-family<2571> */ ) {
        return _this_0.family_supervisors;
      }, family);
     
    var x_0_10496 = $std_core_hnd._open_at2($std_core_hnd._evv_index($std_core_exn.exn_fs__tag), function(target_0 /* kokaine/internal/registry/registry<runtime-supervisor<2571>> */ , value_4 /* runtime-supervisor<2571> */ ) {
        var _x35 = $std_core_hnd._open_none2($kokaine_internal_registry.registry_fs_try_insert, target_0, value_4);
        if (_x35 === null) {
          return $std_core_exn.$throw("cannot register with a sealed lifetime registry");
        }
    ...
    if ($std_core_hnd._yielding()) {
      ...
      ((target_1_10293).value = ($std_core_types.Just(x_0_10496)));
      ...
      var x_2_10499 = $std_core_hnd._open_at3($std_core_hnd._evv_index($std_core_exn.exn_fs__tag), $kokaine_internal_int_dash_index.int_index_fs_insert, _x_x1_7_10371, _x_x2_3_10372, supervisor);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(index_registration /* kokaine/internal/int-index/int-index-registration<runtime-supervisor<2571>> */ ) {
          return _mlift_new_runtime_supervisor_10427(supervisor, index_registration);
        });
        ...
        ((target_2_10299).value = ($std_core_types.Just(x_2_10499)));
        return supervisor;
      }
    }
  }
...
export function runtime_fs_supervisor(runtime, root, scope) /* forall<e> (runtime : generation-runtime<e>, root : kokaine/reactive/internal/model/root<<ui|e>>, scope : kokaine/async/effects/async-scope) -> <kokaine/reactive/effects/signal-write,pure,ui|e> runtime-supervisor<e> */  {
  ...
  var _x_x1_0_10378 = $std_core_hnd._open_none1(function(_this_0 /* async-family<2635> */ ) {
      return _this_0.family_index;
    }, family);
   
  var _x_x2_10379 = $std_core_hnd._open_none1(function(scope_0 /* kokaine/async/effects/async-scope */ ) {
      var _x36 = (scope_0.ids !== null) ? scope_0.ids.head : 0;
      var _x35 = $std_core_types._int_eq(_x36,0);
      if (_x35) {
        return scope_0.scope_namespace;
  ...
  var _x35 = $std_core_hnd._open_none2($kokaine_internal_int_dash_index.int_index_fs_lookup, _x_x1_0_10378, _x_x2_10379);
  if (_x35 !== null) {
    return _x35.value;
  }
  else {
...
export function task_fs_detach_cancellation(task) /* forall<a,e> (task : generation-task<a,e>) -> () */  {
  ...
  var _x36 = $std_core_types._int_le(($kokaine_async_internal_cancellation_dash_supervisor.cancellation_supervisor_fs_count(_x37)),0);
  if (_x36) {
...
// monadic lift
export function _mlift_claim_scope_supervisors_loop_10430(collected, _c_x10159) /* (collected : list<task-cancellation>, list<task-cancellation>) -> list<task-cancellation> */  {
  return reverse_cancellations_onto(_c_x10159, collected);
}
 
 
// monadic lift
export function _mlift_claim_scope_supervisors_loop_10431(collected_0, _c_x10160) /* (collected : list<task-cancellation>, list<task-cancellation>) -> list<task-cancellation> */  {
  return reverse_cancellations_onto(_c_x10160, collected_0);
}
 
 
// monadic lift
export function _mlift_claim_scope_supervisors_loop_10432(include_all, rest, scope, _c_x10162) /* forall<e> (include-all : bool, rest : list<runtime-supervisor<e>>, scope : kokaine/async/effects/async-scope, list<task-cancellation>) -> list<task-cancellation> */  {
  return claim_scope_supervisors_loop(rest, scope, include_all, _c_x10162);
}
...
export function claim_scope_supervisors_loop(supervisors, scope_0, include_all_0, collected_1) /* forall<e> (supervisors : list<runtime-supervisor<e>>, scope : kokaine/async/effects/async-scope, include-all : bool, collected : list<task-cancellation>) -> div list<task-cancellation> */  { tailcall: while(1)
{
  if (supervisors === null) {
    ...
    if (include_all_0) {
      ...
      ((_x40).value = ($kokaine_async_internal_one_dash_shot_dash_task.Task_canceled));
       
      var _x42 = supervisors.head.supervisor_tasks;
      var _x41 = $kokaine_async_internal_cancellation_dash_supervisor.cancellation_supervisor_fs_claim_cancel(_x42);
      if (_x41 === null) {
        var x_0_10505 = $std_core_types.Nil;
      }
      else {
         
        runtime_supervisor_fs_detach(supervisors.head);
        var x_0_10505 = _x41.value;
      }
      if ($std_core_hnd._yielding()) {
        var x_10502 = $std_core_hnd.yield_extend(function(_c_x10159_0 /* list<task-cancellation> */ ) {
          return _mlift_claim_scope_supervisors_loop_10430(collected_1, _c_x10159_0);
        });
      }
      else {
        var x_10502 = _mlift_claim_scope_supervisors_loop_10430(collected_1, x_0_10505);
      }
    }
    else {
      ...
      if (_x40) {
        ...
        ((_x42).value = ($kokaine_async_internal_one_dash_shot_dash_task.Task_canceled));
         
        var _x44 = supervisors.head.supervisor_tasks;
        var _x43 = $kokaine_async_internal_cancellation_dash_supervisor.cancellation_supervisor_fs_claim_cancel(_x44);
        if (_x43 === null) {
          var x_1_10507 = $std_core_types.Nil;
        }
        else {
           
          runtime_supervisor_fs_detach(supervisors.head);
          var x_1_10507 = _x43.value;
        }
        if ($std_core_hnd._yielding()) {
          var x_10502 = $std_core_hnd.yield_extend(function(_c_x10160_0 /* list<task-cancellation> */ ) {
            return _mlift_claim_scope_supervisors_loop_10431(collected_1, _c_x10160_0);
          });
        }
        else {
          var x_10502 = _mlift_claim_scope_supervisors_loop_10431(collected_1, x_1_10507);
        }
      }
      else {
        var x_10502 = collected_1;
      }
    }
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_c_x10162_0 /* list<task-cancellation> */ ) {
        return _mlift_claim_scope_supervisors_loop_10432(include_all_0, supervisors.tail, scope_0, _c_x10162_0);
      });
    }
    else {
      {
...
// monadic lift
export function _mlift_cancel_runtime_scope_10433(actions) /* forall<e> (actions : list<task-cancellation>) -> <div,ui,exn,kokaine/reactive/effects/signal-write|e> () */  {
...
export function cancel_runtime_scope(runtime, scope) /* forall<e> (runtime : generation-runtime<e>, scope : kokaine/async/effects/async-scope) -> <kokaine/reactive/effects/signal-write,pure,ui|e> () */  {
  ...
  var _x_x1_2_10388 = $std_core_hnd._open_none1(function(_this_0 /* async-family<3143> */ ) {
      return _this_0.family_supervisors;
    }, family);
   
  var _x_x1_1_10385 = $std_core_hnd._open_none1($kokaine_internal_registry.registry_fs_snapshot, _x_x1_2_10388);
   
  var _x_x2_1_10391 = $std_core_hnd._open_none1(function(_this_1 /* async-family<3143> */ ) {
      return _this_1.family_root_scope;
    }, family);
   
  var _x_x3_10387 = $std_core_hnd._open_none2($kokaine_async_effects.async_scope_fs__lp__eq__eq__rp_, scope, _x_x2_1_10391);
   
  var x_10511 = $std_core_hnd._open_none3(function(supervisors /* list<runtime-supervisor<3143>> */ , scope_0 /* kokaine/async/effects/async-scope */ , include_all /* bool */ ) {
      return claim_scope_supervisors_loop(supervisors, scope_0, include_all, $std_core_types.Nil);
    }, _x_x1_1_10385, scope, _x_x3_10387);
  if ($std_core_hnd._yielding()) {
...
// monadic lift
export function _mlift_register_owned_disposer_10434(disposer_slot, _c_x10168) /* forall<_e,_e1> (disposer-slot : ref<global,maybe<kokaine/async/effects/dispose-fn>>, bool) -> bool */  {
  if (_c_x10168) {
...
// monadic lift
export function _mlift_register_owned_disposer_10435(committed, disposer_slot, registration) /* forall<_e,_e1,e2> (committed : ref<global,bool>, disposer-slot : ref<global,maybe<kokaine/async/effects/dispose-fn>>, registration : kokaine/reactive/internal/model/cleanup-registration<<ui|e2>>) -> <exn,ui,div,kokaine/reactive/effects/signal-write|e2> (() -> ui bool) */  {
  ...
  return function() {
    ...
    if (_x40 === null) {
      ...
      var x_10516 = (maybe_10016 !== null);
    }
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_c_x10168 /* bool */ ) {
        return _mlift_register_owned_disposer_10434(disposer_slot, _c_x10168);
      });
    }
    else {
      return _mlift_register_owned_disposer_10434(disposer_slot, x_10516);
    }
  };
}
...
export function register_owned_disposer(root, dispose) /* forall<e> (root : kokaine/reactive/internal/model/root<<ui|e>>, dispose : kokaine/async/effects/dispose-fn) -> <kokaine/reactive/effects/signal-write,pure,ui|e> kokaine/async/effects/ownership-release-fn */  {
  ...
  var x_10520 = $std_core_hnd._open_at2($std_core_hnd._evv_index($std_core_exn.exn_fs__tag), $kokaine_reactive_internal_runtime.register_cleanup, root, function() {
  ...
  if ($std_core_hnd._yielding()) {
    var _x41 = $std_core_hnd.yield_extend(function(registration /* kokaine/reactive/internal/model/cleanup-registration<<ui|3357>> */ ) {
      return _mlift_register_owned_disposer_10435(committed, disposer_slot, registration);
    });
  }
  else {
    var _x41 = _mlift_register_owned_disposer_10435(committed, disposer_slot, x_10520);
  }
  return $std_core_hnd.finally_prompt(function() {
...
// monadic lift
export function _mlift_register_task_10436(family_0, setup, task_0, cancellation) /* forall<_e,_e1,a,e2> (family@0 : async-family<e2>, setup : kokaine/async/effects/await-setup<a>, task@0 : generation-task<a,e2>, cancellation : kokaine/async/internal/cancellation-supervisor/cancellation-registration<task-cancellation>) -> <exn,div,ui,kokaine/reactive/effects/signal-write|e2> () */  {
   
  var target_10334 = $std_core_hnd._open_none1(function(_this_2 /* generation-task<5491,5492> */ ) {
      return _this_2.task_cancel;
    }, task_0);
   
  ((target_10334).value = ($std_core_types.Just(cancellation)));
  ...
  var _x42 = $std_core_hnd._open_none1(setup, function(result_0 /* kokaine/async/effects/await-result<5491> */ ) {
      return accept_task_result(task_0, family_0, result_0);
    });
  if (_x42._tag === 1) {
    return $std_core_hnd._open_none3(accept_task_result, task_0, family_0, $kokaine_async_effects.Exception(_x42.error));
  }
  else {
     
    var _x_x1_8_10408 = $std_core_hnd._open_none1(function(_this_3 /* generation-task<5491,5492> */ ) {
        return _this_3.task_state;
      }, task_0);
    var _x43 = $std_core_hnd._open_none2($kokaine_async_internal_one_dash_shot_dash_task.one_shot_task_fs_install_disposer, _x_x1_8_10408, _x42.value);
    if (_x43 === null) {
      return $std_core_types.Unit;
    }
    else {
...
export function _mlift_register_task_10437(family_0_0, label, portal, resume_action, setup_0, supervisor) /* forall<_e,_e1,_e2,a,e3> (family@0 : async-family<e3>, label : string, portal : kokaine/reactive/integration/internal/reentry/reentry<<ui|e3>>, resume-action : (kokaine/async/effects/await-result<a>) -> <kokaine/async/effects/async,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,pure,ui|e3> (), setup : kokaine/async/effects/await-setup<a>, supervisor : runtime-supervisor<e3>) -> <kokaine/reactive/effects/signal-write,pure,ui|e3> () */  {
  ...
  var _x_x1_3_10400 = $std_core_hnd._open_none1(function(_this_1 /* runtime-supervisor<5492> */ ) {
      return _this_1.supervisor_tasks;
    }, supervisor);
   
  var x_10522 = $std_core_hnd._open_at2($std_core_hnd._evv_index($std_core_exn.exn_fs__tag), $kokaine_async_internal_cancellation_dash_supervisor.cancellation_supervisor_fs_register, _x_x1_3_10400, function() {
      return task_fs_claim_stop(task_0_0, family_0_0);
    });
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(cancellation_0 /* kokaine/async/internal/cancellation-supervisor/cancellation-registration<task-cancellation> */ ) {
      return _mlift_register_task_10436(family_0_0, setup_0, task_0_0, cancellation_0);
    });
  }
  else {
    return _mlift_register_task_10436(family_0_0, setup_0, task_0_0, x_10522);
  }
}
 
 
// monadic lift
export function _mlift_register_task_10438(label_0, resume_action_0, root, runtime, scope, setup_1, portal_0) /* forall<_e,_e1,_e2,a,e3> (label : string, resume-action : (kokaine/async/effects/await-result<a>) -> <kokaine/async/effects/async,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,pure,ui|e3> (), root : kokaine/reactive/internal/model/root<<ui|e3>>, runtime : generation-runtime<e3>, scope : kokaine/async/effects/async-scope, setup : kokaine/async/effects/await-setup<a>, portal : kokaine/reactive/integration/internal/reentry/reentry<<ui|e3>>) -> <exn,div,kokaine/reactive/effects/signal-write,ui|e3> () */  {
   
  var family_0_1 = $std_core_hnd._open_none1(function(_this_0 /* generation-runtime<5492> */ ) {
      return _this_0;
    }, runtime);
   
  var x_0_10524 = runtime_fs_supervisor(runtime, root, scope);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(supervisor_0 /* runtime-supervisor<5492> */ ) {
      return _mlift_register_task_10437(family_0_1, label_0, portal_0, resume_action_0, setup_1, supervisor_0);
    });
  }
  else {
    return _mlift_register_task_10437(family_0_1, label_0, portal_0, resume_action_0, setup_1, x_0_10524);
  }
}
 
 
// monadic lift
export function _mlift_register_task_10439(label_1, resume_action_1, root_0, runtime_0, scope_0, setup_2, wild__) /* forall<_e,_e1,_e2,a,e3> (label : string, resume-action : (kokaine/async/effects/await-result<a>) -> <kokaine/async/effects/async,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,pure,ui|e3> (), root : kokaine/reactive/internal/model/root<<ui|e3>>, runtime : generation-runtime<e3>, scope : kokaine/async/effects/async-scope, setup : kokaine/async/effects/await-setup<a>, wild_ : ()) -> <exn,div,kokaine/reactive/effects/signal-write,ui|e3> () */  {
   
  var x_1_10526 = $std_core_hnd._open_at1($std_core_hnd._evv_index($std_core_exn.exn_fs__tag), $kokaine_reactive_integration_internal_reentry.capture_reentry, root_0);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(portal_1 /* kokaine/reactive/integration/internal/reentry/reentry<<ui|5492>> */ ) {
      return _mlift_register_task_10438(label_1, resume_action_1, root_0, runtime_0, scope_0, setup_2, portal_1);
    });
  }
  else {
    return _mlift_register_task_10438(label_1, resume_action_1, root_0, runtime_0, scope_0, setup_2, x_1_10526);
  }
}
 
 
// monadic lift
export function _mlift_interpret_generation_await_10440(label_0_0, rcontext, root_0_0, runtime_0_0, scope_0_0, setup_0_0, _y_x10185) /* forall<a,e> (label@0 : string, rcontext : hnd/resume-context<kokaine/async/effects/await-result<a>,<kokaine/async/effects/async-cancel,kokaine/async/effects/async-ioc,kokaine/async/effects/async-ownership,kokaine/async/effects/discontinue,div,exn,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui|e>,<kokaine/async/effects/async-await,kokaine/async/effects/async-cancel,kokaine/async/effects/async-ioc,kokaine/async/effects/async-ownership,kokaine/async/effects/discontinue,div,exn,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui|e>,()>, root@0 : kokaine/reactive/internal/model/root<<ui|e>>, runtime@0 : generation-runtime<e>, scope@0 : kokaine/async/effects/async-scope, setup@0 : kokaine/async/effects/await-setup<a>, hnd/ev-index) -> <kokaine/reactive/effects/signal-read,div,exn,kokaine/reactive/effects/signal-write,ui|e> () */  {
  return $std_core_hnd._mask_at(_y_x10185, false, function() {
      return register_task(root_0_0, runtime_0_0, scope_0_0, label_0_0, setup_0_0, function(result_1 /* kokaine/async/effects/await-result<3898> */ ) {
...
// monadic lift
export function _mlift_interpret_generation_await_10441(family_1, label_0_1, rcontext_0, root_0_1, runtime_0_1, scope_0_1, setup_0_1, _y_x10182) /* forall<a,e> (family@1 : async-family<e>, label@0 : string, rcontext : hnd/resume-context<kokaine/async/effects/await-result<a>,<kokaine/async/effects/async-cancel,kokaine/async/effects/async-ioc,kokaine/async/effects/async-ownership,kokaine/async/effects/discontinue,div,exn,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui|e>,<kokaine/async/effects/async-await,kokaine/async/effects/async-cancel,kokaine/async/effects/async-ioc,kokaine/async/effects/async-ownership,kokaine/async/effects/discontinue,div,exn,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui|e>,()>, root@0 : kokaine/reactive/internal/model/root<<ui|e>>, runtime@0 : generation-runtime<e>, scope@0 : kokaine/async/effects/async-scope, setup@0 : kokaine/async/effects/await-setup<a>, hnd/ev-index) -> <kokaine/async/effects/discontinue,div,exn,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui|e> () */  {
  return $std_core_hnd._mask_at(_y_x10182, false, function() {
      ...
      if (_x44) {
        ...
        var x_2_10528 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_read_fs__tag);
        if ($std_core_hnd._yielding()) {
          return $std_core_hnd.yield_extend(function(_y_x10185_0 /* hnd/ev-index */ ) {
            return _mlift_interpret_generation_await_10440(label_0_1, rcontext_0, root_0_1, runtime_0_1, scope_0_1, setup_0_1, _y_x10185_0);
          });
        }
        else {
          return _mlift_interpret_generation_await_10440(label_0_1, rcontext_0, root_0_1, runtime_0_1, scope_0_1, setup_0_1, x_2_10528);
        }
      }
    });
}
...
// monadic lift
export function _mlift_interpret_generation_await_10442(family_1_0, label_0_2, rcontext_1, root_0_2, runtime_0_2, scope_0_2, setup_0_2, _y_x10181) /* forall<a,e> (family@1 : async-family<e>, label@0 : string, rcontext : hnd/resume-context<kokaine/async/effects/await-result<a>,<kokaine/async/effects/async-cancel,kokaine/async/effects/async-ioc,kokaine/async/effects/async-ownership,kokaine/async/effects/discontinue,div,exn,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui|e>,<kokaine/async/effects/async-await,kokaine/async/effects/async-cancel,kokaine/async/effects/async-ioc,kokaine/async/effects/async-ownership,kokaine/async/effects/discontinue,div,exn,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui|e>,()>, root@0 : kokaine/reactive/internal/model/root<<ui|e>>, runtime@0 : generation-runtime<e>, scope@0 : kokaine/async/effects/async-scope, setup@0 : kokaine/async/effects/await-setup<a>, hnd/ev-index) -> <kokaine/async/effects/async-ownership,kokaine/async/effects/discontinue,div,exn,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui|e> () */  {
  return $std_core_hnd._mask_at(_y_x10181, false, function() {
       
      var x_3_10530 = $std_core_hnd._evv_index($kokaine_async_effects.discontinue_fs__tag);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_y_x10182_0 /* hnd/ev-index */ ) {
          return _mlift_interpret_generation_await_10441(family_1_0, label_0_2, rcontext_1, root_0_2, runtime_0_2, scope_0_2, setup_0_2, _y_x10182_0);
        });
      }
      else {
        return _mlift_interpret_generation_await_10441(family_1_0, label_0_2, rcontext_1, root_0_2, runtime_0_2, scope_0_2, setup_0_2, x_3_10530);
      }
    });
}
...
// monadic lift
export function _mlift_interpret_generation_await_10443(family_1_1, label_0_3, rcontext_2, root_0_3, runtime_0_3, scope_0_3, setup_0_3, _y_x10180) /* forall<a,e> (family@1 : async-family<e>, label@0 : string, rcontext : hnd/resume-context<kokaine/async/effects/await-result<a>,<kokaine/async/effects/async-cancel,kokaine/async/effects/async-ioc,kokaine/async/effects/async-ownership,kokaine/async/effects/discontinue,div,exn,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui|e>,<kokaine/async/effects/async-await,kokaine/async/effects/async-cancel,kokaine/async/effects/async-ioc,kokaine/async/effects/async-ownership,kokaine/async/effects/discontinue,div,exn,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui|e>,()>, root@0 : kokaine/reactive/internal/model/root<<ui|e>>, runtime@0 : generation-runtime<e>, scope@0 : kokaine/async/effects/async-scope, setup@0 : kokaine/async/effects/await-setup<a>, hnd/ev-index) -> <kokaine/async/effects/async-ioc,kokaine/async/effects/async-ownership,kokaine/async/effects/discontinue,div,exn,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui|e> () */  {
  return $std_core_hnd._mask_at(_y_x10180, false, function() {
       
      var x_4_10532 = $std_core_hnd._evv_index($kokaine_async_effects.async_ownership_fs__tag);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_y_x10181_0 /* hnd/ev-index */ ) {
          return _mlift_interpret_generation_await_10442(family_1_1, label_0_3, rcontext_2, root_0_3, runtime_0_3, scope_0_3, setup_0_3, _y_x10181_0);
        });
      }
      else {
        return _mlift_interpret_generation_await_10442(family_1_1, label_0_3, rcontext_2, root_0_3, runtime_0_3, scope_0_3, setup_0_3, x_4_10532);
      }
    });
}
...
// monadic lift
export function _mlift_interpret_generation_await_10444(family_1_2, label_0_4, rcontext_3, root_0_4, runtime_0_4, scope_0_4, setup_0_4, _y_x10179) /* forall<a,e> (family@1 : async-family<e>, label@0 : string, rcontext : hnd/resume-context<kokaine/async/effects/await-result<a>,<kokaine/async/effects/async-cancel,kokaine/async/effects/async-ioc,kokaine/async/effects/async-ownership,kokaine/async/effects/discontinue,div,exn,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui|e>,<kokaine/async/effects/async-await,kokaine/async/effects/async-cancel,kokaine/async/effects/async-ioc,kokaine/async/effects/async-ownership,kokaine/async/effects/discontinue,div,exn,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui|e>,()>, root@0 : kokaine/reactive/internal/model/root<<ui|e>>, runtime@0 : generation-runtime<e>, scope@0 : kokaine/async/effects/async-scope, setup@0 : kokaine/async/effects/await-setup<a>, hnd/ev-index) -> <kokaine/async/effects/async-cancel,kokaine/async/effects/async-ioc,kokaine/async/effects/async-ownership,kokaine/async/effects/discontinue,div,exn,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui|e> () */  {
  return $std_core_hnd._mask_at(_y_x10179, false, function() {
       
      var x_5_10534 = $std_core_hnd._evv_index($kokaine_async_effects.async_ioc_fs__tag);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_y_x10180_0 /* hnd/ev-index */ ) {
          return _mlift_interpret_generation_await_10443(family_1_2, label_0_4, rcontext_3, root_0_4, runtime_0_4, scope_0_4, setup_0_4, _y_x10180_0);
        });
      }
      else {
        return _mlift_interpret_generation_await_10443(family_1_2, label_0_4, rcontext_3, root_0_4, runtime_0_4, scope_0_4, setup_0_4, x_5_10534);
      }
    });
}
...
// monadic lift
export function _mlift_interpret_generation_await_10446(callback_0, label_0_0_1, root_0_6, runtime_0_6, scope_0_0_1, setup_0_0_1, _y_x10197) /* forall<a,e> (callback : (kokaine/async/effects/await-result<a>) -> ui (), label@0@0 : string, root@0 : kokaine/reactive/internal/model/root<<ui|e>>, runtime@0 : generation-runtime<e>, scope@0@0 : kokaine/async/effects/async-scope, setup@0@0 : kokaine/async/effects/await-setup<a>, hnd/ev-index) -> <kokaine/async/effects/discontinue,div,exn,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui|e> () */  {
  return $std_core_hnd._mask_at(_y_x10197, false, function() {
      ...
      if (_x45) {
        ...
        var x_6_10536 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_read_fs__tag);
        if ($std_core_hnd._yielding()) {
          return $std_core_hnd.yield_extend(function(_y_x10198_0 /* hnd/ev-index */ ) {
            return _mlift_interpret_generation_await_10445(callback_0, label_0_0_1, root_0_6, runtime_0_6, scope_0_0_1, setup_0_0_1, _y_x10198_0);
          });
        }
        else {
          return _mlift_interpret_generation_await_10445(callback_0, label_0_0_1, root_0_6, runtime_0_6, scope_0_0_1, setup_0_0_1, x_6_10536);
        }
      }
    });
}
...
// monadic lift
export function _mlift_interpret_generation_await_10447(callback_1, label_0_0_2, root_0_7, runtime_0_7, scope_0_0_2, setup_0_0_2, _y_x10196) /* forall<a,e> (callback : (kokaine/async/effects/await-result<a>) -> ui (), label@0@0 : string, root@0 : kokaine/reactive/internal/model/root<<ui|e>>, runtime@0 : generation-runtime<e>, scope@0@0 : kokaine/async/effects/async-scope, setup@0@0 : kokaine/async/effects/await-setup<a>, hnd/ev-index) -> <kokaine/async/effects/async-ownership,kokaine/async/effects/discontinue,div,exn,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui|e> () */  {
  return $std_core_hnd._mask_at(_y_x10196, false, function() {
       
      var x_7_10538 = $std_core_hnd._evv_index($kokaine_async_effects.discontinue_fs__tag);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_y_x10197_0 /* hnd/ev-index */ ) {
          return _mlift_interpret_generation_await_10446(callback_1, label_0_0_2, root_0_7, runtime_0_7, scope_0_0_2, setup_0_0_2, _y_x10197_0);
        });
      }
      else {
        return _mlift_interpret_generation_await_10446(callback_1, label_0_0_2, root_0_7, runtime_0_7, scope_0_0_2, setup_0_0_2, x_7_10538);
      }
    });
}
...
// monadic lift
export function _mlift_interpret_generation_await_10448(callback_2, label_0_0_3, root_0_8, runtime_0_8, scope_0_0_3, setup_0_0_3, _y_x10195) /* forall<a,e> (callback : (kokaine/async/effects/await-result<a>) -> ui (), label@0@0 : string, root@0 : kokaine/reactive/internal/model/root<<ui|e>>, runtime@0 : generation-runtime<e>, scope@0@0 : kokaine/async/effects/async-scope, setup@0@0 : kokaine/async/effects/await-setup<a>, hnd/ev-index) -> <kokaine/async/effects/async-ioc,kokaine/async/effects/async-ownership,kokaine/async/effects/discontinue,div,exn,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui|e> () */  {
  return $std_core_hnd._mask_at(_y_x10195, false, function() {
       
      var x_8_10540 = $std_core_hnd._evv_index($kokaine_async_effects.async_ownership_fs__tag);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_y_x10196_0 /* hnd/ev-index */ ) {
          return _mlift_interpret_generation_await_10447(callback_2, label_0_0_3, root_0_8, runtime_0_8, scope_0_0_3, setup_0_0_3, _y_x10196_0);
        });
      }
      else {
        return _mlift_interpret_generation_await_10447(callback_2, label_0_0_3, root_0_8, runtime_0_8, scope_0_0_3, setup_0_0_3, x_8_10540);
      }
    });
}
...
// monadic lift
export function _mlift_interpret_generation_await_10449(callback_3, label_0_0_4, root_0_9, runtime_0_9, scope_0_0_4, setup_0_0_4, _y_x10194) /* forall<a,e> (callback : (kokaine/async/effects/await-result<a>) -> ui (), label@0@0 : string, root@0 : kokaine/reactive/internal/model/root<<ui|e>>, runtime@0 : generation-runtime<e>, scope@0@0 : kokaine/async/effects/async-scope, setup@0@0 : kokaine/async/effects/await-setup<a>, hnd/ev-index) -> <kokaine/async/effects/async-cancel,kokaine/async/effects/async-ioc,kokaine/async/effects/async-ownership,kokaine/async/effects/discontinue,div,exn,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui|e> () */  {
  return $std_core_hnd._mask_at(_y_x10194, false, function() {
       
      var x_9_10542 = $std_core_hnd._evv_index($kokaine_async_effects.async_ioc_fs__tag);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_y_x10195_0 /* hnd/ev-index */ ) {
          return _mlift_interpret_generation_await_10448(callback_3, label_0_0_4, root_0_9, runtime_0_9, scope_0_0_4, setup_0_0_4, _y_x10195_0);
        });
      }
      else {
        return _mlift_interpret_generation_await_10448(callback_3, label_0_0_4, root_0_9, runtime_0_9, scope_0_0_4, setup_0_0_4, x_9_10542);
      }
    });
}
...
// monadic lift
export function _mlift_run_generation_async_with_family_10450(host_action, _y_x10209) /* forall<a,e> (host-action : () -> ui a, hnd/ev-index) -> <exn,div,ui|e> a */  {
  return $std_core_hnd._mask_at(_y_x10209, false, host_action);
}
 
 
// monadic lift
export function _mlift_run_generation_async_with_family_10451(host_action_0, _y_x10208) /* forall<a,e> (host-action : () -> ui a, hnd/ev-index) -> <kokaine/reactive/effects/signal-write,div,exn,ui|e> a */  {
  return $std_core_hnd._mask_at(_y_x10208, false, function() {
       
      var x_10_10545 = $std_core_hnd._evv_index($std_core_exn.exn_fs__tag);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_y_x10209_0 /* hnd/ev-index */ ) {
          return _mlift_run_generation_async_with_family_10450(host_action_0, _y_x10209_0);
        });
      }
      else {
        return _mlift_run_generation_async_with_family_10450(host_action_0, x_10_10545);
      }
    });
}
...
// monadic lift
export function _mlift_run_generation_async_with_family_10452(host_action_1, _y_x10207) /* forall<a,e> (host-action : () -> ui a, hnd/ev-index) -> <kokaine/reactive/effects/signal-read,div,exn,kokaine/reactive/effects/signal-write,ui|e> a */  {
  return $std_core_hnd._mask_at(_y_x10207, false, function() {
       
      var x_11_10547 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_write_fs__tag);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_y_x10208_0 /* hnd/ev-index */ ) {
          return _mlift_run_generation_async_with_family_10451(host_action_1, _y_x10208_0);
        });
      }
      else {
        return _mlift_run_generation_async_with_family_10451(host_action_1, x_11_10547);
      }
    });
}
...
// monadic lift
export function _mlift_run_generation_async_with_family_10453(host_action_0_0, root_1, runtime_1, scope_1, _y_x10214) /* forall<e> (host-action@0 : () -> ui (), root@1 : kokaine/reactive/internal/model/root<<ui|e>>, runtime@1 : generation-runtime<e>, scope@1 : kokaine/async/effects/async-scope, hnd/ev-index) -> <kokaine/reactive/effects/signal-read,div,exn,kokaine/reactive/effects/signal-write,ui|e> () */  {
...
// monadic lift
export function _mlift_run_generation_async_with_family_10454(dispose_0, root_1_0, _y_x10218) /* forall<e> (dispose@0 : kokaine/async/effects/dispose-fn, root@1 : kokaine/reactive/internal/model/root<<ui|e>>, hnd/ev-index) -> <kokaine/reactive/effects/signal-read,div,exn,kokaine/reactive/effects/signal-write,ui|e> (() -> ui bool) */  {
...
// monadic lift
export function _mlift_run_generation_async_with_family_10455(dispose_0_0, root_1_1, _y_x10217) /* forall<e> (dispose@0 : kokaine/async/effects/dispose-fn, root@1 : kokaine/reactive/internal/model/root<<ui|e>>, hnd/ev-index) -> <kokaine/async/effects/async-ioc,div,exn,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui|e> (() -> ui bool) */  {
  return $std_core_hnd._mask_at(_y_x10217, false, function() {
       
      var x_12_10549 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_read_fs__tag);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_y_x10218_0 /* hnd/ev-index */ ) {
          return _mlift_run_generation_async_with_family_10454(dispose_0_0, root_1_1, _y_x10218_0);
        });
      }
      else {
        return _mlift_run_generation_async_with_family_10454(dispose_0_0, root_1_1, x_12_10549);
      }
    });
}
...
// monadic lift
export function _mlift_run_generation_async_with_family_10456(runtime_1_0, scope_0_1_0, _y_x10224) /* forall<e> (runtime@1 : generation-runtime<e>, scope@0@1 : kokaine/async/effects/async-scope, hnd/ev-index) -> <kokaine/reactive/effects/signal-read,div,exn,kokaine/reactive/effects/signal-write,ui|e> () */  {
...
// monadic lift
export function _mlift_run_generation_async_with_family_10457(runtime_1_1, scope_0_1_1, _y_x10223) /* forall<e> (runtime@1 : generation-runtime<e>, scope@0@1 : kokaine/async/effects/async-scope, hnd/ev-index) -> <kokaine/async/effects/async-ownership,div,exn,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui|e> () */  {
  return $std_core_hnd._mask_at(_y_x10223, false, function() {
       
      var x_13_10551 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_read_fs__tag);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_y_x10224_0 /* hnd/ev-index */ ) {
          return _mlift_run_generation_async_with_family_10456(runtime_1_1, scope_0_1_1, _y_x10224_0);
        });
      }
      else {
        return _mlift_run_generation_async_with_family_10456(runtime_1_1, scope_0_1_1, x_13_10551);
      }
    });
}
...
// monadic lift
export function _mlift_run_generation_async_with_family_10458(runtime_1_2, scope_0_1_2, _y_x10222) /* forall<e> (runtime@1 : generation-runtime<e>, scope@0@1 : kokaine/async/effects/async-scope, hnd/ev-index) -> <kokaine/async/effects/async-ioc,kokaine/async/effects/async-ownership,div,exn,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui|e> () */  {
  return $std_core_hnd._mask_at(_y_x10222, false, function() {
       
      var x_14_10553 = $std_core_hnd._evv_index($kokaine_async_effects.async_ownership_fs__tag);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_y_x10223_0 /* hnd/ev-index */ ) {
          return _mlift_run_generation_async_with_family_10457(runtime_1_2, scope_0_1_2, _y_x10223_0);
        });
      }
      else {
        return _mlift_run_generation_async_with_family_10457(runtime_1_2, scope_0_1_2, x_14_10553);
      }
    });
}
...
// monadic lift
export function _mlift_run_generation_async_with_family_10459(runtime_1_3, scope_1_0, _y_x10233) /* forall<e> (runtime@1 : generation-runtime<e>, scope@1@0 : kokaine/async/effects/async-scope, hnd/ev-index) -> <exn,div|e> bool */  {
...
// monadic lift
export function _mlift_run_generation_async_with_family_10460(runtime_1_4, scope_1_0_0, _y_x10232) /* forall<e> (runtime@1 : generation-runtime<e>, scope@1@0 : kokaine/async/effects/async-scope, hnd/ev-index) -> <kokaine/reactive/effects/signal-write,div,exn,ui|e> bool */  {
  return $std_core_hnd._mask_at(_y_x10232, false, function() {
       
      var x_15_10557 = $std_core_hnd._evv_index($std_core_exn.exn_fs__tag);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_y_x10233_0 /* hnd/ev-index */ ) {
          return _mlift_run_generation_async_with_family_10459(runtime_1_4, scope_1_0_0, _y_x10233_0);
        });
      }
      else {
        return _mlift_run_generation_async_with_family_10459(runtime_1_4, scope_1_0_0, x_15_10557);
      }
    });
}
...
// monadic lift
export function _mlift_run_generation_async_with_family_10461(runtime_1_5, scope_1_0_1, _y_x10231) /* forall<e> (runtime@1 : generation-runtime<e>, scope@1@0 : kokaine/async/effects/async-scope, hnd/ev-index) -> <kokaine/reactive/effects/signal-read,div,exn,kokaine/reactive/effects/signal-write,ui|e> bool */  {
  return $std_core_hnd._mask_at(_y_x10231, false, function() {
       
      var x_16_10559 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_write_fs__tag);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_y_x10232_0 /* hnd/ev-index */ ) {
          return _mlift_run_generation_async_with_family_10460(runtime_1_5, scope_1_0_1, _y_x10232_0);
        });
      }
      else {
        return _mlift_run_generation_async_with_family_10460(runtime_1_5, scope_1_0_1, x_16_10559);
      }
    });
}
...
// monadic lift
export function _mlift_run_generation_async_with_family_10462(runtime_1_6, scope_1_0_2, _y_x10230) /* forall<e> (runtime@1 : generation-runtime<e>, scope@1@0 : kokaine/async/effects/async-scope, hnd/ev-index) -> <kokaine/async/effects/async-ownership,div,exn,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui|e> bool */  {
  return $std_core_hnd._mask_at(_y_x10230, false, function() {
       
      var x_17_10561 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_read_fs__tag);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_y_x10231_0 /* hnd/ev-index */ ) {
          return _mlift_run_generation_async_with_family_10461(runtime_1_6, scope_1_0_2, _y_x10231_0);
        });
      }
      else {
        return _mlift_run_generation_async_with_family_10461(runtime_1_6, scope_1_0_2, x_17_10561);
      }
    });
}
...
// monadic lift
export function _mlift_run_generation_async_with_family_10463(runtime_1_7, scope_1_0_3, _y_x10229) /* forall<e> (runtime@1 : generation-runtime<e>, scope@1@0 : kokaine/async/effects/async-scope, hnd/ev-index) -> <kokaine/async/effects/async-ioc,kokaine/async/effects/async-ownership,div,exn,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui|e> bool */  {
  return $std_core_hnd._mask_at(_y_x10229, false, function() {
       
      var x_18_10563 = $std_core_hnd._evv_index($kokaine_async_effects.async_ownership_fs__tag);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_y_x10230_0 /* hnd/ev-index */ ) {
          return _mlift_run_generation_async_with_family_10462(runtime_1_7, scope_1_0_3, _y_x10230_0);
        });
      }
      else {
        return _mlift_run_generation_async_with_family_10462(runtime_1_7, scope_1_0_3, x_18_10563);
      }
    });
}
...
// monadic lift
export function _mlift_run_generation_async_with_family_10464(runtime_1_8, scope_2, _y_x10245) /* forall<e> (runtime@1 : generation-runtime<e>, scope@2 : kokaine/async/effects/async-scope, hnd/ev-index) -> <exn,div|e> () */  {
  return $std_core_hnd._mask_at(_y_x10245, false, function() {
...
// monadic lift
export function _mlift_run_generation_async_with_family_10465(runtime_1_9, scope_2_0, _y_x10244) /* forall<e> (runtime@1 : generation-runtime<e>, scope@2 : kokaine/async/effects/async-scope, hnd/ev-index) -> <kokaine/reactive/effects/signal-write,div,exn,ui|e> () */  {
  return $std_core_hnd._mask_at(_y_x10244, false, function() {
       
      var x_19_10567 = $std_core_hnd._evv_index($std_core_exn.exn_fs__tag);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_y_x10245_0 /* hnd/ev-index */ ) {
          return _mlift_run_generation_async_with_family_10464(runtime_1_9, scope_2_0, _y_x10245_0);
        });
      }
      else {
        return _mlift_run_generation_async_with_family_10464(runtime_1_9, scope_2_0, x_19_10567);
      }
    });
}
...
// monadic lift
export function _mlift_run_generation_async_with_family_10466(runtime_1_10, scope_2_1, _y_x10243) /* forall<e> (runtime@1 : generation-runtime<e>, scope@2 : kokaine/async/effects/async-scope, hnd/ev-index) -> <kokaine/reactive/effects/signal-read,div,exn,kokaine/reactive/effects/signal-write,ui|e> () */  {
  return $std_core_hnd._mask_at(_y_x10243, false, function() {
       
      var x_20_10569 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_write_fs__tag);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_y_x10244_0 /* hnd/ev-index */ ) {
          return _mlift_run_generation_async_with_family_10465(runtime_1_10, scope_2_1, _y_x10244_0);
        });
      }
      else {
        return _mlift_run_generation_async_with_family_10465(runtime_1_10, scope_2_1, x_20_10569);
      }
    });
}
...
// monadic lift
export function _mlift_run_generation_async_with_family_10467(runtime_1_11, scope_2_2, _y_x10242) /* forall<e> (runtime@1 : generation-runtime<e>, scope@2 : kokaine/async/effects/async-scope, hnd/ev-index) -> <kokaine/async/effects/async-ownership,div,exn,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui|e> () */  {
  return $std_core_hnd._mask_at(_y_x10242, false, function() {
       
      var x_21_10571 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_read_fs__tag);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_y_x10243_0 /* hnd/ev-index */ ) {
          return _mlift_run_generation_async_with_family_10466(runtime_1_11, scope_2_2, _y_x10243_0);
        });
      }
      else {
        return _mlift_run_generation_async_with_family_10466(runtime_1_11, scope_2_2, x_21_10571);
      }
    });
}
...
// monadic lift
export function _mlift_run_generation_async_with_family_10468(runtime_1_12, scope_2_3, _y_x10241) /* forall<e> (runtime@1 : generation-runtime<e>, scope@2 : kokaine/async/effects/async-scope, hnd/ev-index) -> <kokaine/async/effects/async-ioc,kokaine/async/effects/async-ownership,div,exn,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui|e> () */  {
  return $std_core_hnd._mask_at(_y_x10241, false, function() {
       
      var x_22_10573 = $std_core_hnd._evv_index($kokaine_async_effects.async_ownership_fs__tag);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_y_x10242_0 /* hnd/ev-index */ ) {
          return _mlift_run_generation_async_with_family_10467(runtime_1_12, scope_2_3, _y_x10242_0);
        });
      }
      else {
        return _mlift_run_generation_async_with_family_10467(runtime_1_12, scope_2_3, x_22_10573);
      }
    });
}
...
export function accept_task_result(task, family, result) /* forall<a,e> (task : generation-task<a,e>, family : async-family<e>, result : kokaine/async/effects/await-result<a>) -> <div,ui> () */  {
  ...
  var _x46 = $kokaine_async_internal_one_dash_shot_dash_task.one_shot_task_fs_accept(_x47, result);
  if (_x46) {
...
export function register_task(root_2, runtime_2, scope_3, label_2, setup_3, resume_action_2) /* forall<a,e> (root : kokaine/reactive/internal/model/root<<ui|e>>, runtime : generation-runtime<e>, scope : kokaine/async/effects/async-scope, label : string, setup : kokaine/async/effects/await-setup<a>, resume-action : (kokaine/async/effects/await-result<a>) -> <pure,kokaine/async/effects/async-await,kokaine/async/effects/async-cancel,kokaine/async/effects/async-ioc,kokaine/async/effects/async-ownership,kokaine/async/effects/discontinue,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui|e> ()) -> <pure,kokaine/reactive/effects/signal-write,ui|e> () */  {
  ...
  var x_23_10576 = $std_core_hnd._open_at1($std_core_hnd._evv_index($std_core_exn.exn_fs__tag), $kokaine_reactive_internal_model.check_not_pure_plane, "async suspension");
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(wild___0 /* () */ ) {
      return _mlift_register_task_10439(label_2, resume_action_2, root_2, runtime_2, scope_3, setup_3, wild___0);
    });
  }
  else {
     
    var x_24_10579 = $std_core_hnd._open_at1($std_core_hnd._evv_index($std_core_exn.exn_fs__tag), $kokaine_reactive_integration_internal_reentry.capture_reentry, root_2);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(portal_2 /* kokaine/reactive/integration/internal/reentry/reentry<<ui|5492>> */ ) {
        return _mlift_register_task_10438(label_2, resume_action_2, root_2, runtime_2, scope_3, setup_3, portal_2);
      });
    }
    else {
       
      var family_0_2 = $std_core_hnd._open_none1(function(_this_0_0 /* generation-runtime<5492> */ ) {
          return _this_0_0;
        }, runtime_2);
       
      var x_25_10582 = runtime_fs_supervisor(runtime_2, root_2, scope_3);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(supervisor_1 /* runtime-supervisor<5492> */ ) {
          return _mlift_register_task_10437(family_0_2, label_2, x_24_10579, resume_action_2, setup_3, supervisor_1);
        });
      }
      else {
         
        var state_0 = $std_core_hnd._open_none1($kokaine_async_internal_one_dash_shot_dash_task.new_one_shot_task, Task_payload(x_24_10579, resume_action_2, label_2));
         
        var task_0_1 = Generation_task(state_0, x_25_10582, { value: ($std_core_types.Nothing) });
         
        var _x_x1_3_10400_0 = $std_core_hnd._open_none1(function(_this_1_0 /* runtime-supervisor<5492> */ ) {
            return _this_1_0.supervisor_tasks;
          }, x_25_10582);
         
        var x_26_10585 = $std_core_hnd._open_at2($std_core_hnd._evv_index($std_core_exn.exn_fs__tag), $kokaine_async_internal_cancellation_dash_supervisor.cancellation_supervisor_fs_register, _x_x1_3_10400_0, function() {
            return task_fs_claim_stop(task_0_1, family_0_2);
          });
        if ($std_core_hnd._yielding()) {
          return $std_core_hnd.yield_extend(function(cancellation_1 /* kokaine/async/internal/cancellation-supervisor/cancellation-registration<task-cancellation> */ ) {
            return _mlift_register_task_10436(family_0_2, setup_3, task_0_1, cancellation_1);
          });
        }
        else {
           
          var target_10334_0 = $std_core_hnd._open_none1(function(_this_2_0 /* generation-task<5491,5492> */ ) {
              return _this_2_0.task_cancel;
            }, task_0_1);
           
          ((target_10334_0).value = ($std_core_types.Just(x_26_10585)));
          ...
          var _x48 = $std_core_hnd._open_none1(setup_3, function(result_0_1 /* kokaine/async/effects/await-result<5491> */ ) {
              return accept_task_result(task_0_1, family_0_2, result_0_1);
            });
          if (_x48._tag === 1) {
            return $std_core_hnd._open_none3(accept_task_result, task_0_1, family_0_2, $kokaine_async_effects.Exception(_x48.error));
          }
          else {
             
            var _x_x1_8_10408_0 = $std_core_hnd._open_none1(function(_this_3_0 /* generation-task<5491,5492> */ ) {
                return _this_3_0.task_state;
              }, task_0_1);
            var _x49 = $std_core_hnd._open_none2($kokaine_async_internal_one_dash_shot_dash_task.one_shot_task_fs_install_disposer, _x_x1_8_10408_0, _x48.value);
            if (_x49 === null) {
              return $std_core_types.Unit;
            }
            else {
...
export function interpret_generation_await(root_0_10, family_1_3, runtime_0_10, action_5) /* forall<e> (root : kokaine/reactive/internal/model/root<<ui|e>>, family : async-family<e>, runtime : generation-runtime<e>, action : () -> <pure,kokaine/async/effects/async-await,kokaine/async/effects/async-cancel,kokaine/async/effects/async-ioc,kokaine/async/effects/async-ownership,kokaine/async/effects/discontinue,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui|e> ()) -> <pure,kokaine/async/effects/async-cancel,kokaine/async/effects/async-ioc,kokaine/async/effects/async-ownership,kokaine/async/effects/discontinue,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui|e> () */  {
  return $kokaine_async_effects.async_await_fs__handle($kokaine_async_effects._Hnd_async_await(3, function(m /* hnd/marker<<kokaine/async/effects/async-cancel,kokaine/async/effects/async-ioc,kokaine/async/effects/async-ownership,kokaine/async/effects/discontinue,div,exn,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui|5502>,()> */ , ___wildcard_x598__16 /* hnd/ev<kokaine/async/effects/async-await> */ , x_27 /* (kokaine/async/effects/await-setup<_3717>, kokaine/async/effects/async-scope, string) */ ) {
        return $std_core_hnd.yield_to(m, function(k /* (hnd/resume-result<kokaine/async/effects/await-result<_3717>,()>) -> <kokaine/async/effects/async-cancel,kokaine/async/effects/async-ioc,kokaine/async/effects/async-ownership,kokaine/async/effects/discontinue,div,exn,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui|5502> () */ ) {
             
            var x_28_10589 = $std_core_hnd._evv_index($kokaine_async_effects.async_cancel_fs__tag);
             
            function next_27_10590(_y_x10179_0) /* (hnd/ev-index) -> <kokaine/async/effects/async-cancel,kokaine/async/effects/async-ioc,kokaine/async/effects/async-ownership,kokaine/async/effects/discontinue,div,exn,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui|5502> () */  {
              return _mlift_interpret_generation_await_10444(family_1_3, x_27.thd, k, root_0_10, runtime_0_10, x_27.snd, x_27.fst, _y_x10179_0);
            }
            if ($std_core_hnd._yielding()) {
              return $std_core_hnd.yield_extend(next_27_10590);
            }
            else {
              return next_27_10590(x_28_10589);
            }
          });
      }, $std_core_hnd.clause_tail1(function(_pat_x789__20 /* (kokaine/async/effects/await-setup<_3720>, kokaine/async/effects/async-scope, string, (kokaine/async/effects/await-result<_3720>) -> ui ()) */ ) {
         
        var x_29_10592 = $std_core_hnd._evv_index($kokaine_async_effects.async_cancel_fs__tag);
        if ($std_core_hnd._yielding()) {
          return $std_core_hnd.yield_extend(function(_y_x10194_0 /* hnd/ev-index */ ) {
            return _mlift_interpret_generation_await_10449(_pat_x789__20.field4, _pat_x789__20.thd, root_0_10, runtime_0_10, _pat_x789__20.snd, _pat_x789__20.fst, _y_x10194_0);
          });
        }
        else {
          return _mlift_interpret_generation_await_10449(_pat_x789__20.field4, _pat_x789__20.thd, root_0_10, runtime_0_10, _pat_x789__20.snd, _pat_x789__20.fst, x_29_10592);
        }
      })), function(_res /* () */ ) {
      return _res;
    }, action_5);
...
export function run_generation_async_with_family(root_1_2, family_2, action_0_0) /* forall<e> (root : kokaine/reactive/internal/model/root<<ui|e>>, family : async-family<e>, action : () -> <pure,kokaine/async/effects/async-await,kokaine/async/effects/async-cancel,kokaine/async/effects/async-ioc,kokaine/async/effects/async-ownership,kokaine/async/effects/discontinue,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui|e> ()) -> <pure,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui|e> () */  {
  ...
  return $kokaine_async_effects.async_ioc_fs__handle($kokaine_async_effects._Hnd_async_ioc(1, $std_core_hnd.clause_tail1(function(host_action_2 /* () -> ui 4142 */ ) {
         
        var x_30_10594 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_read_fs__tag);
        if ($std_core_hnd._yielding()) {
          return $std_core_hnd.yield_extend(function(_y_x10207_0 /* hnd/ev-index */ ) {
            return _mlift_run_generation_async_with_family_10452(host_action_2, _y_x10207_0);
          });
        }
        else {
          return _mlift_run_generation_async_with_family_10452(host_action_2, x_30_10594);
        }
      }), function(m_0 /* hnd/marker<<div,exn,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui|5509>,()> */ , ev /* hnd/ev<kokaine/async/effects/async-ioc> */ , x1_1 /* kokaine/async/effects/async-scope */ , x2_1 /* () -> ui () */ ) {
        return $std_core_hnd.under2(ev, function(scope_1_1 /* kokaine/async/effects/async-scope */ , host_action_0_1 /* () -> ui () */ ) {
             
            var x_31_10597 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_read_fs__tag);
            if ($std_core_hnd._yielding()) {
              return $std_core_hnd.yield_extend(function(_y_x10214_0 /* hnd/ev-index */ ) {
                return _mlift_run_generation_async_with_family_10453(host_action_0_1, root_1_2, runtime_1_13, scope_1_1, _y_x10214_0);
              });
            }
            else {
              return _mlift_run_generation_async_with_family_10453(host_action_0_1, root_1_2, runtime_1_13, scope_1_1, x_31_10597);
            }
          }, x1_1, x2_1);
      }), function(_res_0 /* () */ ) {
      return _res_0;
      ...
      return $kokaine_async_effects.async_ownership_fs__handle($kokaine_async_effects._Hnd_async_ownership(1, $std_core_hnd.clause_tail1(function(dispose_0_1 /* kokaine/async/effects/dispose-fn */ ) {
            ...
            var x_32_10599 = $std_core_hnd._evv_index($kokaine_async_effects.async_ioc_fs__tag);
            if ($std_core_hnd._yielding()) {
              return $std_core_hnd.yield_extend(function(_y_x10217_0 /* hnd/ev-index */ ) {
                return _mlift_run_generation_async_with_family_10455(dispose_0_1, root_1_2, _y_x10217_0);
              });
            }
            else {
              return _mlift_run_generation_async_with_family_10455(dispose_0_1, root_1_2, x_32_10599);
            }
          })), function(_res_0_0 /* () */ ) {
          return _res_0_0;
        }, function() {
           
          var _value_async_scope_l671_c9 = $std_core_hnd._open_none1(function(_this_4 /* async-family<5509> */ ) {
          ...
          return $kokaine_async_effects.async_cancel_fs__handle($kokaine_async_effects._Hnd_async_cancel(1, $std_core_hnd.clause_tail0(function() {
                ...
                var x_33_10601 = $std_core_hnd._evv_index($kokaine_async_effects.async_ioc_fs__tag);
                if ($std_core_hnd._yielding()) {
                  return $std_core_hnd.yield_extend(function(_y_x10222_0 /* hnd/ev-index */ ) {
                    return _mlift_run_generation_async_with_family_10458(runtime_1_13, scope_0_1_3, _y_x10222_0);
                  });
                }
                else {
                  return _mlift_run_generation_async_with_family_10458(runtime_1_13, scope_0_1_3, x_33_10601);
                }
              }), $std_core_hnd.clause_tail1(function(scope_1_0_4 /* kokaine/async/effects/async-scope */ ) {
                 
                var x_34_10603 = $std_core_hnd._evv_index($kokaine_async_effects.async_ioc_fs__tag);
                if ($std_core_hnd._yielding()) {
                  return $std_core_hnd.yield_extend(function(_y_x10229_0 /* hnd/ev-index */ ) {
                    return _mlift_run_generation_async_with_family_10463(runtime_1_13, scope_1_0_4, _y_x10229_0);
                  });
                }
                else {
                  return _mlift_run_generation_async_with_family_10463(runtime_1_13, scope_1_0_4, x_34_10603);
                }
              }), $std_core_hnd.clause_tail1(function(scope_2_4 /* kokaine/async/effects/async-scope */ ) {
                 
                var x_35_10605 = $std_core_hnd._evv_index($kokaine_async_effects.async_ioc_fs__tag);
                if ($std_core_hnd._yielding()) {
                  return $std_core_hnd.yield_extend(function(_y_x10241_0 /* hnd/ev-index */ ) {
                    return _mlift_run_generation_async_with_family_10468(runtime_1_13, scope_2_4, _y_x10241_0);
                  });
                }
                else {
                  return _mlift_run_generation_async_with_family_10468(runtime_1_13, scope_2_4, x_35_10605);
                }
              })), function(_res_1 /* () */ ) {
              return _res_1;
            }, function() {
              return $kokaine_async_effects.discontinue_fs__handle($kokaine_async_effects._Hnd_discontinue(0, function(m_1 /* hnd/marker<<kokaine/async/effects/async-cancel,kokaine/async/effects/async-ioc,kokaine/async/effects/async-ownership,div,exn,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui|5509>,()> */ , ___wildcard_x701__16 /* hnd/ev<kokaine/async/effects/discontinue> */ ) {
                    return $std_core_hnd.yield_to_final(m_1, function(___wildcard_x701__43 /* (hnd/resume-result<4630,()>) -> <kokaine/async/effects/async-cancel,kokaine/async/effects/async-ioc,kokaine/async/effects/async-ownership,div,exn,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui|5509> () */ ) {
                        return $std_core_types.Unit;
                      });
                  }), function(_res_2 /* () */ ) {
                  return _res_2;
...
export function run_task_result(task_1, family_4) /* forall<a,e> (task : generation-task<a,e>, family : async-family<e>) -> <div,ui> () */  {
  ...
  var _x50 = $kokaine_async_internal_one_dash_shot_dash_task.one_shot_task_fs_claim_ready(_x51);
  if (_x50 === null) {
    return $std_core_types.Unit;
  }
  else {
    ...
    return $std_core_exn.exn_fs__handle($std_core_exn._Hnd_exn(0, function(m_2 /* hnd/marker<ui,()> */ , ___wildcard_x654__16 /* hnd/ev<exn> */ , x_36 /* exception */ ) {
        ...
        if (_x50.value.claim_result === null) {
          ...
          var root_3_0 = $std_core_hnd._open_none1(function(value_1 /* kokaine/reactive/integration/internal/reentry/reentry<<ui|5525>> */ ) {
              return value_1.reentry_root;
            }, _x50.value.claim_payload.payload_portal);
          var _x53 = $kokaine_reactive_async_internal_host_dash_turn.host_turn_runner_fs_run($std_core_hnd._open_none1(function(_this_7 /* async-family<5525> */ ) {
                return _this_7.family_runner;
              }, family_4), function() {
              return $kokaine_reactive_integration_internal_reentry.run_reentry(_x50.value.claim_payload.payload_portal, function() {
                  return resume_generation(root_3_0, family_4, function() {
                      return _x50.value.claim_payload.payload_resume(_x50.value.claim_result.value);
                    });
                });
            });
        }
        return $std_core_hnd.finally_prompt(function() {
            ...
            var _x_x1_10418 = $std_core_hnd._open_none1(function(_this_6 /* generation-task<5524,5525> */ ) {
                return _this_6.task_state;
              }, task_1);
             
            var _pat_4_0_0_0 = $std_core_hnd._open_none1($kokaine_async_internal_one_dash_shot_dash_task.one_shot_task_fs_finish, _x_x1_10418);
            return $std_core_types.Unit;
          }, _x53);
      });
  }
...
export function stopped_task_cancellation(family_5, claim) /* forall<a,e> (family : async-family<e>, claim : kokaine/async/internal/one-shot-task/task-claim<task-payload<a,e>,kokaine/async/effects/await-result<a>,kokaine/async/effects/dispose-fn>) -> div task-cancellation */  {
  return Task_cancellation(function() {
      return $std_core_exn.exn_fs__handle($std_core_exn._Hnd_exn(0, function(m_3 /* hnd/marker<ui,()> */ , ___wildcard_x654__16_0 /* hnd/ev<exn> */ , x_37 /* exception */ ) {
          ...
          var root_4_0 = $std_core_hnd._open_none1(function(value_2 /* kokaine/reactive/integration/internal/reentry/reentry<<ui|5537>> */ ) {
              return value_2.reentry_root;
            }, claim.claim_payload.payload_portal);
          return $kokaine_reactive_async_internal_host_dash_turn.host_turn_runner_fs_run($std_core_hnd._open_none1(function(_this_8 /* async-family<5537> */ ) {
...
export function task_fs_claim_stop(task_2, family_6) /* forall<a,e> (task : generation-task<a,e>, family : async-family<e>) -> div maybe<task-cancellation> */  {
  ...
  var _x55 = $kokaine_async_internal_one_dash_shot_dash_task.one_shot_task_fs_claim_stop(_x56, reason);
  if (_x55 === null) {
...
export function account_async_lease_disposers(disposers) /* (disposers : list<kokaine/async/effects/dispose-fn>) -> () */  {
  return function() {
    ...
    var res = $std_core.$while(function() {
        ...
        var list_10132 = ((loc).value);
        return (list_10132 === null) ? false : true;
      }, function() {
        var _x60 = ((loc).value);
        if (_x60 === null) {
          return $std_core_types.Unit;
...
export function run_async_lease_disposers(disposers) /* (disposers : list<kokaine/async/effects/dispose-fn>) -> ui () */  {
  return function() {
    ...
    var res = $std_core.$while(function() {
        ...
        var list_10136 = ((loc).value);
        return (list_10136 === null) ? false : true;
      }, function() {
        var _x60 = ((loc).value);
        if (_x60 === null) {
          return $std_core_types.Unit;
...
export function run_generation_async(root, action) /* (root : kokaine/reactive/internal/model/root<ui>, action : () -> <pure,kokaine/async/effects/async-await,kokaine/async/effects/async-cancel,kokaine/async/effects/async-ioc,kokaine/async/effects/async-ownership,kokaine/async/effects/discontinue,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui> ()) -> <pure,kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui> () */  {
  return run_generation_async_with_family(root, Async_family($std_core_hnd._open_none0($kokaine_internal_registry.new_registry), $std_core_hnd._open_none0($kokaine_internal_int_dash_index.new_int_index), { value: ($std_core_types.Nil) }, $std_core_hnd._open_none0($kokaine_async_effects.new_runtime_scope_root), function(run_action /* () -> <exn,ui> 6003 */ ) {
        return run_action();
      }), action);
}