...
import * as $kokaine_reactive_integration_event from './kokaine_reactive_integration_event.mjs';
...
// monadic lift
export function _mlift_open_keyed_participation_11360(_y_x10270) /* (kokaine/reactive/integration/internal/provision/provision-lease<ui>) -> exn keyed-participation */  {
...
// monadic lift
export function _mlift_open_keyed_participation_11361(current_0, _y_x10271) /* (current@0 : kokaine/reactive/integration/provision<ui>, kokaine/dom/internal/keyed-transaction/keyed-transaction) -> exn keyed-participation */  {
  return Keyed_joined(current_0, _y_x10271);
}
 
 
// monadic lift
export function _mlift_open_keyed_participation_11362(renderer, root, _y_x10269) /* (renderer : kokaine/dom/internal/keyed-transaction/keyed-context, root : kokaine/reactive/root<ui>, maybe<kokaine/reactive/integration/provision<ui>>) -> exn keyed-participation */  {
  if (_y_x10269 === null) {
     
    var x_11537 = $kokaine_reactive_integration_internal_provision.open_provision($std_core_hnd._open_none1(function(value /* kokaine/reactive/root<ui> */ ) {
        return value;
      }, root));
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(_mlift_open_keyed_participation_11360);
    }
    else {
      return _mlift_open_keyed_participation_11360(x_11537);
    }
  }
  else {
     
    var x_0_11539 = $kokaine_dom_internal_keyed_dash_transaction.current_keyed_transaction(renderer, _y_x10269.value);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_y_x10271 /* kokaine/dom/internal/keyed-transaction/keyed-transaction */ ) {
        return Keyed_joined(_y_x10269.value, _y_x10271);
      });
    }
    else {
      return Keyed_joined(_y_x10269.value, x_0_11539);
    }
  }
}
...
export function open_keyed_participation(renderer, root) /* (renderer : kokaine/dom/internal/keyed-transaction/keyed-context, root : kokaine/reactive/root<ui>) -> exn keyed-participation */  {
  ...
  var x_11543 = $kokaine_reactive_integration.current_provision(root);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(_y_x10269 /* maybe<kokaine/reactive/integration/provision<ui>> */ ) {
      return _mlift_open_keyed_participation_11362(renderer, root, _y_x10269);
    });
  }
  else {
    if (x_11543 === null) {
       
      var x_0_11546 = $kokaine_reactive_integration_internal_provision.open_provision($std_core_hnd._open_none1(function(value /* kokaine/reactive/root<ui> */ ) {
          return value;
        }, root));
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(_mlift_open_keyed_participation_11360);
      ...
      var x_1_11549 = $kokaine_dom_internal_keyed_dash_transaction.current_keyed_transaction(renderer, x_11543.value);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_y_x10271 /* kokaine/dom/internal/keyed-transaction/keyed-transaction */ ) {
          return Keyed_joined(x_11543.value, _y_x10271);
        });
      }
      else {
        return Keyed_joined(x_11543.value, x_1_11549);
      }
    }
  }
}
...
// monadic lift
export function _mlift_query_11363(selector, result) /* (selector : string, result : any) -> <ui,exn> node */  {
...
export function query(selector) /* (selector : string) -> <exn,ui> node */  {
  ...
  if (_x26) {
    var x_11556 = $std_core_hnd._open_none1(dom_attempt_value, result);
  }
  else {
    var x_11556 = $std_core_exn.$throw($std_core_types._lp__plus__plus__rp_("browser DOM exception: ", $std_core_hnd._open_none1(dom_attempt_message, result)));
  }
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(result_0 /* any */ ) {
      return _mlift_query_11363(selector, result_0);
    });
  }
  else {
    var _x26 = $std_core_hnd._open_none1(any_is_null, x_11556);
    if (_x26) {
      return $std_core_exn.$throw($std_core_types._lp__plus__plus__rp_("DOM selector did not match: ", selector));
    }
    else {
      return $std_core_hnd._open_none1(any_node, x_11556);
    }
  }
}
...
// monadic lift
export function toggle_fs__mlift_state_11364(state) /* (state : int) -> <ui,exn> toggle-state */  {
...
export function toggle_fs_state(value) /* (value : kokaine/html/event) -> <exn,ui> toggle-state */  {
  ...
  if (_x43) {
    var x_11575 = $std_core_hnd._open_none1(dom_attempt_value, result);
  }
  else {
    var x_11575 = $std_core_exn.$throw($std_core_types._lp__plus__plus__rp_("browser DOM exception: ", $std_core_hnd._open_none1(dom_attempt_message, result)));
  }
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(toggle_fs__mlift_state_11364);
  }
  else {
    return ($std_core_types._int_eq(x_11575,1)) ? Toggle_open : Toggle_closed;
  }
}
 
 
// monadic lift
export function _mlift_tracked_11365(read, _y_x10304) /* forall<a> (read : () -> kokaine/reactive/effects/signal-read a, hnd/ev-index) -> <exn,div,kokaine/reactive/effects/signal-read> a */  {
  return $std_core_hnd._mask_at(_y_x10304, false, read);
}
...
export function tracked(read) /* forall<a> (read : () -> kokaine/reactive/effects/signal-read a) -> <kokaine/reactive/effects/signal-read,pure> a */  {
  ...
  var x_11580 = $std_core_hnd._evv_index($std_core_exn.exn_fs__tag);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(_y_x10304 /* hnd/ev-index */ ) {
      return $std_core_hnd._mask_at(_y_x10304, false, read);
    });
  }
  else {
    return $std_core_hnd._mask_at(x_11580, false, read);
  }
}
 
 
// monadic lift
export function _mlift_constant_track_11366(_y_x10308) /* (hnd/ev-index) -> <exn,div> () */  {
  return $std_core_hnd._mask_at(_y_x10308, false, function() {
      return $std_core_types.Unit;
    });
}
...
// monadic lift
export function _mlift_constant_track_11367(_y_x10307) /* (hnd/ev-index) -> <kokaine/reactive/effects/signal-read,div,exn> () */  {
  return $std_core_hnd._mask_at(_y_x10307, false, function() {
       
      var x_11585 = $std_core_hnd._evv_index($std_core_exn.exn_fs__tag);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(_mlift_constant_track_11366);
      }
      else {
...
export function constant_track() /* () -> <pure,kokaine/reactive/effects/signal-read> () */  {
  ...
  var x_11587 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_read_fs__tag);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(_mlift_constant_track_11367);
  }
  else {
    return $std_core_hnd._mask_at(x_11587, false, function() {
         
        var x_0_11590 = $std_core_hnd._evv_index($std_core_exn.exn_fs__tag);
        if ($std_core_hnd._yielding()) {
          return $std_core_hnd.yield_extend(_mlift_constant_track_11366);
        }
        else {
          return $std_core_hnd._mask_at(x_0_11590, false, function() {
              return $std_core_types.Unit;
            });
        }
      });
...
// monadic lift
export function _mlift_reactive_ui_exn_11368(action, _y_x10311) /* forall<a,e> (action : () -> <ui,exn> a, hnd/ev-index) -> <kokaine/reactive/effects/signal-write,div,exn,ui|e> a */  {
  return $std_core_hnd._mask_at(_y_x10311, false, function() {
...
export function reactive_ui_exn(action) /* forall<a,e> (action : () -> <ui,exn> a) -> <kokaine/reactive/effects/signal-write,pure,ui|e> a */  {
  ...
  var x_11593 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_write_fs__tag);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(_y_x10311 /* hnd/ev-index */ ) {
      return _mlift_reactive_ui_exn_11368(action, _y_x10311);
    });
  }
  else {
    return $std_core_hnd._mask_at(x_11593, false, function() {
        return $std_core_hnd._open_at0($std_core_hnd._evv_index($std_core_exn.exn_fs__tag), action);
      });
  }
}
...
// monadic lift
export function _mlift_reactive_ui_exn_open_11369(action, _y_x10315) /* forall<a,e> (action : () -> <ui,exn|e> a, hnd/ev-index) -> <kokaine/reactive/effects/signal-write,div,exn,ui|e> a */  {
  return $std_core_hnd._mask_at(_y_x10315, false, action);
}
...
export function reactive_ui_exn_open(action) /* forall<a,e> (action : () -> <ui,exn|e> a) -> <kokaine/reactive/effects/signal-write,pure,ui|e> a */  {
  ...
  var x_11598 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_write_fs__tag);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(_y_x10315 /* hnd/ev-index */ ) {
      return $std_core_hnd._mask_at(_y_x10315, false, action);
    });
  }
  else {
    return $std_core_hnd._mask_at(x_11598, false, action);
  }
}
 
 
// monadic lift
export function _mlift_reactive_sample_11370(action, root, _y_x10318) /* forall<a> (action : () -> <kokaine/reactive/effects/signal-read,pure> a, root : kokaine/reactive/root<ui>, hnd/ev-index) -> <kokaine/reactive/effects/signal-write,div,exn,ui> a */  {
...
export function reactive_sample(root, action) /* forall<a> (root : kokaine/reactive/root<ui>, action : () -> <kokaine/reactive/effects/signal-read,pure> a) -> <kokaine/reactive/effects/signal-write,pure,ui> a */  {
  ...
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(_y_x10318 /* hnd/ev-index */ ) {
      return _mlift_reactive_sample_11370(action, root, _y_x10318);
    });
  }
  else {
    return $std_core_hnd._mask_at(x_11603, false, function() {
        return $kokaine_reactive.sample(root, action);
      });
  }
}
...
// monadic lift
export function _mlift_reactive_write_ui_11371(action, _y_x10322) /* forall<a,e> (action : () -> kokaine/reactive/effects/signal-write a, hnd/ev-index) -> <exn,div,kokaine/reactive/effects/signal-write|e> a */  {
  return $std_core_hnd._mask_at(_y_x10322, false, function() {
...
export function reactive_write_ui(action) /* forall<a,e> (action : () -> kokaine/reactive/effects/signal-write a) -> <kokaine/reactive/effects/signal-write,pure,ui|e> a */  {
  ...
  var x_11609 = $std_core_hnd._evv_index($std_core_exn.exn_fs__tag);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(_y_x10322 /* hnd/ev-index */ ) {
      return _mlift_reactive_write_ui_11371(action, _y_x10322);
    });
  }
  else {
    return _mlift_reactive_write_ui_11371(action, x_11609);
  }
}
 
 
// monadic lift
export function _mlift_reactive_integration_11372(action, _y_x10327) /* forall<a,e> (action : () -> <div,exn,ui|e> a, hnd/ev-index) -> <kokaine/reactive/effects/signal-write,div,exn,ui|e> a */  {
  return $std_core_hnd._mask_at(_y_x10327, false, action);
}
...
export function reactive_integration(action) /* forall<a,e> (action : () -> <div,exn,ui|e> a) -> <kokaine/reactive/effects/signal-write,pure,ui|e> a */  {
  ...
  var x_11611 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_write_fs__tag);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(_y_x10327 /* hnd/ev-index */ ) {
      return $std_core_hnd._mask_at(_y_x10327, false, action);
    });
  }
  else {
    return $std_core_hnd._mask_at(x_11611, false, action);
  }
}
...
// monadic lift
export function _mlift_validate_range_move_lifecycle_11373(first, last, parent, wild__) /* (first : node, last : node, parent : node, wild_ : ()) -> <ui,exn> () */  {
...
export function validate_range_move_lifecycle(parent, first, last) /* (parent : node, first : node, last : node) -> <exn,ui> () */  {
  ...
  if (_x49) {
    var x_11623 = $std_core_hnd._open_none1(dom_attempt_value, result);
  }
  else {
    var x_11623 = $std_core_exn.$throw($std_core_types._lp__plus__plus__rp_("browser DOM exception: ", $std_core_hnd._open_none1(dom_attempt_message, result)));
  }
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(wild__ /* () */ ) {
      return _mlift_validate_range_move_lifecycle_11373(first, last, parent, wild__);
    });
  }
  else {
...
// monadic lift
export function _mlift_move_range_before_11374(before, first, last, parent, focus) /* (before : node, first : node, last : node, parent : node, focus : any) -> <ui,exn> () */  {
...
// monadic lift
export function _mlift_move_range_before_11375(before, first, last, parent, wild___0) /* (before : node, first : node, last : node, parent : node, wild_@0 : ()) -> <ui,exn> () */  {
  ...
  if (_x51) {
    var x_11629 = $std_core_hnd._open_none1(dom_attempt_value, result);
  }
  else {
    var x_11629 = $std_core_exn.$throw($std_core_types._lp__plus__plus__rp_("browser DOM exception: ", $std_core_hnd._open_none1(dom_attempt_message, result)));
  }
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(focus /* any */ ) {
      return _mlift_move_range_before_11374(before, first, last, parent, focus);
    });
  }
  else {
    return _mlift_move_range_before_11374(before, first, last, parent, x_11629);
  }
}
 
 
// monadic lift
export function _mlift_move_range_before_11376(before, first, last, parent, wild__) /* (before : node, first : node, last : node, parent : node, wild_ : ()) -> <ui,exn> () */  {
  ...
  var _x51 = $std_core_hnd._open_none1(dom_attempt_ok, result);
  if (_x51) {
    var x_11632 = $std_core_hnd._open_none1(dom_attempt_value, result);
  }
  else {
    var x_11632 = $std_core_exn.$throw($std_core_types._lp__plus__plus__rp_("browser DOM exception: ", $std_core_hnd._open_none1(dom_attempt_message, result)));
  }
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(wild___0 /* () */ ) {
      return _mlift_move_range_before_11375(before, first, last, parent, wild___0);
    });
  }
  else {
    return _mlift_move_range_before_11375(before, first, last, parent, x_11632);
  }
}
...
export function move_range_before(parent, first, last, before) /* (parent : node, first : node, last : node, before : node) -> <exn,ui> () */  {
  ...
  var _x51 = $std_core_hnd._open_none1(dom_attempt_ok, result);
  if (_x51) {
    var x_11635 = $std_core_hnd._open_none1(dom_attempt_value, result);
  }
  else {
    var x_11635 = $std_core_exn.$throw($std_core_types._lp__plus__plus__rp_("browser DOM exception: ", $std_core_hnd._open_none1(dom_attempt_message, result)));
  }
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(wild__ /* () */ ) {
      return _mlift_move_range_before_11376(before, first, last, parent, wild__);
    });
  }
  else {
    ...
    if (_x51) {
      var x_0_11639 = $std_core_hnd._open_none1(dom_attempt_value, result_0);
    }
    else {
      var x_0_11639 = $std_core_exn.$throw($std_core_types._lp__plus__plus__rp_("browser DOM exception: ", $std_core_hnd._open_none1(dom_attempt_message, result_0)));
    }
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(wild___0 /* () */ ) {
        return _mlift_move_range_before_11375(before, first, last, parent, wild___0);
      ...
      if (_x51) {
        var x_1_11643 = $std_core_hnd._open_none1(dom_attempt_value, result_1);
      }
      else {
        var x_1_11643 = $std_core_exn.$throw($std_core_types._lp__plus__plus__rp_("browser DOM exception: ", $std_core_hnd._open_none1(dom_attempt_message, result_1)));
      }
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(focus /* any */ ) {
          return _mlift_move_range_before_11374(before, first, last, parent, focus);
        ...
        var result_2 = $std_core_hnd._open_none1(dom_attempt_raw, function() {
            return dom_move_range_before(parent, first, last, before, x_1_11643);
          });
...
// monadic lift
export function _mlift_register_owner_cleanup_11377(_pat_1) /* (kokaine/reactive/internal/model/cleanup-registration<ui>) -> exn () */  {
  return $std_core_types.Unit;
}
 
 
// monadic lift
export function _mlift_register_owner_cleanup_11378(value, _y_x10348) /* (value : dom-owner-registration, hnd/ev-index) -> <kokaine/reactive/effects/signal-write,div,exn,ui> () */  {
  return $std_core_hnd._mask_at(_y_x10348, false, function() {
...
// monadic lift
export function _mlift_register_owner_cleanup_11379(committed, wild__) /* forall<_e> (committed : ref<global,bool>, wild_ : ()) -> <exn,ui,div,kokaine/reactive/effects/signal-write> () */  {
...
export function register_owner_cleanup(root, value) /* (root : kokaine/reactive/root<ui>, value : dom-owner-registration) -> <pure,kokaine/reactive/effects/signal-write,ui> () */  {
  ...
  var x_11654 = $std_core_hnd._open_at2(0, function(root_0 /* kokaine/reactive/root<ui> */ , cleanup /* () -> <kokaine/reactive/effects/signal-write,pure,ui> () */ ) {
       
      var root_0_10046 = $std_core_hnd._open_none1(function(value_3 /* kokaine/reactive/root<ui> */ ) {
          return value_3;
        }, root_0);
       
      var x_0_11656 = $kokaine_reactive_internal_runtime.register_cleanup(root_0_10046, cleanup);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(_mlift_register_owner_cleanup_11377);
      }
      else {
        return $std_core_types.Unit;
      }
      ...
      var x_1_11658 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_write_fs__tag);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_y_x10348 /* hnd/ev-index */ ) {
          return _mlift_register_owner_cleanup_11378(value, _y_x10348);
        });
      }
      else {
        return _mlift_register_owner_cleanup_11378(value, x_1_11658);
      }
    });
  if ($std_core_hnd._yielding()) {
...
// monadic lift
export function _mlift_record_owner_11380(root, registered) /* (root : kokaine/reactive/root<ui>, registered : dom-owner-registration) -> <exn,ui,div,kokaine/reactive/effects/signal-write> () */  {
  return register_owner_cleanup(root, registered);
}
 
 
// monadic lift
export function _mlift_record_owner_11381(_y_x10354) /* (kokaine/reactive/integration/internal/reentry/reentry<ui>) -> exn kokaine/reactive/integration/reentry<ui> */  {
  return _y_x10354;
}
 
 
// monadic lift
export function _mlift_record_owner_11382(root, value, portal) /* (root : kokaine/reactive/root<ui>, value : node, portal : kokaine/reactive/integration/reentry<ui>) -> <exn,div,kokaine/reactive/effects/signal-write,ui> () */  {
   
  var x_11662 = $std_core_hnd._open_at1(0, dom_attempt, function() {
  ...
  if ($std_core_hnd._yielding()) {
    ...
    return register_owner_cleanup(root, x_11662);
  }
}
...
export function record_owner(root, value) /* (root : kokaine/reactive/root<ui>, value : node) -> <pure,kokaine/reactive/effects/signal-write,ui> () */  {
  ...
  var x_11666 = $std_core_hnd._open_at1(0, function(root_0 /* kokaine/reactive/root<ui> */ ) {
       
      var x_0_11669 = $kokaine_reactive_integration_internal_reentry.capture_reentry($std_core_hnd._open_none1(function(value_0 /* kokaine/reactive/root<ui> */ ) {
          return value_0;
        }, root_0));
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(_mlift_record_owner_11381);
      }
      else {
        return x_0_11669;
      }
  ...
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(portal /* kokaine/reactive/integration/reentry<ui> */ ) {
      return _mlift_record_owner_11382(root, value, portal);
    });
  }
  else {
     
    var x_1_11671 = $std_core_hnd._open_at1(0, dom_attempt, function() {
        return dom_record_owner(value, root, x_11666);
      });
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(registered /* dom-owner-registration */ ) {
        return register_owner_cleanup(root, registered);
      ...
      return register_owner_cleanup(root, x_1_11671);
    }
  }
}
...
// monadic lift
export function _mlift_find_owner_11383(found) /* (found : any) -> <ui,exn> owner-match */  {
  ...
  if (_x57 === 0) {
    ...
    var _x_x1_0_11117 = $std_core_hnd._open_none1(dom_owner_portal, found);
    return Owner_live($std_core_hnd._open_none1(any_reentry, _x_x1_0_11117));
  }
  else {
...
export function find_owner(root, value) /* (root : kokaine/reactive/root<ui>, value : node) -> <exn,ui> owner-match */  {
  ...
  if (_x58) {
    var x_11676 = $std_core_hnd._open_none1(dom_attempt_value, result);
  }
  else {
    var x_11676 = $std_core_exn.$throw($std_core_types._lp__plus__plus__rp_("browser DOM exception: ", $std_core_hnd._open_none1(dom_attempt_message, result)));
  }
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(_mlift_find_owner_11383);
  }
  else {
    var _x58 = $std_core_hnd._open_none1(dom_owner_state, x_11676);
    if (_x58 === 0) {
      return Owner_none;
    }
    else if (_x58 === 1) {
       
      var _x_x1_0_11117 = $std_core_hnd._open_none1(dom_owner_portal, x_11676);
      return Owner_live($std_core_hnd._open_none1(any_reentry, _x_x1_0_11117));
    }
    else {
      return Owner_retired;
...
// monadic lift
export function _mlift_insert_html_11384(root, _c_x10364) /* (root : kokaine/reactive/root<ui>, dom-owner-registration) -> () */  {
  return register_owner_cleanup(root, _c_x10364);
}
 
 
// monadic lift
export function _mlift_insert_html_11385(_y_x10360) /* (kokaine/reactive/integration/internal/reentry/reentry<ui>) -> exn kokaine/reactive/integration/reentry<ui> */  {
  return _y_x10360;
}
 
 
// monadic lift
export function _mlift_insert_html_11386(before, content, parent, root, portal) /* (before : maybe<node>, content : string, parent : node, root : kokaine/reactive/root<ui>, portal : kokaine/reactive/integration/reentry<ui>) -> <exn,div,kokaine/reactive/effects/signal-write,ui> () */  {
   
  if (before === null) {
    var x_11680 = $std_core_hnd._open_at1(0, dom_attempt, function() {
  ...
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(_c_x10364 /* dom-owner-registration */ ) {
      return register_owner_cleanup(root, _c_x10364);
    });
  }
  else {
    return register_owner_cleanup(root, x_11680);
  }
}
...
export function insert_html(root, parent, before, content) /* (root : kokaine/reactive/root<ui>, parent : node, before : maybe<node>, content : string) -> <pure,kokaine/reactive/effects/signal-write,ui> () */  {
  ...
  var x_11684 = $std_core_hnd._open_at1(0, function(root_0 /* kokaine/reactive/root<ui> */ ) {
       
      var x_0_11687 = $kokaine_reactive_integration_internal_reentry.capture_reentry($std_core_hnd._open_none1(function(value /* kokaine/reactive/root<ui> */ ) {
          return value;
        }, root_0));
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(_mlift_insert_html_11385);
      }
      else {
        return x_0_11687;
      }
  ...
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(portal /* kokaine/reactive/integration/reentry<ui> */ ) {
      return _mlift_insert_html_11386(before, content, parent, root, portal);
    });
  }
  else {
     
    if (before === null) {
      var x_1_11689 = $std_core_hnd._open_at1(0, dom_attempt, function() {
          return dom_append_html(parent, content, root, x_11684);
        });
    }
    else {
      var x_1_11689 = $std_core_hnd._open_at1(0, dom_attempt, function() {
          return dom_insert_html_before(parent, before.value, content, root, x_11684);
        });
    }
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_c_x10364 /* dom-owner-registration */ ) {
      ...
      return register_owner_cleanup(root, x_1_11689);
    }
  }
}
...
export function set_attribute(value, name, content) /* (value : element, name : string, content : maybe<string>) -> <exn,ui> () */  {
  ...
  var _x_x1_11123 = $std_core_hnd._open_none1($kokaine_html.is_valid_attribute_name, name);
...
export function set_property(value, name, content) /* (value : element, name : string, content : kokaine/html/property-value) -> <exn,ui> () */  {
  ...
  var _x_x1_11125 = $std_core_hnd._open_none1($kokaine_html.is_valid_property_name, name);
...
// monadic lift
export function _mlift_invoke_event_11387(_pat_1_2) /* (bool) -> <kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui,pure|kokaine/async/effects/async> () */  {
  return $std_core_types.Unit;
}
 
 
// monadic lift
export function _mlift_invoke_event_11388(continuation, portal, root, captured) /* forall<_e> (continuation : kokaine/reactive/integration/event/event-continuation<kokaine/async/effects/async,kokaine/html/event>, portal : kokaine/reactive/integration/reentry<ui>, root : kokaine/reactive/root<ui>, captured : kokaine/html/event) -> <exn,ui> () */  {
  var _x67 = $std_core_hnd._open_none1(function(value_1 /* kokaine/reactive/integration/event/event-continuation<kokaine/async/effects/async,kokaine/html/event> */ ) {
  ...
  if (_x67) {
    return $kokaine_reactive_integration_internal_reentry.run_reentry($std_core_hnd._open_none1(function(value_0_0 /* kokaine/reactive/integration/reentry<ui> */ ) {
        ...
        return $kokaine_reactive_async.run_async(root, function() {
             
            var x_11700 = $kokaine_reactive_integration_event.event_continuation_fs_resume(continuation, captured);
            if ($std_core_hnd._yielding()) {
              return $std_core_hnd.yield_extend(_mlift_invoke_event_11387);
            }
            else {
              return $std_core_types.Unit;
            }
...
export function invoke_event(root, portal, continuation, value) /* (root : kokaine/reactive/root<ui>, portal : kokaine/reactive/integration/reentry<ui>, continuation : kokaine/reactive/integration/event/event-continuation<kokaine/async/effects/async,kokaine/html/event>, value : raw-event) -> ui () */  {
  return $std_core_exn.exn_fs__handle($std_core_exn._Hnd_exn(0, function(m /* hnd/marker<ui,()> */ , ___wildcard_x654__16 /* hnd/ev<exn> */ , x /* exception */ ) {
      ...
      var _x70 = $std_core_hnd._open_none1(function(value_0 /* kokaine/reactive/integration/event/event-continuation<kokaine/async/effects/async,kokaine/html/event> */ ) {
          var _x71 = value_0.value;
          return (_x71 !== null);
        }, continuation);
      if (_x70) {
         
        var x_0_11703 = snapshot(value);
        if ($std_core_hnd._yielding()) {
          return $std_core_hnd.yield_extend(function(captured /* kokaine/html/event */ ) {
            return _mlift_invoke_event_11388(continuation, portal, root, captured);
          });
        }
        else {
          return _mlift_invoke_event_11388(continuation, portal, root, x_0_11703);
        }
      }
      else {
        return $std_core_types.Unit;
...
export function retire_event_listener(target, name, continuation, listener) /* (target : element, name : string, continuation : kokaine/reactive/integration/event/event-continuation<kokaine/async/effects/async,kokaine/html/event>, listener : ref<global,maybe<dom-listener>>) -> <exn,ui> () */  {
  return $std_core_hnd.finally_prompt(function() {
    ...
    }, $std_core_hnd._open_none1(function(value_2 /* kokaine/reactive/integration/event/event-continuation<kokaine/async/effects/async,kokaine/html/event> */ ) {
        return ((value_2).value = ($kokaine_reactive_integration_event.Event_retired));
      }, continuation));
}
 
 
// monadic lift
export function _mlift_capture_event_listener_11389(captured, _y_x10390) /* forall<_e> (captured : ref<global,maybe<kokaine/reactive/integration/event/event-continuation<<kokaine/async/effects/async-await,kokaine/async/effects/async-cancel,kokaine/async/effects/async-ioc,kokaine/async/effects/async-ownership,kokaine/async/effects/discontinue>,kokaine/html/event>>>, kokaine/reactive/integration/event/event-continuation<<kokaine/async/effects/async-await,kokaine/async/effects/async-cancel,kokaine/async/effects/async-ioc,kokaine/async/effects/async-ownership,kokaine/async/effects/discontinue>,kokaine/html/event>) -> <kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui,pure,kokaine/async/effects/async-await,kokaine/async/effects/async-cancel,kokaine/async/effects/async-ioc,kokaine/async/effects/async-ownership,kokaine/async/effects/discontinue> () */  {
  return ((captured).value = ($std_core_types.Just(_y_x10390)));
}
 
 
// monadic lift
export function _mlift_capture_event_listener_11390(captured, wild__) /* forall<_e> (captured : ref<global,maybe<kokaine/reactive/integration/event/event-continuation<<kokaine/async/effects/async-await,kokaine/async/effects/async-cancel,kokaine/async/effects/async-ioc,kokaine/async/effects/async-ownership,kokaine/async/effects/discontinue>,kokaine/html/event>>>, wild_ : ()) -> <exn,ui> kokaine/reactive/integration/event/event-continuation<<kokaine/async/effects/async-await,kokaine/async/effects/async-cancel,kokaine/async/effects/async-ioc,kokaine/async/effects/async-ownership,kokaine/async/effects/discontinue>,kokaine/html/event> */  {
...
export function capture_event_listener(root, action) /* (root : kokaine/reactive/root<ui>, action : kokaine/html/callback) -> <exn,ui> kokaine/reactive/integration/event/event-continuation<kokaine/async/effects/async,kokaine/html/event> */  {
   
  var captured = { value: ($std_core_types.Nothing) };
   
  var inner_0 = $std_core_hnd._open_none1(function(value_0 /* kokaine/reactive/root<ui> */ ) {
      return value_0;
    }, root);
   
  var x_11708 = $kokaine_reactive_internal_handlers.dispatch_handled(inner_0, function() {
      return $kokaine_reactive_async.run_async(root, function() {
           
          var x_0_11711 = $kokaine_reactive_integration_event.capture_event(action);
           
          function next_0_11712(_y_x10390) /* (kokaine/reactive/integration/event/event-continuation<<kokaine/async/effects/async-await,kokaine/async/effects/async-cancel,kokaine/async/effects/async-ioc,kokaine/async/effects/async-ownership,kokaine/async/effects/discontinue>,kokaine/html/event>) -> <kokaine/reactive/effects/signal-read,kokaine/reactive/effects/signal-write,ui,pure,kokaine/async/effects/async-await,kokaine/async/effects/async-cancel,kokaine/async/effects/async-ioc,kokaine/async/effects/async-ownership,kokaine/async/effects/discontinue> () */  {
            return ((captured).value = ($std_core_types.Just(_y_x10390)));
          }
          if ($std_core_hnd._yielding()) {
            return $std_core_hnd.yield_extend(next_0_11712);
          }
          else {
            return next_0_11712(x_0_11711);
          }
        });
    });
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(wild__ /* () */ ) {
      return _mlift_capture_event_listener_11390(captured, wild__);
    });
  }
  else {
...
// monadic lift
export function _mlift_install_event_listener_11391(continuation, listener, name, target, _y_x10400) /* (continuation : kokaine/reactive/integration/event/event-continuation<kokaine/async/effects/async,kokaine/html/event>, listener : ref<global,maybe<dom-listener>>, name : string, target : element, hnd/ev-index) -> <kokaine/reactive/effects/signal-write,div,exn,ui> () */  {
  return $std_core_hnd._mask_at(_y_x10400, false, function() {
...
// monadic lift
export function _mlift_install_event_listener_11392(committed, _pat_1) /* forall<_e> (committed : ref<global,bool>, kokaine/reactive/internal/model/cleanup-registration<ui>) -> exn () */  {
  return ((committed).value = true);
}
 
 
// monadic lift
export function _mlift_install_event_listener_11393(committed, continuation, listener, name, root, target, installed) /* forall<_e> (committed : ref<global,bool>, continuation : kokaine/reactive/integration/event/event-continuation<kokaine/async/effects/async,kokaine/html/event>, listener : ref<global,maybe<dom-listener>>, name : string, root : kokaine/reactive/root<ui>, target : element, installed : dom-listener) -> <ui,exn> () */  {
  ...
  var x_11716 = $kokaine_reactive_internal_runtime.register_cleanup(root_0_10046, function() {
       
      var x_0_11718 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_write_fs__tag);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_y_x10400 /* hnd/ev-index */ ) {
          return _mlift_install_event_listener_11391(continuation, listener, name, target, _y_x10400);
        });
      }
      else {
        return _mlift_install_event_listener_11391(continuation, listener, name, target, x_0_11718);
      }
    });
  if ($std_core_hnd._yielding()) {
...
// monadic lift
export function _mlift_install_event_listener_11394(continuation, name, root, target, _y_x10396) /* forall<_e,_e1,_e2> (continuation : kokaine/reactive/integration/event/event-continuation<kokaine/async/effects/async,kokaine/html/event>, name : string, root : kokaine/reactive/root<ui>, target : element, kokaine/reactive/integration/internal/reentry/reentry<ui>) -> exn () */  {
  ...
  var result = $std_core_hnd._open_none1(dom_attempt_raw, function() {
      return dom_listen(target, name, function(value_3 /* raw-event */ ) {
          return invoke_event(root, _y_x10396, continuation, value_3);
        });
    });
   
  var _x76 = $std_core_hnd._open_none1(dom_attempt_ok, result);
  if (_x76) {
    var x_11724 = $std_core_hnd._open_none1(dom_attempt_value, result);
  }
  else {
    var x_11724 = $std_core_exn.$throw($std_core_types._lp__plus__plus__rp_("browser DOM exception: ", $std_core_hnd._open_none1(dom_attempt_message, result)));
  }
  if ($std_core_hnd._yielding()) {
    var _x77 = $std_core_hnd.yield_extend(function(installed /* dom-listener */ ) {
      return _mlift_install_event_listener_11393(committed, continuation, listener, name, root, target, installed);
    });
  }
  else {
    var _x77 = _mlift_install_event_listener_11393(committed, continuation, listener, name, root, target, x_11724);
  }
  return $std_core_hnd.finally_prompt(function() {
...
// monadic lift
export function _mlift_install_event_listener_11395(name, root, target, continuation) /* forall<_e,_e1,_e2> (name : string, root : kokaine/reactive/root<ui>, target : element, continuation : kokaine/reactive/integration/event/event-continuation<kokaine/async/effects/async,kokaine/html/event>) -> <exn,ui> () */  {
   
  var x_11727 = $kokaine_reactive_integration_internal_reentry.capture_reentry($std_core_hnd._open_none1(function(value /* kokaine/reactive/root<ui> */ ) {
      return value;
    }, root));
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(_y_x10396 /* kokaine/reactive/integration/internal/reentry/reentry<ui> */ ) {
      return _mlift_install_event_listener_11394(continuation, name, root, target, _y_x10396);
    });
  }
  else {
    return _mlift_install_event_listener_11394(continuation, name, root, target, x_11727);
  }
}
...
export function install_event_listener(root, target, name, action) /* (root : kokaine/reactive/root<ui>, target : element, name : string, action : kokaine/html/callback) -> <exn,ui> () */  {
  ...
  var x_11729 = capture_event_listener(root, action);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(continuation /* kokaine/reactive/integration/event/event-continuation<kokaine/async/effects/async,kokaine/html/event> */ ) {
      return _mlift_install_event_listener_11395(name, root, target, continuation);
    });
  }
  else {
     
    var x_0_11732 = $kokaine_reactive_integration_internal_reentry.capture_reentry($std_core_hnd._open_none1(function(value /* kokaine/reactive/root<ui> */ ) {
        return value;
      }, root));
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_y_x10396 /* kokaine/reactive/integration/internal/reentry/reentry<ui> */ ) {
        return _mlift_install_event_listener_11394(x_11729, name, root, target, _y_x10396);
      });
    }
    else {
      ...
      var result = $std_core_hnd._open_none1(dom_attempt_raw, function() {
          return dom_listen(target, name, function(value_3 /* raw-event */ ) {
              return invoke_event(root, x_0_11732, x_11729, value_3);
            });
        });
       
      var _x78 = $std_core_hnd._open_none1(dom_attempt_ok, result);
      if (_x78) {
        var x_1_11737 = $std_core_hnd._open_none1(dom_attempt_value, result);
      }
      else {
        var x_1_11737 = $std_core_exn.$throw($std_core_types._lp__plus__plus__rp_("browser DOM exception: ", $std_core_hnd._open_none1(dom_attempt_message, result)));
      }
      if ($std_core_hnd._yielding()) {
        var _x79 = $std_core_hnd.yield_extend(function(installed /* dom-listener */ ) {
          return _mlift_install_event_listener_11393(committed, x_11729, listener, name, root, target, installed);
        });
      }
      else {
        var _x79 = _mlift_install_event_listener_11393(committed, x_11729, listener, name, root, target, x_1_11737);
      }
      return $std_core_hnd.finally_prompt(function() {
          ...
          if (_x78) {
            ...
            return retire_event_listener(target, name, x_11729, listener);
          }
        }, _x79);
    }
  }
...
// monadic lift
export function _mlift_mount_attribute_11396(read, _y_x10409) /* (read : () -> kokaine/reactive/effects/signal-read maybe<string>, hnd/ev-index) -> <exn,div,kokaine/reactive/effects/signal-read> maybe<string> */  {
  return $std_core_hnd._mask_at(_y_x10409, false, read);
}
 
 
// monadic lift
export function _mlift_mount_attribute_11397(name_2, target, value_1, _y_x10412) /* (name@2 : string, target : element, value@1 : maybe<string>, hnd/ev-index) -> <kokaine/reactive/effects/signal-write,div,exn,ui> () */  {
  return $std_core_hnd._mask_at(_y_x10412, false, function() {
      return set_attribute(target, name_2, value_1);
    });
}
 
 
// monadic lift
export function _mlift_mount_attribute_11398(_y_x10416) /* (kokaine/reactive/disposer<ui>) -> <kokaine/reactive/effects/signal-write,pure> () */  {
  return $std_core_types.Unit;
}
 
 
// monadic lift
export function _mlift_mount_attribute_11399(read_0_0, _y_x10417) /* (read@0@0 : () -> kokaine/reactive/effects/signal-read kokaine/html/property-value, hnd/ev-index) -> <exn,div,kokaine/reactive/effects/signal-read> kokaine/html/property-value */  {
  return $std_core_hnd._mask_at(_y_x10417, false, read_0_0);
}
 
 
// monadic lift
export function _mlift_mount_attribute_11400(name_3, target, value_2, _y_x10420) /* (name@3 : string, target : element, value@2 : kokaine/html/property-value, hnd/ev-index) -> <kokaine/reactive/effects/signal-write,div,exn,ui> () */  {
  return $std_core_hnd._mask_at(_y_x10420, false, function() {
      return set_property(target, name_3, value_2);
    });
}
 
 
// monadic lift
export function _mlift_mount_attribute_11401(_y_x10424) /* (kokaine/reactive/disposer<ui>) -> <kokaine/reactive/effects/signal-write,pure> () */  {
  return $std_core_types.Unit;
}
 
 
// monadic lift
export function _mlift_mount_attribute_11402(action_1, name_4, root, target, _y_x10427) /* (action@1 : kokaine/html/callback, name@4 : string, root : kokaine/reactive/root<ui>, target : element, hnd/ev-index) -> <kokaine/reactive/effects/signal-write,div,exn,ui> () */  {
  return $std_core_hnd._mask_at(_y_x10427, false, function() {
...
// monadic lift
export function _mlift_mount_attribute_11403(action_1, name_4, root, target, _c_x10426) /* (action@1 : kokaine/html/callback, name@4 : string, root : kokaine/reactive/root<ui>, target : element, ()) -> () */  {
   
  var x_11745 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_write_fs__tag);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(_y_x10427 /* hnd/ev-index */ ) {
      return _mlift_mount_attribute_11402(action_1, name_4, root, target, _y_x10427);
    });
  }
  else {
    return _mlift_mount_attribute_11402(action_1, name_4, root, target, x_11745);
  }
}
...
export function mount_attribute(root, target, attribute) /* forall<e> (root : kokaine/reactive/root<ui>, target : element, attribute : kokaine/html/attribute<e>) -> <kokaine/reactive/effects/signal-write,ui,pure> () */  {
  if (attribute._tag === 1) {
    ...
    var x_11747 = $kokaine_reactive.create_effect(root, function() {
         
        var x_0_11750 = $std_core_hnd._evv_index($std_core_exn.exn_fs__tag);
        if ($std_core_hnd._yielding()) {
          return $std_core_hnd.yield_extend(function(_y_x10409 /* hnd/ev-index */ ) {
            return $std_core_hnd._mask_at(_y_x10409, false, attribute.read);
          });
        }
        else {
          return $std_core_hnd._mask_at(x_0_11750, false, attribute.read);
        }
      }, function(value_1 /* maybe<string> */ ) {
         
        var x_1_11752 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_write_fs__tag);
        if ($std_core_hnd._yielding()) {
          return $std_core_hnd.yield_extend(function(_y_x10412 /* hnd/ev-index */ ) {
            return _mlift_mount_attribute_11397(attribute.name, target, value_1, _y_x10412);
          });
        }
        else {
          return _mlift_mount_attribute_11397(attribute.name, target, value_1, x_1_11752);
        }
      });
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(_mlift_mount_attribute_11398);
    }
    else {
      return $std_core_types.Unit;
    }
    ...
    var x_2_11754 = $kokaine_reactive.create_effect(root, function() {
         
        var x_3_11757 = $std_core_hnd._evv_index($std_core_exn.exn_fs__tag);
        if ($std_core_hnd._yielding()) {
          return $std_core_hnd.yield_extend(function(_y_x10417 /* hnd/ev-index */ ) {
            return $std_core_hnd._mask_at(_y_x10417, false, attribute.read);
          });
        }
        else {
          return $std_core_hnd._mask_at(x_3_11757, false, attribute.read);
        }
      }, function(value_2 /* kokaine/html/property-value */ ) {
         
        var x_4_11759 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_write_fs__tag);
        if ($std_core_hnd._yielding()) {
          return $std_core_hnd.yield_extend(function(_y_x10420 /* hnd/ev-index */ ) {
            return _mlift_mount_attribute_11400(attribute.name, target, value_2, _y_x10420);
          });
        }
        else {
          return _mlift_mount_attribute_11400(attribute.name, target, value_2, x_4_11759);
        }
      });
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(_mlift_mount_attribute_11401);
    }
    else {
      return $std_core_types.Unit;
    }
    ...
    var _x_x1_2_11144 = $std_core_hnd._open_none1($kokaine_html.is_valid_event_name, attribute.name);
    ...
    if (_x81) {
      ...
      var _x_x1_4_11146 = $std_core_types._lp__plus__plus__rp_("invalid DOM event name: ", attribute.name);
      var x_5_11761 = $std_core_hnd._open_at2(0, $std_core_exn.$throw, _x_x1_4_11146);
    }
    else {
      var x_5_11761 = $std_core_types.Unit;
    }
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_c_x10426 /* () */ ) {
        return _mlift_mount_attribute_11403(attribute.action, attribute.name, root, target, _c_x10426);
      });
    }
    else {
       
      var x_6_11764 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_write_fs__tag);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_y_x10427 /* hnd/ev-index */ ) {
          return _mlift_mount_attribute_11402(attribute.action, attribute.name, root, target, _y_x10427);
        });
      }
      else {
        return $std_core_hnd._mask_at(x_6_11764, false, function() {
...
// monadic lift
export function _mlift_run_keyed_row_actions_11404(failure, wild__) /* forall<e> (failure : ref<global,error<()>>, wild_ : ()) -> <exn|e> () */  {
  return $std_core_hnd._open_at1($std_core_hnd._evv_index($std_core_exn.exn_fs__tag), throw_keyed_row_failure, failure);
}
 
 
// monadic lift
export function _mlift_run_keyed_row_actions_11405(completed, _c_x10439) /* forall<_e> (completed : ref<global,bool>, ()) -> () */  {
  return ((completed).value = true);
}
 
 
// monadic lift
export function _mlift_run_keyed_row_actions_11406(completed_0, failure_0, previous, _y_x10438) /* forall<_e,e1> (completed : ref<global,bool>, failure : ref<global,error<()>>, previous : error<()>, error<()>) -> e1 () */  {
   
  if (_y_x10438._tag === 1) {
    var x_11768 = ((failure_0).value = ($std_core_types.$Error(_y_x10438.error)));
  }
  else {
    var x_11768 = ((failure_0).value = previous);
  }
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(_c_x10439_0 /* () */ ) {
      return _mlift_run_keyed_row_actions_11405(completed_0, _c_x10439_0);
    });
  }
  else {
    return _mlift_run_keyed_row_actions_11405(completed_0, x_11768);
  }
}
 
 
// monadic lift
export function _mlift_run_keyed_row_actions_11407(action, completed_1, failure_1, row, _y_x10436) /* forall<_e,_e1,a,b,e2,e3> (action : (keyed-row<e2,a,b>) -> <exn|e3> (), completed : ref<global,bool>, failure : ref<global,error<()>>, row : keyed-row<e2,a,b>, hnd/ev-index) -> <exn|e3> () */  {
  return $std_core_hnd._mask_at(_y_x10436, false, function() {
       
      var previous_0 = failure_1.value;
       
      ((failure_1).value = ($std_core_types.Ok($std_core_types.Unit)));
       
      var x_0_11770 = $kokaine_internal_compat.capture_error(function() {
        return action(row);
      });
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_y_x10438_0 /* error<()> */ ) {
          return _mlift_run_keyed_row_actions_11406(completed_1, failure_1, previous_0, _y_x10438_0);
        });
      }
      else {
        return _mlift_run_keyed_row_actions_11406(completed_1, failure_1, previous_0, x_0_11770);
      }
    });
}
...
// monadic lift
export function _mlift_run_keyed_row_actions_11408(action_0, failure_2, rest, wild___2) /* forall<a,b,e,e1> (action : (keyed-row<e,a,b>) -> <exn|e1> (), failure : ref<global,error<()>>, rest : list<keyed-row<e,a,b>>, wild_@2 : ()) -> <exn|e1> () */  {
...
export function run_keyed_row_actions(rows, action_1, failure_3) /* forall<a,b,e,e1> (rows : list<keyed-row<e,a,b>>, action : (keyed-row<e,a,b>) -> <exn|e1> (), failure : ref<global,error<()>>) -> <exn|e1> () */  { tailcall: while(1)
{
  if (rows === null) {
    ...
    var x_3_11779 = $std_core_hnd._evv_index($std_core_exn.exn_fs__tag);
     
    if ($std_core_hnd._yielding()) {
      var _x82 = $std_core_hnd.yield_extend(function(_y_x10436_0 /* hnd/ev-index */ ) {
        return _mlift_run_keyed_row_actions_11407(action_1, completed_2, failure_3, rows.head, _y_x10436_0);
      });
    }
    else {
      var _x82 = _mlift_run_keyed_row_actions_11407(action_1, completed_2, failure_3, rows.head, x_3_11779);
    }
    var x_1_11772 = $std_core_hnd.finally_prompt(function() {
        ...
        if (_x81) {
          ...
          var x_2_11777 = run_keyed_row_actions(rows.tail, action_1, failure_3);
          if ($std_core_hnd._yielding()) {
            return $std_core_hnd.yield_extend(function(wild___0 /* () */ ) {
              return _mlift_run_keyed_row_actions_11404(failure_3, wild___0);
            });
          }
          else {
            return _mlift_run_keyed_row_actions_11404(failure_3, x_2_11777);
          }
        }
      }, _x82);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(wild___2_0 /* () */ ) {
        return _mlift_run_keyed_row_actions_11408(action_1, failure_3, rows.tail, wild___2_0);
      });
    }
    else {
      {
...
// monadic lift
export function _mlift_exhaust_keyed_row_actions_11409(failure, wild__) /* forall<e> (failure : ref<global,error<()>>, wild_ : ()) -> <exn|e> () */  {
  return $std_core_hnd._open_at1($std_core_hnd._evv_index($std_core_exn.exn_fs__tag), throw_keyed_row_failure, failure);
}
...
export function exhaust_keyed_row_actions(rows, action) /* forall<a,b,e,e1> (rows : list<keyed-row<e,a,b>>, action : (keyed-row<e,a,b>) -> <exn|e1> ()) -> <exn|e1> () */  {
  ...
  var x_11781 = run_keyed_row_actions(rows, action, failure);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(wild__ /* () */ ) {
      return $std_core_hnd._open_at1($std_core_hnd._evv_index($std_core_exn.exn_fs__tag), throw_keyed_row_failure, failure);
    });
...
export function dispose_keyed_rows(rows) /* forall<a,b,e> (rows : list<keyed-row<e,a,b>>) -> <ui,exn> () */  {
  return exhaust_keyed_row_actions(rows, function(row /* keyed-row<6029,6027,6028> */ ) {
       
      var scope_10077 = $std_core_hnd._open_none1(function(_this /* keyed-row<6029,6027,6028> */ ) {
          return _this.row_scope;
        }, row);
...
// monadic lift
export function _mlift_rollback_keyed_order_11410(first_10259, last, last_0_10260, parent, focus) /* (first@10259 : node, last : node, last@0@10260 : node, parent : node, focus : any) -> <ui,exn> () */  {
   
  var result = $std_core_hnd._open_none1(dom_attempt_raw, function() {
      return dom_move_range_before(parent, first_10259, last_0_10260, last, focus);
    });
...
// monadic lift
export function _mlift_rollback_keyed_order_11411(first_10259, last, last_0_10260, parent, wild___0) /* (first@10259 : node, last : node, last@0@10260 : node, parent : node, wild_@0 : ()) -> <ui,exn> () */  {
   
  var result = $std_core_hnd._open_none1(dom_attempt_raw, function() {
      return dom_capture_range_focus(parent, first_10259, last_0_10260);
    });
   
  var _x82 = $std_core_hnd._open_none1(dom_attempt_ok, result);
  if (_x82) {
    var x_11787 = $std_core_hnd._open_none1(dom_attempt_value, result);
  }
  else {
    var x_11787 = $std_core_exn.$throw($std_core_types._lp__plus__plus__rp_("browser DOM exception: ", $std_core_hnd._open_none1(dom_attempt_message, result)));
  }
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(focus /* any */ ) {
      return _mlift_rollback_keyed_order_11410(first_10259, last, last_0_10260, parent, focus);
    });
  }
  else {
    return _mlift_rollback_keyed_order_11410(first_10259, last, last_0_10260, parent, x_11787);
  }
}
 
 
// monadic lift
export function _mlift_rollback_keyed_order_11412(first_10259, last, last_0_10260, parent, wild__) /* (first@10259 : node, last : node, last@0@10260 : node, parent : node, wild_ : ()) -> <ui,exn> () */  {
   
  var result = $std_core_hnd._open_none1(dom_attempt_raw, function() {
      return dom_validate_range_move_focus(parent, first_10259, last_0_10260);
    });
   
  var _x82 = $std_core_hnd._open_none1(dom_attempt_ok, result);
  if (_x82) {
    var x_11790 = $std_core_hnd._open_none1(dom_attempt_value, result);
  }
  else {
    var x_11790 = $std_core_exn.$throw($std_core_types._lp__plus__plus__rp_("browser DOM exception: ", $std_core_hnd._open_none1(dom_attempt_message, result)));
  }
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(wild___0 /* () */ ) {
      return _mlift_rollback_keyed_order_11411(first_10259, last, last_0_10260, parent, wild___0);
    });
  }
  else {
    return _mlift_rollback_keyed_order_11411(first_10259, last, last_0_10260, parent, x_11790);
  }
}
 
 
// monadic lift
export function _mlift_rollback_keyed_order_11413(last, parent, row, next) /* forall<a,b,e> (last : node, parent : node, row : keyed-row<e,a,b>, next : node) -> <ui,exn> () */  {
  ...
  if (_x82) {
    ...
    var first_10259 = $std_core_hnd._open_none1(function(_this_1 /* keyed-row<6153,6151,6152> */ ) {
        return _this_1.row_first;
      }, row);
     
    var last_0_10260 = $std_core_hnd._open_none1(function(_this_2 /* keyed-row<6153,6151,6152> */ ) {
        return _this_2.row_last;
      }, row);
     
    var result = $std_core_hnd._open_none1(dom_attempt_raw, function() {
        return dom_validate_range_move_lifecycle(parent, first_10259, last_0_10260);
      });
     
    var _x83 = $std_core_hnd._open_none1(dom_attempt_ok, result);
    if (_x83) {
      var x_11793 = $std_core_hnd._open_none1(dom_attempt_value, result);
    }
    else {
      var x_11793 = $std_core_exn.$throw($std_core_types._lp__plus__plus__rp_("browser DOM exception: ", $std_core_hnd._open_none1(dom_attempt_message, result)));
    }
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(wild__ /* () */ ) {
        return _mlift_rollback_keyed_order_11412(first_10259, last, last_0_10260, parent, wild__);
      });
    }
    else {
      return _mlift_rollback_keyed_order_11412(first_10259, last, last_0_10260, parent, x_11793);
    }
  }
}
...
export function rollback_keyed_order(parent, last, rows) /* forall<a,b,e> (parent : node, last : node, rows : list<keyed-row<e,a,b>>) -> <ui,exn> () */  {
  return exhaust_keyed_row_actions(rows, function(row /* keyed-row<6153,6151,6152> */ ) {
       
      var first_10079 = $std_core_hnd._open_none1(function(_this /* keyed-row<6153,6151,6152> */ ) {
          return _this.row_first;
        }, row);
       
      var last_0_10080 = $std_core_hnd._open_none1(function(_this_0 /* keyed-row<6153,6151,6152> */ ) {
          return _this_0.row_last;
        }, row);
       
      var result = $std_core_hnd._open_none1(dom_attempt_raw, function() {
          return dom_range_next(parent, first_10079, last_0_10080);
        });
       
      var _x83 = $std_core_hnd._open_none1(dom_attempt_ok, result);
      if (_x83) {
        var x_11796 = $std_core_hnd._open_none1(dom_attempt_value, result);
      }
      else {
        var x_11796 = $std_core_exn.$throw($std_core_types._lp__plus__plus__rp_("browser DOM exception: ", $std_core_hnd._open_none1(dom_attempt_message, result)));
      }
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(next_0 /* node */ ) {
          return _mlift_rollback_keyed_order_11413(last, parent, row, next_0);
        });
      }
      else {
        return _mlift_rollback_keyed_order_11413(last, parent, row, x_11796);
      }
    });
}
...
// monadic lift
export function _mlift_validate_keyed_move_lifecycles_11414(first_10082, last_10083, parent, wild__) /* (first@10082 : node, last@10083 : node, parent : node, wild_ : ()) -> <ui,exn> () */  {
   
  var result = $std_core_hnd._open_none1(dom_attempt_raw, function() {
      return dom_validate_range_move_focus(parent, first_10082, last_10083);
    });
  var _x83 = $std_core_hnd._open_none1(dom_attempt_ok, result);
  if (_x83) {
    return $std_core_hnd._open_none1(dom_attempt_value, result);
...
export function validate_keyed_move_lifecycles(parent, rows) /* forall<a,b,e> (parent : node, rows : list<keyed-row<e,a,b>>) -> <ui,exn> () */  {
  return $std_core_list.foreach(rows, function(row /* keyed-row<6237,6235,6236> */ ) {
       
      var first_10082 = $std_core_hnd._open_none1(function(_this /* keyed-row<6237,6235,6236> */ ) {
          return _this.row_first;
        }, row);
       
      var last_10083 = $std_core_hnd._open_none1(function(_this_0 /* keyed-row<6237,6235,6236> */ ) {
          return _this_0.row_last;
        }, row);
       
      var result = $std_core_hnd._open_none1(dom_attempt_raw, function() {
          return dom_validate_range_move_lifecycle(parent, first_10082, last_10083);
        });
       
      var _x84 = $std_core_hnd._open_none1(dom_attempt_ok, result);
      if (_x84) {
        var x_11800 = $std_core_hnd._open_none1(dom_attempt_value, result);
      }
      else {
        var x_11800 = $std_core_exn.$throw($std_core_types._lp__plus__plus__rp_("browser DOM exception: ", $std_core_hnd._open_none1(dom_attempt_message, result)));
      }
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(wild__ /* () */ ) {
          return _mlift_validate_keyed_move_lifecycles_11414(first_10082, last_10083, parent, wild__);
        });
      }
      else {
        return _mlift_validate_keyed_move_lifecycles_11414(first_10082, last_10083, parent, x_11800);
      }
    });
}
...
// monadic lift
export function _mlift_validate_keyed_order_11415(last, parent, rest, next) /* forall<a,b,e> (last : node, parent : node, rest : list<keyed-row<e,a,b>>, next : node) -> <ui,exn> () */  {
...
export function validate_keyed_order(parent_0, last_0, cursor, rows) /* forall<a,b,e> (parent : node, last : node, cursor : node, rows : list<keyed-row<e,a,b>>) -> <ui,exn> () */  { tailcall: while(1)
{
  if (rows === null) {
    ...
    var _x_x2_0_11164 = $std_core_hnd._open_none1(function(_this /* keyed-row<6395,6393,6394> */ ) {
        return _this.row_first;
      }, rows.head);
     
    var _x_x1_0_11162 = $std_core_hnd._open_none2(dom_same_node, cursor, _x_x2_0_11164);
    ...
    if (_x85) {
      ...
      var first_10085 = $std_core_hnd._open_none1(function(_this_0 /* keyed-row<6395,6393,6394> */ ) {
          return _this_0.row_first;
        }, rows.head);
       
      var last_0_10086 = $std_core_hnd._open_none1(function(_this_1 /* keyed-row<6395,6393,6394> */ ) {
          return _this_1.row_last;
        }, rows.head);
       
      var result = $std_core_hnd._open_none1(dom_attempt_raw, function() {
          return dom_range_next(parent_0, first_10085, last_0_10086);
        });
      ...
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(next_1 /* node */ ) {
          return _mlift_validate_keyed_order_11415(last_0, parent_0, rows.tail, next_1);
        });
      }
      else {
        {
...
// monadic lift
export function _mlift_keyed_order_matches_11416(last, parent, rest, next) /* forall<a,b,e> (last : node, parent : node, rest : list<keyed-row<e,a,b>>, next : node) -> <ui,exn> bool */  {
...
export function keyed_order_matches(parent_0, last_0, cursor, rows) /* forall<a,b,e> (parent : node, last : node, cursor : node, rows : list<keyed-row<e,a,b>>) -> <ui,exn> bool */  { tailcall: while(1)
{
  if (rows === null) {
    ...
    var _x_x2_0_11172 = $std_core_hnd._open_none1(function(_this /* keyed-row<6526,6524,6525> */ ) {
        return _this.row_first;
      }, rows.head);
     
    var _x_x1_0_11170 = $std_core_hnd._open_none2(dom_same_node, cursor, _x_x2_0_11172);
    ...
    if (_x86) {
      ...
      var first_10088 = $std_core_hnd._open_none1(function(_this_0 /* keyed-row<6526,6524,6525> */ ) {
          return _this_0.row_first;
        }, rows.head);
       
      var last_0_10089 = $std_core_hnd._open_none1(function(_this_1 /* keyed-row<6526,6524,6525> */ ) {
          return _this_1.row_last;
        }, rows.head);
       
      var result = $std_core_hnd._open_none1(dom_attempt_raw, function() {
          return dom_range_next(parent_0, first_10088, last_0_10089);
        });
       
      var _x87 = $std_core_hnd._open_none1(dom_attempt_ok, result);
      if (_x87) {
        var x_11807 = $std_core_hnd._open_none1(dom_attempt_value, result);
      }
      else {
        var x_11807 = $std_core_exn.$throw($std_core_types._lp__plus__plus__rp_("browser DOM exception: ", $std_core_hnd._open_none1(dom_attempt_message, result)));
      }
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(next_1 /* node */ ) {
          return _mlift_keyed_order_matches_11416(last_0, parent_0, rows.tail, next_1);
        });
      }
      else {
        {
...
// monadic lift
export function _mlift_place_keyed_updates_11417(cursor, parent, rest, wild___1) /* forall<a,b,e> (cursor : node, parent : node, rest : list<keyed-update<e,a,b>>, wild_@1 : ()) -> <ui,exn> node */  {
  return place_keyed_updates(parent, cursor, rest);
}
 
 
// monadic lift
export function _mlift_place_keyed_updates_11418(cursor_0, first_10263, last_10264, parent_0, rest_0, focus) /* forall<a,b,e> (cursor : node, first@10263 : node, last@10264 : node, parent : node, rest : list<keyed-update<e,a,b>>, focus : any) -> <ui,exn> node */  {
   
  var result = $std_core_hnd._open_none1(dom_attempt_raw, function() {
      return dom_move_range_before(parent_0, first_10263, last_10264, cursor_0, focus);
    });
   
  var _x87 = $std_core_hnd._open_none1(dom_attempt_ok, result);
  if (_x87) {
    var x_11811 = $std_core_hnd._open_none1(dom_attempt_value, result);
  }
  else {
    var x_11811 = $std_core_exn.$throw($std_core_types._lp__plus__plus__rp_("browser DOM exception: ", $std_core_hnd._open_none1(dom_attempt_message, result)));
  }
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(wild___1_0 /* () */ ) {
      return _mlift_place_keyed_updates_11417(cursor_0, parent_0, rest_0, wild___1_0);
    });
  }
  else {
    return _mlift_place_keyed_updates_11417(cursor_0, parent_0, rest_0, x_11811);
  }
}
 
 
// monadic lift
export function _mlift_place_keyed_updates_11419(cursor_1, first_10263_0, last_10264_0, parent_1, rest_1, wild___0) /* forall<a,b,e> (cursor : node, first@10263 : node, last@10264 : node, parent : node, rest : list<keyed-update<e,a,b>>, wild_@0 : ()) -> <ui,exn> node */  {
   
  var result_0 = $std_core_hnd._open_none1(dom_attempt_raw, function() {
      return dom_capture_range_focus(parent_1, first_10263_0, last_10264_0);
    });
   
  var _x87 = $std_core_hnd._open_none1(dom_attempt_ok, result_0);
  if (_x87) {
    var x_0_11814 = $std_core_hnd._open_none1(dom_attempt_value, result_0);
  }
  else {
    var x_0_11814 = $std_core_exn.$throw($std_core_types._lp__plus__plus__rp_("browser DOM exception: ", $std_core_hnd._open_none1(dom_attempt_message, result_0)));
  }
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(focus_0 /* any */ ) {
      return _mlift_place_keyed_updates_11418(cursor_1, first_10263_0, last_10264_0, parent_1, rest_1, focus_0);
    });
  }
  else {
    return _mlift_place_keyed_updates_11418(cursor_1, first_10263_0, last_10264_0, parent_1, rest_1, x_0_11814);
  }
}
 
 
// monadic lift
export function _mlift_place_keyed_updates_11420(cursor_2, first_10263_1, last_10264_1, parent_2, rest_2, wild__) /* forall<a,b,e> (cursor : node, first@10263 : node, last@10264 : node, parent : node, rest : list<keyed-update<e,a,b>>, wild_ : ()) -> <ui,exn> node */  {
   
  var result_1 = $std_core_hnd._open_none1(dom_attempt_raw, function() {
      return dom_validate_range_move_focus(parent_2, first_10263_1, last_10264_1);
    });
   
  var _x87 = $std_core_hnd._open_none1(dom_attempt_ok, result_1);
  if (_x87) {
    var x_1_11817 = $std_core_hnd._open_none1(dom_attempt_value, result_1);
  }
  else {
    var x_1_11817 = $std_core_exn.$throw($std_core_types._lp__plus__plus__rp_("browser DOM exception: ", $std_core_hnd._open_none1(dom_attempt_message, result_1)));
  }
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(wild___0_0 /* () */ ) {
      return _mlift_place_keyed_updates_11419(cursor_2, first_10263_1, last_10264_1, parent_2, rest_2, wild___0_0);
    });
  }
  else {
    return _mlift_place_keyed_updates_11419(cursor_2, first_10263_1, last_10264_1, parent_2, rest_2, x_1_11817);
  }
}
 
 
// monadic lift
export function _mlift_place_keyed_updates_11421(cursor_3, parent_3, rest_3, row, next_2) /* forall<a,b,e> (cursor : node, parent : node, rest : list<keyed-update<e,a,b>>, row : keyed-row<e,a,b>, next : node) -> <ui,exn> node */  {
   
  var _x_x2_11180 = $std_core_hnd._open_none1(function(_this_2 /* keyed-row<6702,6700,6701> */ ) {
      return _this_2.row_first;
    }, row);
  var _x87 = $std_core_hnd._open_none2(dom_same_node, cursor_3, _x_x2_11180);
  if (_x87) {
    return place_keyed_updates(parent_3, next_2, rest_3);
  }
  else {
     
    var first_10263_2 = $std_core_hnd._open_none1(function(_this_3 /* keyed-row<6702,6700,6701> */ ) {
        return _this_3.row_first;
      }, row);
     
    var last_10264_2 = $std_core_hnd._open_none1(function(_this_4 /* keyed-row<6702,6700,6701> */ ) {
        return _this_4.row_last;
      }, row);
     
    var result_2 = $std_core_hnd._open_none1(dom_attempt_raw, function() {
        return dom_validate_range_move_lifecycle(parent_3, first_10263_2, last_10264_2);
      });
     
    var _x88 = $std_core_hnd._open_none1(dom_attempt_ok, result_2);
    if (_x88) {
      var x_2_11820 = $std_core_hnd._open_none1(dom_attempt_value, result_2);
    }
    else {
      var x_2_11820 = $std_core_exn.$throw($std_core_types._lp__plus__plus__rp_("browser DOM exception: ", $std_core_hnd._open_none1(dom_attempt_message, result_2)));
    }
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(wild___2 /* () */ ) {
        return _mlift_place_keyed_updates_11420(cursor_3, first_10263_2, last_10264_2, parent_3, rest_3, wild___2);
      });
    }
    else {
      return _mlift_place_keyed_updates_11420(cursor_3, first_10263_2, last_10264_2, parent_3, rest_3, x_2_11820);
    }
  }
}
...
export function place_keyed_updates(parent_4, cursor_4, updates) /* forall<a,b,e> (parent : node, cursor : node, updates : list<keyed-update<e,a,b>>) -> <ui,exn> node */  { tailcall: while(1)
{
  if (updates === null) {
    ...
    var row_0 = $std_core_hnd._open_none1(function(_this /* keyed-update<6702,6700,6701> */ ) {
        return _this.update_row;
      }, updates.head);
     
    var first_10091 = $std_core_hnd._open_none1(function(_this_0 /* keyed-row<6702,6700,6701> */ ) {
        return _this_0.row_first;
      }, row_0);
     
    var last_10092 = $std_core_hnd._open_none1(function(_this_1 /* keyed-row<6702,6700,6701> */ ) {
        return _this_1.row_last;
      }, row_0);
     
    var result_3 = $std_core_hnd._open_none1(dom_attempt_raw, function() {
        return dom_range_next(parent_4, first_10091, last_10092);
      });
     
    var _x88 = $std_core_hnd._open_none1(dom_attempt_ok, result_3);
    if (_x88) {
      var x_3_11823 = $std_core_hnd._open_none1(dom_attempt_value, result_3);
    }
    else {
      var x_3_11823 = $std_core_exn.$throw($std_core_types._lp__plus__plus__rp_("browser DOM exception: ", $std_core_hnd._open_none1(dom_attempt_message, result_3)));
    }
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(next_5 /* node */ ) {
        return _mlift_place_keyed_updates_11421(cursor_4, parent_4, updates.tail, row_0, next_5);
      });
    }
    else {
       
      var _x_x2_11180_0 = $std_core_hnd._open_none1(function(_this_2_0 /* keyed-row<6702,6700,6701> */ ) {
          return _this_2_0.row_first;
        }, row_0);
      var _x88 = $std_core_hnd._open_none2(dom_same_node, cursor_4, _x_x2_11180_0);
      if (_x88) {
        {
          // tail call
          cursor_4 = x_3_11823;
        ...
        var first_10263_3 = $std_core_hnd._open_none1(function(_this_3_0 /* keyed-row<6702,6700,6701> */ ) {
            return _this_3_0.row_first;
          }, row_0);
         
        var last_10264_3 = $std_core_hnd._open_none1(function(_this_4_0 /* keyed-row<6702,6700,6701> */ ) {
            return _this_4_0.row_last;
          }, row_0);
         
        var result_4 = $std_core_hnd._open_none1(dom_attempt_raw, function() {
            return dom_validate_range_move_lifecycle(parent_4, first_10263_3, last_10264_3);
          });
         
        var _x89 = $std_core_hnd._open_none1(dom_attempt_ok, result_4);
        if (_x89) {
          var x_4_11827 = $std_core_hnd._open_none1(dom_attempt_value, result_4);
        }
        else {
          var x_4_11827 = $std_core_exn.$throw($std_core_types._lp__plus__plus__rp_("browser DOM exception: ", $std_core_hnd._open_none1(dom_attempt_message, result_4)));
        }
        if ($std_core_hnd._yielding()) {
          return $std_core_hnd.yield_extend(function(wild___3 /* () */ ) {
            return _mlift_place_keyed_updates_11420(cursor_4, first_10263_3, last_10264_3, parent_4, updates.tail, wild___3);
          });
        }
        else {
           
          var result_5 = $std_core_hnd._open_none1(dom_attempt_raw, function() {
              return dom_validate_range_move_focus(parent_4, first_10263_3, last_10264_3);
            });
           
          var _x89 = $std_core_hnd._open_none1(dom_attempt_ok, result_5);
          if (_x89) {
            var x_5_11831 = $std_core_hnd._open_none1(dom_attempt_value, result_5);
          }
          else {
            var x_5_11831 = $std_core_exn.$throw($std_core_types._lp__plus__plus__rp_("browser DOM exception: ", $std_core_hnd._open_none1(dom_attempt_message, result_5)));
          }
          if ($std_core_hnd._yielding()) {
            return $std_core_hnd.yield_extend(function(wild___0_1 /* () */ ) {
              return _mlift_place_keyed_updates_11419(cursor_4, first_10263_3, last_10264_3, parent_4, updates.tail, wild___0_1);
            });
          }
          else {
             
            var result_6 = $std_core_hnd._open_none1(dom_attempt_raw, function() {
                return dom_capture_range_focus(parent_4, first_10263_3, last_10264_3);
              });
             
            var _x89 = $std_core_hnd._open_none1(dom_attempt_ok, result_6);
            if (_x89) {
              var x_6_11835 = $std_core_hnd._open_none1(dom_attempt_value, result_6);
            }
            else {
              var x_6_11835 = $std_core_exn.$throw($std_core_types._lp__plus__plus__rp_("browser DOM exception: ", $std_core_hnd._open_none1(dom_attempt_message, result_6)));
            }
            if ($std_core_hnd._yielding()) {
              return $std_core_hnd.yield_extend(function(focus_1 /* any */ ) {
                return _mlift_place_keyed_updates_11418(cursor_4, first_10263_3, last_10264_3, parent_4, updates.tail, focus_1);
              });
            }
            else {
               
              var result_7 = $std_core_hnd._open_none1(dom_attempt_raw, function() {
                  return dom_move_range_before(parent_4, first_10263_3, last_10264_3, cursor_4, x_6_11835);
                });
               
              var _x89 = $std_core_hnd._open_none1(dom_attempt_ok, result_7);
              if (_x89) {
                var x_7_11839 = $std_core_hnd._open_none1(dom_attempt_value, result_7);
              }
              else {
                var x_7_11839 = $std_core_exn.$throw($std_core_types._lp__plus__plus__rp_("browser DOM exception: ", $std_core_hnd._open_none1(dom_attempt_message, result_7)));
              }
              if ($std_core_hnd._yielding()) {
                return $std_core_hnd.yield_extend(function(wild___1_1 /* () */ ) {
                  return _mlift_place_keyed_updates_11417(cursor_4, parent_4, updates.tail, wild___1_1);
                });
              }
              else {
                {
...
export function _trmc_collect_stale_rows(rows, next, compare, _acc) /* forall<a,b,e> (rows : list<keyed-row<e,a,b>>, next : kokaine/internal/key-index/key-index<b,keyed-row<e,a,b>>, compare : (b, b) -> order, ctx<list<keyed-row<e,a,b>>>) -> list<keyed-row<e,a,b>> */  { tailcall: while(1)
{
  if (rows === null) {
    ...
    if (_x89 !== null) {
      ...
      var _trmc_x10267 = undefined;
       
      var _trmc_x10268 = $std_core_types.Cons(rows.head, _trmc_x10267);
      {
        // tail call
        var _x91 = $std_core_types._cctx_extend(_acc,_trmc_x10268,({obj: _trmc_x10268, field_name: "tail"}));
        rows = rows.tail;
        _acc = _x91;
        continue tailcall;
      }
...
// monadic lift
export function _mlift_stage_keyed_retirements_loop_11422(collected, rest, row, staged) /* forall<a,b,e> (collected : list<keyed-retirement<e,a,b>>, rest : list<keyed-row<e,a,b>>, row : keyed-row<e,a,b>, staged : dom-retirement) -> <ui,exn> list<keyed-retirement<e,a,b>> */  {
...
export function stage_keyed_retirements_loop(rows, collected_0) /* forall<a,b,e> (rows : list<keyed-row<e,a,b>>, collected : list<keyed-retirement<e,a,b>>) -> <ui,exn> list<keyed-retirement<e,a,b>> */  { tailcall: while(1)
{
  if (rows === null) {
    ...
    if (_x94) {
      var x_11843 = $std_core_hnd._open_none1(dom_attempt_value, result);
    }
    else {
      var x_11843 = $std_core_exn.$throw($std_core_types._lp__plus__plus__rp_("browser DOM exception: ", $std_core_hnd._open_none1(dom_attempt_message, result)));
    }
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(staged_0 /* dom-retirement */ ) {
        return _mlift_stage_keyed_retirements_loop_11422(collected_0, rows.tail, rows.head, staged_0);
      });
    }
    else {
      {
        // tail call
        var _x92 = $std_core_types.Cons(Keyed_retirement(rows.head, x_11843), collected_0);
        rows = rows.tail;
        collected_0 = _x92;
        continue tailcall;
      }
...
// monadic lift
export function _mlift_detach_keyed_retirements_loop_11423(current, detached, index, order, rest, table, wild__) /* forall<_e,_e1,a,b,e2> (current : keyed-retirement<e2,a,b>, detached : ref<global,list<keyed-row<e2,a,b>>>, index : kokaine/internal/key-index/key-index<b,keyed-row<e2,a,b>>, order : list<keyed-row<e2,a,b>>, rest : list<keyed-retirement<e2,a,b>>, table : ref<global,keyed-table<e2,a,b>>, wild_ : ()) -> <ui,exn> () */  {
   
  ((table).value = (Keyed_table(index, order, rest)));
   
  var _x_x1_11184 = $std_core_hnd._open_none1(function(_this_0 /* keyed-retirement<7286,7284,7285> */ ) {
      return _this_0.retirement_handle;
    }, current);
   
  $std_core_hnd._open_none1(dom_release_retirement, _x_x1_11184);
   
  var value_1_10866 = $std_core_types.Cons($std_core_hnd._open_none1(function(_this_1 /* keyed-retirement<7286,7284,7285> */ ) {
        return _this_1.retirement_row;
      }, current), detached.value);
   
  ((detached).value = value_1_10866);
...
export function detach_keyed_retirements_loop(table_0, detached_0) /* forall<a,b,e> (table : ref<global,keyed-table<e,a,b>>, detached : ref<global,list<keyed-row<e,a,b>>>) -> <pure,ui> () */  { tailcall: while(1)
{
  ...
  if (_x93.table_retirements === null) {
    ...
    if (_x95) {
      var x_11847 = $std_core_hnd._open_none1(dom_attempt_value, result);
    }
    else {
      var x_11847 = $std_core_exn.$throw($std_core_types._lp__plus__plus__rp_("browser DOM exception: ", $std_core_hnd._open_none1(dom_attempt_message, result)));
    }
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(wild___0 /* () */ ) {
        return _mlift_detach_keyed_retirements_loop_11423(_x93.table_retirements.head, detached_0, _x93.table_index, _x93.table_order, _x93.table_retirements.tail, table_0, wild___0);
      });
    }
    else {
      ...
      var _x_x1_11184_0 = $std_core_hnd._open_none1(function(_this_0_0 /* keyed-retirement<7286,7284,7285> */ ) {
          return _this_0_0.retirement_handle;
        }, _x93.table_retirements.head);
       
      $std_core_hnd._open_none1(dom_release_retirement, _x_x1_11184_0);
       
      var value_1_10866_0 = $std_core_types.Cons($std_core_hnd._open_none1(function(_this_1_0 /* keyed-retirement<7286,7284,7285> */ ) {
            return _this_1_0.retirement_row;
          }, _x93.table_retirements.head), detached_0.value);
       
      ((detached_0).value = value_1_10866_0);
      {
        // tail call
        continue tailcall;
      }
...
// monadic lift
export function _mlift_drain_keyed_retirements_11424(rows) /* forall<a,b,e> (rows : list<keyed-row<e,a,b>>) -> <exn,ui> () */  {
  return exhaust_keyed_row_actions(rows, function(row /* keyed-row<7399,7397,7398> */ ) {
       
      var scope_10077 = $std_core_hnd._open_none1(function(_this /* keyed-row<7399,7397,7398> */ ) {
          return _this.row_scope;
        }, row);
      return $kokaine_reactive_integration_internal_lifetime_dash_scope.lifetime_scope_fs_dispose($std_core_hnd._open_none1(function(value /* kokaine/reactive/integration/lifetime-scope<ui> */ ) {
          return value;
...
export function drain_keyed_retirements(table) /* forall<a,b,e> (table : ref<global,keyed-table<e,a,b>>) -> <ui,exn> () */  {
  ...
  return $std_core_hnd.finally_prompt(function() {
      ...
      var xs_10870 = detached.value;
       
      var x_11854 = $std_core_list.reverse_acc($std_core_types.Nil, xs_10870);
       
      function next_11855(rows) /* (list<keyed-row<7399,7397,7398>>) -> <exn,ui> () */  {
        return exhaust_keyed_row_actions(rows, function(row /* keyed-row<7399,7397,7398> */ ) {
      ...
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(next_11855);
      }
      else {
        return next_11855(x_11854);
      }
...
// monadic lift
export function _mlift_commit_keyed_update_11425(row, update, wild___1) /* forall<_e,a,b,e1> (row : keyed-row<e1,a,b>, update : keyed-update<e1,a,b>, wild_@1 : ()) -> kokaine/reactive/effects/signal-write () */  {
   
  var target_0_10885 = $std_core_hnd._open_none1(function(_this_8 /* keyed-row<7631,7629,7630> */ ) {
      return _this_8.row_current_index;
    }, row);
   
  var value_3_10886 = $std_core_hnd._open_none1(function(_this_9 /* keyed-update<7631,7629,7630> */ ) {
      return _this_9.update_index;
    }, update);
  return ((target_0_10885).value = value_3_10886);
}
 
 
// monadic lift
export function _mlift_commit_keyed_update_11426(row, update, wild__) /* forall<_e,a,b,e1> (row : keyed-row<e1,a,b>, update : keyed-update<e1,a,b>, wild_ : ()) -> kokaine/reactive/effects/signal-write () */  {
   
  var target_10877 = $std_core_hnd._open_none1(function(_this_3 /* keyed-row<7631,7629,7630> */ ) {
      return _this_3.row_current_item;
    }, row);
   
  var value_0_10878 = $std_core_hnd._open_none1(function(_this_4 /* keyed-update<7631,7629,7630> */ ) {
      return _this_4.update_item;
    }, update);
  return ((target_10877).value = value_0_10878);
}
 
 
// monadic lift
export function _mlift_commit_keyed_update_11427(row, update, _c_x10495) /* forall<_e,a,b,e1> (row : keyed-row<e1,a,b>, update : keyed-update<e1,a,b>, ()) -> () */  {
  var _x94 = $std_core_hnd._open_none1(function(_this_5 /* keyed-update<7631,7629,7630> */ ) {
      return _this_5.update_index_changed;
    }, update);
  if (_x94) {
     
    var value_2_10110 = $std_core_hnd._open_none1(function(_this_6 /* keyed-row<7631,7629,7630> */ ) {
        return _this_6.row_index_source;
      }, row);
     
    var next_0_10111 = $std_core_hnd._open_none1(function(_this_7 /* keyed-update<7631,7629,7630> */ ) {
    ...
    var x_11856 = $kokaine_reactive_internal_runtime.signal_fs_set(value_0_10023_0, next_0_10111);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(wild___1 /* () */ ) {
        return _mlift_commit_keyed_update_11425(row, update, wild___1);
      });
    }
    else {
      return _mlift_commit_keyed_update_11425(row, update, x_11856);
    }
  }
  else {
    return $std_core_types.Unit;
...
export function commit_keyed_update(update) /* forall<a,b,e> (update : keyed-update<e,a,b>) -> kokaine/reactive/effects/signal-write () */  {
  ...
  var row = $std_core_hnd._open_none1(function(_this /* keyed-update<7631,7629,7630> */ ) {
      return _this.update_row;
    }, update);
   
  var _x95 = $std_core_hnd._open_none1(function(_this_0 /* keyed-update<7631,7629,7630> */ ) {
      return _this_0.update_item_changed;
    }, update);
  if (_x95) {
     
    var value_10107 = $std_core_hnd._open_none1(function(_this_1 /* keyed-row<7631,7629,7630> */ ) {
        return _this_1.row_item_source;
      }, row);
     
    var next_10108 = $std_core_hnd._open_none1(function(_this_2 /* keyed-update<7631,7629,7630> */ ) {
        return _this_2.update_item;
      }, update);
     
    var value_0_10023 = $std_core_hnd._open_none1(function(value_1 /* kokaine/reactive/signal<7629> */ ) {
        return value_1;
      }, value_10107);
     
    var x_0_11861 = $kokaine_reactive_internal_runtime.signal_fs_set(value_0_10023, next_10108);
    if ($std_core_hnd._yielding()) {
      var x_11858 = $std_core_hnd.yield_extend(function(wild__ /* () */ ) {
        return _mlift_commit_keyed_update_11426(row, update, wild__);
      });
    }
    else {
      var x_11858 = _mlift_commit_keyed_update_11426(row, update, x_0_11861);
    }
  }
  else {
    var x_11858 = $std_core_types.Unit;
  }
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(_c_x10495 /* () */ ) {
      return _mlift_commit_keyed_update_11427(row, update, _c_x10495);
    });
  }
  else {
    var _x95 = $std_core_hnd._open_none1(function(_this_5 /* keyed-update<7631,7629,7630> */ ) {
        return _this_5.update_index_changed;
      }, update);
    if (_x95) {
      ...
      var x_1_11863 = $kokaine_reactive_internal_runtime.signal_fs_set(value_0_10023_0, next_0_10111);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(wild___1 /* () */ ) {
          return _mlift_commit_keyed_update_11425(row, update, wild___1);
        });
...
// monadic lift
export function _mlift_create_keyed_row_11428(scope, _y_x10500) /* (scope : kokaine/reactive/integration/lifetime-scope<ui>, hnd/ev-index) -> <kokaine/reactive/effects/signal-write,div,exn,ui> () */  {
  return $std_core_hnd._mask_at(_y_x10500, false, function() {
...
// monadic lift
export function _mlift_create_keyed_row_11429(first, row_last, _y_x10507) /* (first : node, row-last : node, hnd/ev-index) -> <kokaine/reactive/effects/signal-write,div,exn,ui> () */  {
  return $std_core_hnd._mask_at(_y_x10507, false, function() {
      ...
      return $kokaine_reactive.sample(root_0, function() {
          ...
          var x_1_11874 = $kokaine_html.collect(function() {
            return $std_core_hnd._open2($std_core_vector.unvlist($std_core_types.Cons(1, $std_core_types.Cons(2, $std_core_types.Nil))), children, function() {
                ...
                var value_0_10022 = $std_core_hnd._open_none1(function(value_1_0 /* kokaine/reactive/signal<10841> */ ) {
                    return value_1_0;
                  }, item_source_1);
          ...
          if ($std_core_hnd._yielding()) {
            return $std_core_hnd.yield_extend(function(_y_x10531_0 /* list<kokaine/html/view<10842>> */ ) {
              return _mlift_create_keyed_row_11431(_y_x10531_0);
            });
          }
          else {
            return _mlift_create_keyed_row_11431(x_1_11874);
          }
        });
    });
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(tree_0 /* kokaine/html/view<10842> */ ) {
      return _mlift_create_keyed_row_11432(committed_1, first_2, identity_1, index_1, index_source_1, item_1, item_source_1, parent_0, renderer_0, root_0, row_last_2, scope_2, tree_0);
    });
  }
  else {
    return _mlift_create_keyed_row_11432(committed_1, first_2, identity_1, index_1, index_source_1, item_1, item_source_1, parent_0, renderer_0, root_0, row_last_2, scope_2, x_0_11871);
  }
}
 
 
// monadic lift
export function _mlift_create_keyed_row_11434(_y_x10525) /* (kokaine/reactive/internal/model/signal<int>) -> exn kokaine/reactive/signal<int> */  {
  return _y_x10525;
}
 
 
// monadic lift
export function _mlift_create_keyed_row_11435(children_0, committed_2, first_3, identity_2, index_2, item_2, item_source_2, parent_1, renderer_1, root_1, row_last_3, scope_3, index_source_2) /* forall<_e,_e1,a,b,e2> (children : (item : kokaine/html/accessor<b>, index : kokaine/html/accessor<int>) -> <kokaine/html/html<e2>,kokaine/reactive/effects/signal-read> (), committed : ref<global,bool>, first : node, identity : a, index : int, item : b, item-source : kokaine/reactive/signal<b>, parent : node, renderer : kokaine/dom/internal/keyed-transaction/keyed-context, root : kokaine/reactive/root<ui>, row-last : node, scope : kokaine/reactive/integration/lifetime-scope<ui>, index-source : kokaine/reactive/signal<int>) -> <exn,div,kokaine/reactive/effects/signal-write,ui> keyed-row<e2,b,a> */  {
   
  var x_2_11876 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_write_fs__tag);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(_y_x10527_0 /* hnd/ev-index */ ) {
      return _mlift_create_keyed_row_11433(children_0, committed_2, first_3, identity_2, index_2, index_source_2, item_2, item_source_2, parent_1, renderer_1, root_1, row_last_3, scope_3, _y_x10527_0);
    });
  }
  else {
    return _mlift_create_keyed_row_11433(children_0, committed_2, first_3, identity_2, index_2, index_source_2, item_2, item_source_2, parent_1, renderer_1, root_1, row_last_3, scope_3, x_2_11876);
  }
}
 
 
// monadic lift
export function _mlift_create_keyed_row_11436(_y_x10523) /* forall<a> (kokaine/reactive/internal/model/signal<a>) -> exn kokaine/reactive/signal<a> */  {
  return _y_x10523;
}
 
 
// monadic lift
export function _mlift_create_keyed_row_11437(children_1, committed_3, first_4, identity_3, index_3, item_3, parent_2, renderer_2, root_2, row_last_4, scope_4, item_source_3) /* forall<_e,_e1,a,b,e2> (children : (item : kokaine/html/accessor<b>, index : kokaine/html/accessor<int>) -> <kokaine/html/html<e2>,kokaine/reactive/effects/signal-read> (), committed : ref<global,bool>, first : node, identity : a, index : int, item : b, parent : node, renderer : kokaine/dom/internal/keyed-transaction/keyed-context, root : kokaine/reactive/root<ui>, row-last : node, scope : kokaine/reactive/integration/lifetime-scope<ui>, item-source : kokaine/reactive/signal<b>) -> <exn,div,kokaine/reactive/effects/signal-write,ui> keyed-row<e2,b,a> */  {
   
  var x_3_11878 = $std_core_hnd._open_at2(0, function(root_3 /* kokaine/reactive/root<ui> */ , initial_0 /* int */ ) {
       
      var root_1_10019_0 = $std_core_hnd._open_none1(function(value_11 /* kokaine/reactive/root<ui> */ ) {
          return value_11;
        }, root_3);
       
      var x_4_11880 = $kokaine_reactive_internal_runtime.signal_by(root_1_10019_0, initial_0, function(___wildcard_x87__29_0 /* int */ , ___wildcard_x87__31_0 /* int */ ) {
          return false;
        });
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(_mlift_create_keyed_row_11434);
      }
      else {
        return _mlift_create_keyed_row_11434(x_4_11880);
      }
    }, root_2, index_3);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(index_source_3 /* kokaine/reactive/signal<int> */ ) {
      return _mlift_create_keyed_row_11435(children_1, committed_3, first_4, identity_3, index_3, item_3, item_source_3, parent_2, renderer_2, root_2, row_last_4, scope_4, index_source_3);
    });
  }
  else {
    return _mlift_create_keyed_row_11435(children_1, committed_3, first_4, identity_3, index_3, item_3, item_source_3, parent_2, renderer_2, root_2, row_last_4, scope_4, x_3_11878);
  }
}
 
 
// monadic lift
export function _mlift_create_keyed_row_11438(_pat_6_0) /* (kokaine/reactive/internal/model/cleanup-registration<ui>) -> exn () */  {
  return $std_core_types.Unit;
}
 
 
// monadic lift
export function _mlift_create_keyed_row_11439(first_5, row_last_5, _y_x10518) /* (first : node, row-last : node, hnd/ev-index) -> <kokaine/reactive/effects/signal-write,div,exn,ui> () */  {
  return $std_core_hnd._mask_at(_y_x10518, false, function() {
...
// monadic lift
export function _mlift_create_keyed_row_11440(children_2, committed_4, first_6, identity_4, index_4, item_4, parent_3, range_owned, renderer_3, root_4, row_last_6, scope_5, wild___1) /* forall<_e,_e1,a,b,e2> (children : (item : kokaine/html/accessor<b>, index : kokaine/html/accessor<int>) -> <kokaine/html/html<e2>,kokaine/reactive/effects/signal-read> (), committed : ref<global,bool>, first : node, identity : a, index : int, item : b, parent : node, range-owned : ref<global,bool>, renderer : kokaine/dom/internal/keyed-transaction/keyed-context, root : kokaine/reactive/root<ui>, row-last : node, scope : kokaine/reactive/integration/lifetime-scope<ui>, wild_@1 : ()) -> <exn,div,kokaine/reactive/effects/signal-write,ui> keyed-row<e2,b,a> */  {
   
  ((range_owned).value = true);
   
  var x_5_11884 = $std_core_hnd._open_at2(0, function(root_2_0 /* kokaine/reactive/root<ui> */ , initial /* 10841 */ ) {
       
      var root_1_10019 = $std_core_hnd._open_none1(function(value_10 /* kokaine/reactive/root<ui> */ ) {
          return value_10;
        }, root_2_0);
       
      var x_6_11886 = $kokaine_reactive_internal_runtime.signal_by(root_1_10019, initial, function(___wildcard_x87__29 /* 10841 */ , ___wildcard_x87__31 /* 10841 */ ) {
          return false;
        });
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_y_x10523_0 /* kokaine/reactive/internal/model/signal<10841> */ ) {
          return _mlift_create_keyed_row_11436(_y_x10523_0);
        });
      }
      else {
        return _mlift_create_keyed_row_11436(x_6_11886);
      }
    }, root_4, item_4);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(item_source_4 /* kokaine/reactive/signal<10841> */ ) {
      return _mlift_create_keyed_row_11437(children_2, committed_4, first_6, identity_4, index_4, item_4, parent_3, renderer_3, root_4, row_last_6, scope_5, item_source_4);
    });
  }
  else {
    return _mlift_create_keyed_row_11437(children_2, committed_4, first_6, identity_4, index_4, item_4, parent_3, renderer_3, root_4, row_last_6, scope_5, x_5_11884);
  }
}
 
 
// monadic lift
export function _mlift_create_keyed_row_11441(children_3, committed_5, first_7, identity_5, index_5, installed, item_5, parent_4, range_owned_0, renderer_4, root_5, row_last_7, scope_6, wild__) /* forall<_e,_e1,a,b,e2> (children : (item : kokaine/html/accessor<b>, index : kokaine/html/accessor<int>) -> <kokaine/html/html<e2>,kokaine/reactive/effects/signal-read> (), committed : ref<global,bool>, first : node, identity : a, index : int, installed : ref<global,bool>, item : b, parent : node, range-owned : ref<global,bool>, renderer : kokaine/dom/internal/keyed-transaction/keyed-context, root : kokaine/reactive/root<ui>, row-last : node, scope : kokaine/reactive/integration/lifetime-scope<ui>, wild_ : ()) -> <exn,ui,div,kokaine/reactive/effects/signal-write> keyed-row<e2,b,a> */  {
   
  ((installed).value = true);
   
  var x_7_11888 = $std_core_hnd._open_at2(0, function(root_1_0 /* kokaine/reactive/root<ui> */ , cleanup /* () -> <kokaine/reactive/effects/signal-write,pure,ui> () */ ) {
       
      var root_0_10046 = $std_core_hnd._open_none1(function(value_8 /* kokaine/reactive/root<ui> */ ) {
          return value_8;
        }, root_1_0);
       
      var x_8_11890 = $kokaine_reactive_internal_runtime.register_cleanup(root_0_10046, cleanup);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(_mlift_create_keyed_row_11438);
      }
      else {
        return _mlift_create_keyed_row_11438(x_8_11890);
      }
    }, root_5, function() {
       
      var x_9_11892 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_write_fs__tag);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_y_x10518_0 /* hnd/ev-index */ ) {
          return _mlift_create_keyed_row_11439(first_7, row_last_7, _y_x10518_0);
        });
      }
      else {
        return _mlift_create_keyed_row_11439(first_7, row_last_7, x_9_11892);
      }
    });
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(wild___1_0 /* () */ ) {
      return _mlift_create_keyed_row_11440(children_3, committed_5, first_7, identity_5, index_5, item_5, parent_4, range_owned_0, renderer_4, root_5, row_last_7, scope_6, wild___1_0);
    });
  }
  else {
    return _mlift_create_keyed_row_11440(children_3, committed_5, first_7, identity_5, index_5, item_5, parent_4, range_owned_0, renderer_4, root_5, row_last_7, scope_6, x_7_11888);
  }
}
 
 
// monadic lift
export function _mlift_create_keyed_row_11442(children_4, committed_6, first_8, identity_6, index_6, installed_0, item_6, last, parent_5, range_owned_1, renderer_5, root_6, scope_7, row_last_8) /* forall<_e,_e1,_e2,a,b,e3> (children : (item : kokaine/html/accessor<b>, index : kokaine/html/accessor<int>) -> <kokaine/html/html<e3>,kokaine/reactive/effects/signal-read> (), committed : ref<global,bool>, first : node, identity : a, index : int, installed : ref<global,bool>, item : b, last : node, parent : node, range-owned : ref<global,bool>, renderer : kokaine/dom/internal/keyed-transaction/keyed-context, root : kokaine/reactive/root<ui>, scope : kokaine/reactive/integration/lifetime-scope<ui>, row-last : node) -> <exn,ui,div,kokaine/reactive/effects/signal-write> keyed-row<e3,b,a> */  {
   
  var x_11_11898 = $std_core_hnd._open_at4(0, function(parent_0_0 /* node */ , before /* maybe<node> */ , first_1_0 /* node */ , last_1 /* node */ ) {
      if (before === null) {
  ...
  if ($std_core_hnd._yielding()) {
    var _x100 = $std_core_hnd.yield_extend(function(wild___0 /* () */ ) {
      return _mlift_create_keyed_row_11441(children_4, committed_6, first_8, identity_6, index_6, installed_0, item_6, parent_5, range_owned_1, renderer_5, root_6, row_last_8, scope_7, wild___0);
    });
  }
  else {
    var _x100 = _mlift_create_keyed_row_11441(children_4, committed_6, first_8, identity_6, index_6, installed_0, item_6, parent_5, range_owned_1, renderer_5, root_6, row_last_8, scope_7, x_11_11898);
  }
  return $std_core_hnd.finally_prompt(function() {
      var _x98 = installed_0.value;
      if (_x98) {
         
        var _x_x1_4_11205 = range_owned_1.value;
        var _x99 = $std_core_hnd._open_none1(function(b /* bool */ ) {
            return (b) ? false : true;
          }, _x_x1_4_11205);
        if (_x99) {
           
          var x_10_11896 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_write_fs__tag);
          if ($std_core_hnd._yielding()) {
            return $std_core_hnd.yield_extend(function(_y_x10507_0 /* hnd/ev-index */ ) {
              return _mlift_create_keyed_row_11429(first_8, row_last_8, _y_x10507_0);
            });
          }
          else {
            return _mlift_create_keyed_row_11429(first_8, row_last_8, x_10_11896);
          }
        }
        else {
          return $std_core_types.Unit;
...
// monadic lift
export function _mlift_create_keyed_row_11443(children_5, committed_7, identity_7, index_7, installed_1, item_7, last_0, parent_6, range_owned_2, renderer_6, root_7, scope_8, first_9) /* forall<_e,_e1,_e2,a,b,e3> (children : (item : kokaine/html/accessor<b>, index : kokaine/html/accessor<int>) -> <kokaine/html/html<e3>,kokaine/reactive/effects/signal-read> (), committed : ref<global,bool>, identity : a, index : int, installed : ref<global,bool>, item : b, last : node, parent : node, range-owned : ref<global,bool>, renderer : kokaine/dom/internal/keyed-transaction/keyed-context, root : kokaine/reactive/root<ui>, scope : kokaine/reactive/integration/lifetime-scope<ui>, first : node) -> <exn,ui,div,kokaine/reactive/effects/signal-write> keyed-row<e3,b,a> */  {
   
  var x_12_11902 = $std_core_hnd._open_at1(0, dom_attempt, function() {
      return dom_create_comment("/kokaine:for-row");
    });
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(row_last_9 /* node */ ) {
      return _mlift_create_keyed_row_11442(children_5, committed_7, first_9, identity_7, index_7, installed_1, item_7, last_0, parent_6, range_owned_2, renderer_6, root_7, scope_8, row_last_9);
    });
  }
  else {
    return _mlift_create_keyed_row_11442(children_5, committed_7, first_9, identity_7, index_7, installed_1, item_7, last_0, parent_6, range_owned_2, renderer_6, root_7, scope_8, x_12_11902);
  }
}
 
 
// monadic lift
export function _mlift_create_keyed_row_11444(_y_x10498) /* (kokaine/reactive/integration/internal/lifetime-scope/lifetime-scope<ui>) -> exn kokaine/reactive/integration/lifetime-scope<ui> */  {
  return _y_x10498;
}
 
 
// monadic lift
export function _mlift_create_keyed_row_11445(children_6, identity_8, index_8, item_8, last_2, parent_7, renderer_7, root_8, scope_9) /* forall<_e,_e1,_e2,a,b,e3> (children : (item : kokaine/html/accessor<b>, index : kokaine/html/accessor<int>) -> <kokaine/html/html<e3>,kokaine/reactive/effects/signal-read> (), identity : a, index : int, item : b, last : node, parent : node, renderer : kokaine/dom/internal/keyed-transaction/keyed-context, root : kokaine/reactive/root<ui>, scope : kokaine/reactive/integration/lifetime-scope<ui>) -> <exn,div,kokaine/reactive/effects/signal-write,ui> keyed-row<e3,b,a> */  {
  ...
  return $std_core_hnd.finally_prompt(function() {
      ...
      if (_x101) {
        ...
        var x_13_11906 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_write_fs__tag);
        if ($std_core_hnd._yielding()) {
          return $std_core_hnd.yield_extend(function(_y_x10500_0 /* hnd/ev-index */ ) {
            return _mlift_create_keyed_row_11428(scope_9, _y_x10500_0);
          });
        }
        else {
          return _mlift_create_keyed_row_11428(scope_9, x_13_11906);
        }
      }
    }, $kokaine_reactive_integration.with_lifetime_scope(root_8, scope_9, function() {
         
        var x_14_11908 = $std_core_hnd._open_at1(0, dom_attempt, function() {
            return dom_create_comment("kokaine:for-row");
          });
        if ($std_core_hnd._yielding()) {
          return $std_core_hnd.yield_extend(function(first_10 /* node */ ) {
            return _mlift_create_keyed_row_11443(children_6, committed_8, identity_8, index_8, installed_2, item_8, last_2, parent_7, range_owned_3, renderer_7, root_8, scope_9, first_10);
          });
        }
        else {
          return _mlift_create_keyed_row_11443(children_6, committed_8, identity_8, index_8, installed_2, item_8, last_2, parent_7, range_owned_3, renderer_7, root_8, scope_9, x_14_11908);
        }
      }));
}
...
// monadic lift
export function _mlift_reconcile_keyed_11446(drafts, wild___0_0) /* forall<_e,a,b,e1> (drafts : ref<global,list<keyed-row<e1,a,b>>>, wild_@0@0 : ()) -> <ui,exn> () */  {
   
  var rows_10151 = drafts.value;
  return exhaust_keyed_row_actions(rows_10151, function(row_0 /* keyed-row<10860,10858,10859> */ ) {
       
      var scope_1_10153 = $std_core_hnd._open_none1(function(_this /* keyed-row<10860,10858,10859> */ ) {
          return _this.row_scope;
        }, row_0);
...
// monadic lift
export function _mlift_reconcile_keyed_11447(drafts_0, last_0_0, move_phase, old_order, parent_0_0_0, participation, staged_retirements, _y_x10547) /* forall<_e,a,b,e1> (drafts : ref<global,list<keyed-row<e1,a,b>>>, last@0@0 : node, move-phase : ref<global,bool>, old-order : list<keyed-row<e1,a,b>>, parent@0@0 : node, participation : keyed-participation, staged-retirements : ref<global,list<keyed-retirement<e1,a,b>>>, hnd/ev-index) -> <kokaine/reactive/effects/signal-write,div,exn,ui> () */  {
  return $std_core_hnd._mask_at(_y_x10547, false, function() {
      return $std_core_hnd.finally_prompt(function() {
          ...
          if (_x102) {
            ...
            var _x_x1_1_11225 = staged_retirements.value;
             
            var x_15_11915 = $std_core_hnd._open_none1(release_keyed_retirements, _x_x1_1_11225);
            if ($std_core_hnd._yielding()) {
              return $std_core_hnd.yield_extend(function(wild___0_0_0 /* () */ ) {
                return _mlift_reconcile_keyed_11446(drafts_0, wild___0_0_0);
              });
            }
            else {
              return _mlift_reconcile_keyed_11446(drafts_0, x_15_11915);
            }
...
// monadic lift
export function _mlift_reconcile_keyed_11448(table, _y_x10610) /* forall<a,b,e> (table : ref<global,keyed-table<e,a,b>>, hnd/ev-index) -> <kokaine/reactive/effects/signal-write,div,exn,ui> () */  {
...
// monadic lift
export function _mlift_reconcile_keyed_11449(final_updates, _y_x10604) /* forall<a,b,e> (final-updates : list<keyed-update<e,a,b>>, hnd/ev-index) -> <exn,div,kokaine/reactive/effects/signal-write> () */  {
  return $std_core_hnd._mask_at(_y_x10604, false, function() {
      return $std_core_list.foreach(final_updates, function(update_1 /* keyed-update<10860,10858,10859> */ ) {
...
export function _mlift_reconcile_keyed_11450(committed_0_0, final_index, final_order, retirements, staged_retirements_0, table_0, wild___18) /* forall<_e,a,b,e1> (committed@0 : ref<global,bool>, final-index : kokaine/internal/key-index/key-index<b,keyed-row<e1,a,b>>, final-order : list<keyed-row<e1,a,b>>, retirements : list<keyed-retirement<e1,a,b>>, staged-retirements : ref<global,list<keyed-retirement<e1,a,b>>>, table : ref<global,keyed-table<e1,a,b>>, wild_@18 : ()) -> <ui,div,exn,kokaine/reactive/effects/signal-write> () */  {
  ...
  var x_16_11919 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_write_fs__tag);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(_y_x10610_0 /* hnd/ev-index */ ) {
      return _mlift_reconcile_keyed_11448(table_0, _y_x10610_0);
    });
  }
  else {
    return _mlift_reconcile_keyed_11448(table_0, x_16_11919);
  }
}
 
 
// monadic lift
export function _mlift_reconcile_keyed_11451(committed_0_1, final_index_0, final_order_0, final_updates_0, retirements_0, staged_retirements_1, table_1, wild___17) /* forall<_e,a,b,e1> (committed@0 : ref<global,bool>, final-index : kokaine/internal/key-index/key-index<b,keyed-row<e1,a,b>>, final-order : list<keyed-row<e1,a,b>>, final-updates : list<keyed-update<e1,a,b>>, retirements : list<keyed-retirement<e1,a,b>>, staged-retirements : ref<global,list<keyed-retirement<e1,a,b>>>, table : ref<global,keyed-table<e1,a,b>>, wild_@17 : ()) -> <kokaine/reactive/effects/signal-write,div,exn,ui> () */  {
   
  var x_18_11924 = $std_core_hnd._evv_index($std_core_exn.exn_fs__tag);
   
  if ($std_core_hnd._yielding()) {
    var x_17_11921 = $std_core_hnd.yield_extend(function(_y_x10604_0 /* hnd/ev-index */ ) {
      return _mlift_reconcile_keyed_11449(final_updates_0, _y_x10604_0);
    });
  }
  else {
    var x_17_11921 = _mlift_reconcile_keyed_11449(final_updates_0, x_18_11924);
  }
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(wild___18_0 /* () */ ) {
      return _mlift_reconcile_keyed_11450(committed_0_1, final_index_0, final_order_0, retirements_0, staged_retirements_1, table_1, wild___18_0);
    });
  }
  else {
    return _mlift_reconcile_keyed_11450(committed_0_1, final_index_0, final_order_0, retirements_0, staged_retirements_1, table_1, x_17_11921);
  }
}
 
 
// monadic lift
export function _mlift_reconcile_keyed_11452(committed_0_2, final_index_1, final_order_1, final_updates_1, publication_transaction, retirements_1, staged_retirements_2, table_2, _y_x10601) /* forall<_e,a,b,e1> (committed@0 : ref<global,bool>, final-index : kokaine/internal/key-index/key-index<b,keyed-row<e1,a,b>>, final-order : list<keyed-row<e1,a,b>>, final-updates : list<keyed-update<e1,a,b>>, publication-transaction : kokaine/dom/internal/keyed-transaction/keyed-transaction, retirements : list<keyed-retirement<e1,a,b>>, staged-retirements : ref<global,list<keyed-retirement<e1,a,b>>>, table : ref<global,keyed-table<e1,a,b>>, hnd/ev-index) -> <kokaine/reactive/effects/signal-write,div,exn,ui> () */  {
   
  var x_19_11926 = $std_core_hnd._mask_at(_y_x10601, false, function() {
  ...
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(wild___17_0 /* () */ ) {
      return _mlift_reconcile_keyed_11451(committed_0_2, final_index_1, final_order_1, final_updates_1, retirements_1, staged_retirements_2, table_2, wild___17_0);
    });
  }
  else {
    return _mlift_reconcile_keyed_11451(committed_0_2, final_index_1, final_order_1, final_updates_1, retirements_1, staged_retirements_2, table_2, x_19_11926);
  }
}
 
 
// monadic lift
export function _mlift_reconcile_keyed_11453(committed_0_3, final_index_2, final_order_2, final_updates_2, publication_transaction_0, retirements_2, staged_retirements_3, table_3, wild___16) /* forall<_e,a,b,e1> (committed@0 : ref<global,bool>, final-index : kokaine/internal/key-index/key-index<b,keyed-row<e1,a,b>>, final-order : list<keyed-row<e1,a,b>>, final-updates : list<keyed-update<e1,a,b>>, publication-transaction : kokaine/dom/internal/keyed-transaction/keyed-transaction, retirements : list<keyed-retirement<e1,a,b>>, staged-retirements : ref<global,list<keyed-retirement<e1,a,b>>>, table : ref<global,keyed-table<e1,a,b>>, wild_@16 : ()) -> <kokaine/reactive/effects/signal-write,div,exn,ui> () */  {
   
  var x_20_11928 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_write_fs__tag);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(_y_x10601_0 /* hnd/ev-index */ ) {
      return _mlift_reconcile_keyed_11452(committed_0_3, final_index_2, final_order_2, final_updates_2, publication_transaction_0, retirements_2, staged_retirements_3, table_3, _y_x10601_0);
    });
  }
  else {
    return _mlift_reconcile_keyed_11452(committed_0_3, final_index_2, final_order_2, final_updates_2, publication_transaction_0, retirements_2, staged_retirements_3, table_3, x_20_11928);
  }
}
 
 
// monadic lift
export function _mlift_reconcile_keyed_11454(committed_0_4, final_index_3, final_order_3, final_updates_3, participation_0, publication_transaction_1, retirements_3, staged_retirements_4, table_4, _y_x10597) /* forall<_e,a,b,e1> (committed@0 : ref<global,bool>, final-index : kokaine/internal/key-index/key-index<b,keyed-row<e1,a,b>>, final-order : list<keyed-row<e1,a,b>>, final-updates : list<keyed-update<e1,a,b>>, participation : keyed-participation, publication-transaction : kokaine/dom/internal/keyed-transaction/keyed-transaction, retirements : list<keyed-retirement<e1,a,b>>, staged-retirements : ref<global,list<keyed-retirement<e1,a,b>>>, table : ref<global,keyed-table<e1,a,b>>, hnd/ev-index) -> <kokaine/reactive/effects/signal-write,div,exn,ui> () */  {
   
  var x_21_11930 = $std_core_hnd._mask_at(_y_x10597, false, function() {
  ...
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(wild___16_0 /* () */ ) {
      return _mlift_reconcile_keyed_11453(committed_0_4, final_index_3, final_order_3, final_updates_3, publication_transaction_1, retirements_3, staged_retirements_4, table_4, wild___16_0);
    });
  }
  else {
    return _mlift_reconcile_keyed_11453(committed_0_4, final_index_3, final_order_3, final_updates_3, publication_transaction_1, retirements_3, staged_retirements_4, table_4, x_21_11930);
  }
}
 
 
// monadic lift
export function _mlift_reconcile_keyed_11455(committed_0_5, final_index_4, final_order_4, final_updates_4, participation_1, publication_transaction_2, retirements_4, staged_retirements_5, table_5, wild___15) /* forall<_e,a,b,e1> (committed@0 : ref<global,bool>, final-index : kokaine/internal/key-index/key-index<b,keyed-row<e1,a,b>>, final-order : list<keyed-row<e1,a,b>>, final-updates : list<keyed-update<e1,a,b>>, participation : keyed-participation, publication-transaction : kokaine/dom/internal/keyed-transaction/keyed-transaction, retirements : list<keyed-retirement<e1,a,b>>, staged-retirements : ref<global,list<keyed-retirement<e1,a,b>>>, table : ref<global,keyed-table<e1,a,b>>, wild_@15 : ()) -> <kokaine/reactive/effects/signal-write,div,exn,ui> () */  {
   
  var x_22_11932 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_write_fs__tag);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(_y_x10597_0 /* hnd/ev-index */ ) {
      return _mlift_reconcile_keyed_11454(committed_0_5, final_index_4, final_order_4, final_updates_4, participation_1, publication_transaction_2, retirements_4, staged_retirements_5, table_5, _y_x10597_0);
    });
  }
  else {
    return _mlift_reconcile_keyed_11454(committed_0_5, final_index_4, final_order_4, final_updates_4, participation_1, publication_transaction_2, retirements_4, staged_retirements_5, table_5, x_22_11932);
  }
}
 
 
// monadic lift
export function _mlift_reconcile_keyed_11456(committed_0_6, final_index_5, final_order_5, final_updates_5, participation_2, publication_transaction_3, retirements_5, staged_retirements_6, table_6, _y_x10594) /* forall<_e,a,b,e1> (committed@0 : ref<global,bool>, final-index : kokaine/internal/key-index/key-index<b,keyed-row<e1,a,b>>, final-order : list<keyed-row<e1,a,b>>, final-updates : list<keyed-update<e1,a,b>>, participation : keyed-participation, publication-transaction : kokaine/dom/internal/keyed-transaction/keyed-transaction, retirements : list<keyed-retirement<e1,a,b>>, staged-retirements : ref<global,list<keyed-retirement<e1,a,b>>>, table : ref<global,keyed-table<e1,a,b>>, hnd/ev-index) -> <kokaine/reactive/effects/signal-write,div,exn,ui> () */  {
   
  var x_23_11934 = $std_core_hnd._mask_at(_y_x10594, false, function() {
  ...
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(wild___15_0 /* () */ ) {
      return _mlift_reconcile_keyed_11455(committed_0_6, final_index_5, final_order_5, final_updates_5, participation_2, publication_transaction_3, retirements_5, staged_retirements_6, table_6, wild___15_0);
    });
  }
  else {
    return _mlift_reconcile_keyed_11455(committed_0_6, final_index_5, final_order_5, final_updates_5, participation_2, publication_transaction_3, retirements_5, staged_retirements_6, table_6, x_23_11934);
  }
}
 
 
// monadic lift
export function _mlift_reconcile_keyed_11457(committed_0_7, final_index_6, final_order_6, final_updates_6, participation_3, publication_transaction_4, staged_retirements_7, table_7, retirements_6) /* forall<_e,a,b,e1> (committed@0 : ref<global,bool>, final-index : kokaine/internal/key-index/key-index<b,keyed-row<e1,a,b>>, final-order : list<keyed-row<e1,a,b>>, final-updates : list<keyed-update<e1,a,b>>, participation : keyed-participation, publication-transaction : kokaine/dom/internal/keyed-transaction/keyed-transaction, staged-retirements : ref<global,list<keyed-retirement<e1,a,b>>>, table : ref<global,keyed-table<e1,a,b>>, retirements : list<keyed-retirement<e1,a,b>>) -> <exn,ui,div,kokaine/reactive/effects/signal-write> () */  {
   
  ((staged_retirements_7).value = retirements_6);
   
  var x_24_11936 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_write_fs__tag);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(_y_x10594_0 /* hnd/ev-index */ ) {
      return _mlift_reconcile_keyed_11456(committed_0_7, final_index_6, final_order_6, final_updates_6, participation_3, publication_transaction_4, retirements_6, staged_retirements_7, table_7, _y_x10594_0);
    });
  }
  else {
    return _mlift_reconcile_keyed_11456(committed_0_7, final_index_6, final_order_6, final_updates_6, participation_3, publication_transaction_4, retirements_6, staged_retirements_7, table_7, x_24_11936);
  }
}
 
 
// monadic lift
export function _mlift_reconcile_keyed_11458(committed_0_8, final_index_7, final_order_7, final_updates_7, participation_4, publication_transaction_5, staged_retirements_8, stale, table_8, wild___13) /* forall<_e,a,b,e1> (committed@0 : ref<global,bool>, final-index : kokaine/internal/key-index/key-index<b,keyed-row<e1,a,b>>, final-order : list<keyed-row<e1,a,b>>, final-updates : list<keyed-update<e1,a,b>>, participation : keyed-participation, publication-transaction : kokaine/dom/internal/keyed-transaction/keyed-transaction, staged-retirements : ref<global,list<keyed-retirement<e1,a,b>>>, stale : list<keyed-row<e1,a,b>>, table : ref<global,keyed-table<e1,a,b>>, wild_@13 : ()) -> <kokaine/reactive/effects/signal-write,div,exn,ui> () */  {
   
  var x_25_11938 = $std_core_hnd._open_at1(0, function(rows_0 /* list<keyed-row<10860,10858,10859>> */ ) {
      return stage_keyed_retirements_loop(rows_0, $std_core_types.Nil);
    }, stale);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(retirements_7 /* list<keyed-retirement<10860,10858,10859>> */ ) {
      return _mlift_reconcile_keyed_11457(committed_0_8, final_index_7, final_order_7, final_updates_7, participation_4, publication_transaction_5, staged_retirements_8, table_8, retirements_7);
    });
  }
  else {
    return _mlift_reconcile_keyed_11457(committed_0_8, final_index_7, final_order_7, final_updates_7, participation_4, publication_transaction_5, staged_retirements_8, table_8, x_25_11938);
  }
}
 
 
// monadic lift
export function _mlift_reconcile_keyed_11459(committed_0_9, final_index_8, final_order_8, final_updates_8, participation_5, publication_transaction_6, root_0_0, scope_0_0, staged_retirements_9, stale_0, table_9, _y_x10589) /* forall<_e,a,b,e1> (committed@0 : ref<global,bool>, final-index : kokaine/internal/key-index/key-index<b,keyed-row<e1,a,b>>, final-order : list<keyed-row<e1,a,b>>, final-updates : list<keyed-update<e1,a,b>>, participation : keyed-participation, publication-transaction : kokaine/dom/internal/keyed-transaction/keyed-transaction, root@0@0 : kokaine/reactive/root<ui>, scope@0@0 : kokaine/reactive/integration/lifetime-scope<ui>, staged-retirements : ref<global,list<keyed-retirement<e1,a,b>>>, stale : list<keyed-row<e1,a,b>>, table : ref<global,keyed-table<e1,a,b>>, hnd/ev-index) -> <kokaine/reactive/effects/signal-write,div,exn,ui> () */  {
   
  var x_26_11940 = $std_core_hnd._mask_at(_y_x10589, false, function() {
  ...
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(wild___13_0 /* () */ ) {
      return _mlift_reconcile_keyed_11458(committed_0_9, final_index_8, final_order_8, final_updates_8, participation_5, publication_transaction_6, staged_retirements_9, stale_0, table_9, wild___13_0);
    });
  }
  else {
    return _mlift_reconcile_keyed_11458(committed_0_9, final_index_8, final_order_8, final_updates_8, participation_5, publication_transaction_6, staged_retirements_9, stale_0, table_9, x_26_11940);
  }
}
 
 
// monadic lift
export function _mlift_reconcile_keyed_11460(committed_0_10, final_index_9, final_order_9, final_updates_9, participation_6, publication_transaction_7, root_0_0_0, scope_0_0_0, staged_retirements_10, stale_1, table_10, wild___12) /* forall<_e,a,b,e1> (committed@0 : ref<global,bool>, final-index : kokaine/internal/key-index/key-index<b,keyed-row<e1,a,b>>, final-order : list<keyed-row<e1,a,b>>, final-updates : list<keyed-update<e1,a,b>>, participation : keyed-participation, publication-transaction : kokaine/dom/internal/keyed-transaction/keyed-transaction, root@0@0 : kokaine/reactive/root<ui>, scope@0@0 : kokaine/reactive/integration/lifetime-scope<ui>, staged-retirements : ref<global,list<keyed-retirement<e1,a,b>>>, stale : list<keyed-row<e1,a,b>>, table : ref<global,keyed-table<e1,a,b>>, wild_@12 : ()) -> <exn,ui,div,kokaine/reactive/effects/signal-write> () */  {
   
  var x_27_11942 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_write_fs__tag);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(_y_x10589_0 /* hnd/ev-index */ ) {
      return _mlift_reconcile_keyed_11459(committed_0_10, final_index_9, final_order_9, final_updates_9, participation_6, publication_transaction_7, root_0_0_0, scope_0_0_0, staged_retirements_10, stale_1, table_10, _y_x10589_0);
    });
  }
  else {
    return _mlift_reconcile_keyed_11459(committed_0_10, final_index_9, final_order_9, final_updates_9, participation_6, publication_transaction_7, root_0_0_0, scope_0_0_0, staged_retirements_10, stale_1, table_10, x_27_11942);
  }
}
 
 
// monadic lift
export function _mlift_reconcile_keyed_11461(committed_0_11, final_index_10, final_order_10, final_updates_10, last_0_0_0, parent_0_0_1, participation_7, physical_order, publication_transaction_8, root_0_0_1, scope_0_0_1, staged_retirements_11, stale_2, table_11, placed) /* forall<_e,a,b,e1> (committed@0 : ref<global,bool>, final-index : kokaine/internal/key-index/key-index<b,keyed-row<e1,a,b>>, final-order : list<keyed-row<e1,a,b>>, final-updates : list<keyed-update<e1,a,b>>, last@0@0 : node, parent@0@0 : node, participation : keyed-participation, physical-order : list<keyed-row<e1,a,b>>, publication-transaction : kokaine/dom/internal/keyed-transaction/keyed-transaction, root@0@0 : kokaine/reactive/root<ui>, scope@0@0 : kokaine/reactive/integration/lifetime-scope<ui>, staged-retirements : ref<global,list<keyed-retirement<e1,a,b>>>, stale : list<keyed-row<e1,a,b>>, table : ref<global,keyed-table<e1,a,b>>, placed : node) -> <exn,ui,div,kokaine/reactive/effects/signal-write> () */  {
   
  var x_28_11944 = $std_core_hnd._open_at4(0, validate_keyed_order, parent_0_0_1, last_0_0_0, placed, physical_order);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(wild___12_0 /* () */ ) {
      return _mlift_reconcile_keyed_11460(committed_0_11, final_index_10, final_order_10, final_updates_10, participation_7, publication_transaction_8, root_0_0_1, scope_0_0_1, staged_retirements_11, stale_2, table_11, wild___12_0);
    });
  }
  else {
    return _mlift_reconcile_keyed_11460(committed_0_11, final_index_10, final_order_10, final_updates_10, participation_7, publication_transaction_8, root_0_0_1, scope_0_0_1, staged_retirements_11, stale_2, table_11, x_28_11944);
  }
}
 
 
// monadic lift
export function _mlift_reconcile_keyed_11462(_y_x10584) /* (node) -> <exn,ui,div,kokaine/reactive/effects/signal-write> () */  {
  return $std_core_types.Unit;
}
 
 
// monadic lift
export function _mlift_reconcile_keyed_11463(final_updates_11, parent_0_0_2, cursor) /* forall<a,b,e> (final-updates : list<keyed-update<e,a,b>>, parent@0@0 : node, cursor : node) -> <exn,ui,div,kokaine/reactive/effects/signal-write> () */  {
   
  var x_29_11946 = $std_core_hnd._open_at3(0, place_keyed_updates, parent_0_0_2, cursor, final_updates_11);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(_mlift_reconcile_keyed_11462);
  }
  else {
    return _mlift_reconcile_keyed_11462(x_29_11946);
  }
}
 
 
// monadic lift
export function _mlift_reconcile_keyed_11464(final_updates_12, first_0_0, last_0_0_1, move_phase_0, parent_0_0_3, wild___9) /* forall<_e,a,b,e1> (final-updates : list<keyed-update<e1,a,b>>, first@0@0 : node, last@0@0 : node, move-phase : ref<global,bool>, parent@0@0 : node, wild_@9 : ()) -> <exn,ui,div,kokaine/reactive/effects/signal-write> () */  {
   
  ((move_phase_0).value = true);
   
  var x_30_11948 = $std_core_hnd._open_at3(0, function(parent_3_0 /* node */ , first_5_0 /* node */ , last_5 /* node */ ) {
...
export function _mlift_reconcile_keyed_11465(committed_0_12, final_index_11, final_order_11, final_updates_13, first_0_0_0, last_0_0_2, parent_0_0_4, participation_8, physical_order_0, publication_transaction_9, root_0_0_2, scope_0_0_2, staged_retirements_12, stale_3, table_12, _c_x10585) /* forall<_e,a,b,e1> (committed@0 : ref<global,bool>, final-index : kokaine/internal/key-index/key-index<b,keyed-row<e1,a,b>>, final-order : list<keyed-row<e1,a,b>>, final-updates : list<keyed-update<e1,a,b>>, first@0@0 : node, last@0@0 : node, parent@0@0 : node, participation : keyed-participation, physical-order : list<keyed-row<e1,a,b>>, publication-transaction : kokaine/dom/internal/keyed-transaction/keyed-transaction, root@0@0 : kokaine/reactive/root<ui>, scope@0@0 : kokaine/reactive/integration/lifetime-scope<ui>, staged-retirements : ref<global,list<keyed-retirement<e1,a,b>>>, stale : list<keyed-row<e1,a,b>>, table : ref<global,keyed-table<e1,a,b>>, ()) -> () */  {
  ...
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(placed_0 /* node */ ) {
      return _mlift_reconcile_keyed_11461(committed_0_12, final_index_11, final_order_11, final_updates_13, last_0_0_2, parent_0_0_4, participation_8, physical_order_0, publication_transaction_9, root_0_0_2, scope_0_0_2, staged_retirements_12, stale_3, table_12, placed_0);
    });
  }
  else {
    return _mlift_reconcile_keyed_11461(committed_0_12, final_index_11, final_order_11, final_updates_13, last_0_0_2, parent_0_0_4, participation_8, physical_order_0, publication_transaction_9, root_0_0_2, scope_0_0_2, staged_retirements_12, stale_3, table_12, x_31_11951);
  }
}
 
 
// monadic lift
export function _mlift_reconcile_keyed_11466(committed_0_13, final_index_12, final_order_12, final_updates_14, first_0_0_1, last_0_0_3, move_phase_1, parent_0_0_5, participation_9, physical_order_1, publication_transaction_10, root_0_0_3, scope_0_0_3, staged_retirements_13, stale_4, table_13, _y_x10580) /* forall<_e,a,b,e1> (committed@0 : ref<global,bool>, final-index : kokaine/internal/key-index/key-index<b,keyed-row<e1,a,b>>, final-order : list<keyed-row<e1,a,b>>, final-updates : list<keyed-update<e1,a,b>>, first@0@0 : node, last@0@0 : node, move-phase : ref<global,bool>, parent@0@0 : node, participation : keyed-participation, physical-order : list<keyed-row<e1,a,b>>, publication-transaction : kokaine/dom/internal/keyed-transaction/keyed-transaction, root@0@0 : kokaine/reactive/root<ui>, scope@0@0 : kokaine/reactive/integration/lifetime-scope<ui>, staged-retirements : ref<global,list<keyed-retirement<e1,a,b>>>, stale : list<keyed-row<e1,a,b>>, table : ref<global,keyed-table<e1,a,b>>, bool) -> <exn,ui,div,kokaine/reactive/effects/signal-write> () */  {
  ...
  if (order_changed) {
    ...
    var x_33_11956 = $std_core_hnd._open_at2(0, validate_keyed_move_lifecycles, parent_0_0_5, physical_order_1);
    if ($std_core_hnd._yielding()) {
      var x_32_11954 = $std_core_hnd.yield_extend(function(wild___9_0 /* () */ ) {
        return _mlift_reconcile_keyed_11464(final_updates_14, first_0_0_1, last_0_0_3, move_phase_1, parent_0_0_5, wild___9_0);
      });
    }
    else {
      var x_32_11954 = _mlift_reconcile_keyed_11464(final_updates_14, first_0_0_1, last_0_0_3, move_phase_1, parent_0_0_5, x_33_11956);
    }
  }
  else {
    var x_32_11954 = $std_core_types.Unit;
  }
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(_c_x10585_0 /* () */ ) {
      return _mlift_reconcile_keyed_11465(committed_0_13, final_index_12, final_order_12, final_updates_14, first_0_0_1, last_0_0_3, parent_0_0_5, participation_9, physical_order_1, publication_transaction_10, root_0_0_3, scope_0_0_3, staged_retirements_13, stale_4, table_13, _c_x10585_0);
    });
  }
  else {
    return _mlift_reconcile_keyed_11465(committed_0_13, final_index_12, final_order_12, final_updates_14, first_0_0_1, last_0_0_3, parent_0_0_5, participation_9, physical_order_1, publication_transaction_10, root_0_0_3, scope_0_0_3, staged_retirements_13, stale_4, table_13, x_32_11954);
  }
}
 
 
// monadic lift
export function _mlift_reconcile_keyed_11467(committed_0_14, final_index_13, final_order_13, final_updates_15, first_0_0_2, last_0_0_4, move_phase_2, parent_0_0_6, participation_10, physical_order_2, publication_transaction_11, root_0_0_4, scope_0_0_4, staged_retirements_14, stale_5, table_14, current_cursor) /* forall<_e,a,b,e1> (committed@0 : ref<global,bool>, final-index : kokaine/internal/key-index/key-index<b,keyed-row<e1,a,b>>, final-order : list<keyed-row<e1,a,b>>, final-updates : list<keyed-update<e1,a,b>>, first@0@0 : node, last@0@0 : node, move-phase : ref<global,bool>, parent@0@0 : node, participation : keyed-participation, physical-order : list<keyed-row<e1,a,b>>, publication-transaction : kokaine/dom/internal/keyed-transaction/keyed-transaction, root@0@0 : kokaine/reactive/root<ui>, scope@0@0 : kokaine/reactive/integration/lifetime-scope<ui>, staged-retirements : ref<global,list<keyed-retirement<e1,a,b>>>, stale : list<keyed-row<e1,a,b>>, table : ref<global,keyed-table<e1,a,b>>, current-cursor : node) -> <exn,ui,div,kokaine/reactive/effects/signal-write> () */  {
   
  var x_34_11958 = $std_core_hnd._open_at4(0, keyed_order_matches, parent_0_0_6, last_0_0_4, current_cursor, physical_order_2);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(_y_x10580_0 /* bool */ ) {
      return _mlift_reconcile_keyed_11466(committed_0_14, final_index_13, final_order_13, final_updates_15, first_0_0_2, last_0_0_4, move_phase_2, parent_0_0_6, participation_10, physical_order_2, publication_transaction_11, root_0_0_4, scope_0_0_4, staged_retirements_14, stale_5, table_14, _y_x10580_0);
    });
  }
  else {
    return _mlift_reconcile_keyed_11466(committed_0_14, final_index_13, final_order_13, final_updates_15, first_0_0_2, last_0_0_4, move_phase_2, parent_0_0_6, participation_10, physical_order_2, publication_transaction_11, root_0_0_4, scope_0_0_4, staged_retirements_14, stale_5, table_14, x_34_11958);
  }
}
 
 
// monadic lift
export function _mlift_reconcile_keyed_11468(committed_0_15, final_index_14, final_order_14, final_updates_16, first_0_0_3, last_0_0_5, move_phase_3, parent_0_0_7, participation_11, publication_transaction_12, root_0_0_5, scope_0_0_5, staged_retirements_15, stale_6, table_15, wild___8) /* forall<_e,a,b,e1> (committed@0 : ref<global,bool>, final-index : kokaine/internal/key-index/key-index<b,keyed-row<e1,a,b>>, final-order : list<keyed-row<e1,a,b>>, final-updates : list<keyed-update<e1,a,b>>, first@0@0 : node, last@0@0 : node, move-phase : ref<global,bool>, parent@0@0 : node, participation : keyed-participation, publication-transaction : kokaine/dom/internal/keyed-transaction/keyed-transaction, root@0@0 : kokaine/reactive/root<ui>, scope@0@0 : kokaine/reactive/integration/lifetime-scope<ui>, staged-retirements : ref<global,list<keyed-retirement<e1,a,b>>>, stale : list<keyed-row<e1,a,b>>, table : ref<global,keyed-table<e1,a,b>>, wild_@8 : ()) -> <kokaine/reactive/effects/signal-write,div,exn,ui> () */  {
   
  var physical_order_3 = $std_core_list.append(final_order_14, stale_6);
   
  var x_35_11960 = $std_core_hnd._open_at3(0, function(parent_2_0 /* node */ , first_4_0 /* node */ , last_4 /* node */ ) {
  ...
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(current_cursor_0 /* node */ ) {
      return _mlift_reconcile_keyed_11467(committed_0_15, final_index_14, final_order_14, final_updates_16, first_0_0_3, last_0_0_5, move_phase_3, parent_0_0_7, participation_11, physical_order_3, publication_transaction_12, root_0_0_5, scope_0_0_5, staged_retirements_15, stale_6, table_15, current_cursor_0);
    });
  }
  else {
    return _mlift_reconcile_keyed_11467(committed_0_15, final_index_14, final_order_14, final_updates_16, first_0_0_3, last_0_0_5, move_phase_3, parent_0_0_7, participation_11, physical_order_3, publication_transaction_12, root_0_0_5, scope_0_0_5, staged_retirements_15, stale_6, table_15, x_35_11960);
  }
}
 
 
// monadic lift
export function _mlift_reconcile_keyed_11469(committed_0_16, final_index_15, final_order_15, final_updates_17, first_0_0_4, last_0_0_6, move_phase_4, parent_0_0_8, participation_12, publication_transaction_13, renderer_0_0, root_0_0_6, scope_0_0_6, staged_retirements_16, stale_7, table_16, _y_x10575) /* forall<_e,a,b,e1> (committed@0 : ref<global,bool>, final-index : kokaine/internal/key-index/key-index<b,keyed-row<e1,a,b>>, final-order : list<keyed-row<e1,a,b>>, final-updates : list<keyed-update<e1,a,b>>, first@0@0 : node, last@0@0 : node, move-phase : ref<global,bool>, parent@0@0 : node, participation : keyed-participation, publication-transaction : kokaine/dom/internal/keyed-transaction/keyed-transaction, renderer@0 : kokaine/dom/internal/keyed-transaction/keyed-context, root@0@0 : kokaine/reactive/root<ui>, scope@0@0 : kokaine/reactive/integration/lifetime-scope<ui>, staged-retirements : ref<global,list<keyed-retirement<e1,a,b>>>, stale : list<keyed-row<e1,a,b>>, table : ref<global,keyed-table<e1,a,b>>, hnd/ev-index) -> <kokaine/reactive/effects/signal-write,div,exn,ui> () */  {
   
  var x_36_11963 = $std_core_hnd._mask_at(_y_x10575, false, function() {
  ...
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(wild___8_0 /* () */ ) {
      return _mlift_reconcile_keyed_11468(committed_0_16, final_index_15, final_order_15, final_updates_17, first_0_0_4, last_0_0_6, move_phase_4, parent_0_0_8, participation_12, publication_transaction_13, root_0_0_6, scope_0_0_6, staged_retirements_16, stale_7, table_16, wild___8_0);
    });
  }
  else {
    return _mlift_reconcile_keyed_11468(committed_0_16, final_index_15, final_order_15, final_updates_17, first_0_0_4, last_0_0_6, move_phase_4, parent_0_0_8, participation_12, publication_transaction_13, root_0_0_6, scope_0_0_6, staged_retirements_16, stale_7, table_16, x_36_11963);
  }
}
 
 
// monadic lift
export function _mlift_reconcile_keyed_11470(root_0_0_7, scope_0_0_7, wild___26) /* (root@0@0 : kokaine/reactive/root<ui>, scope@0@0 : kokaine/reactive/integration/lifetime-scope<ui>, wild_@26 : ()) -> <ui,exn> () */  {
...
// monadic lift
export function _mlift_reconcile_keyed_11471(final_order_16, last_0_0_7, parent_0_0_9, root_0_0_8, scope_0_0_8, placed_0_0) /* forall<a,b,e> (final-order : list<keyed-row<e,a,b>>, last@0@0 : node, parent@0@0 : node, root@0@0 : kokaine/reactive/root<ui>, scope@0@0 : kokaine/reactive/integration/lifetime-scope<ui>, placed@0 : node) -> <ui,exn> () */  {
   
  var x_37_11967 = validate_keyed_order(parent_0_0_9, last_0_0_7, placed_0_0, final_order_16);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(wild___26_0 /* () */ ) {
      return _mlift_reconcile_keyed_11470(root_0_0_8, scope_0_0_8, wild___26_0);
    });
  }
  else {
    return _mlift_reconcile_keyed_11470(root_0_0_8, scope_0_0_8, x_37_11967);
  }
}
 
 
// monadic lift
export function _mlift_reconcile_keyed_11472(_y_x10623) /* (node) -> <ui,exn> () */  {
  return $std_core_types.Unit;
}
 
 
// monadic lift
export function _mlift_reconcile_keyed_11473(final_updates_18, parent_0_0_10, cursor_0_0) /* forall<a,b,e> (final-updates : list<keyed-update<e,a,b>>, parent@0@0 : node, cursor@0 : node) -> <ui,exn> () */  {
   
  var x_38_11969 = place_keyed_updates(parent_0_0_10, cursor_0_0, final_updates_18);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(_mlift_reconcile_keyed_11472);
  }
  else {
    return _mlift_reconcile_keyed_11472(x_38_11969);
  }
}
 
 
// monadic lift
export function _mlift_reconcile_keyed_11474(final_updates_19, first_0_0_5, last_0_0_8, move_phase_5, parent_0_0_11, wild___23) /* forall<_e,a,b,e1> (final-updates : list<keyed-update<e1,a,b>>, first@0@0 : node, last@0@0 : node, move-phase : ref<global,bool>, parent@0@0 : node, wild_@23 : ()) -> <ui,exn> () */  {
  ...
  if (_x103) {
    var x_39_11971 = $std_core_hnd._open_none1(dom_attempt_value, result_6);
  }
  else {
    var x_39_11971 = $std_core_exn.$throw($std_core_types._lp__plus__plus__rp_("browser DOM exception: ", $std_core_hnd._open_none1(dom_attempt_message, result_6)));
  }
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(cursor_0_1 /* node */ ) {
      return _mlift_reconcile_keyed_11473(final_updates_19, parent_0_0_11, cursor_0_1);
    });
  }
  else {
    return _mlift_reconcile_keyed_11473(final_updates_19, parent_0_0_11, x_39_11971);
  }
}
 
 
// monadic lift
export function _mlift_reconcile_keyed_11475(final_order_17, first_0_0_6, last_0_0_9, parent_0_0_12, root_0_0_9, scope_0_0_9, _c_x10624) /* forall<a,b,e> (final-order : list<keyed-row<e,a,b>>, first@0@0 : node, last@0@0 : node, parent@0@0 : node, root@0@0 : kokaine/reactive/root<ui>, scope@0@0 : kokaine/reactive/integration/lifetime-scope<ui>, ()) -> () */  {
  ...
  if (_x103) {
    var x_40_11974 = $std_core_hnd._open_none1(dom_attempt_value, result_7);
  }
  else {
    var x_40_11974 = $std_core_exn.$throw($std_core_types._lp__plus__plus__rp_("browser DOM exception: ", $std_core_hnd._open_none1(dom_attempt_message, result_7)));
  }
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(placed_0_1 /* node */ ) {
      return _mlift_reconcile_keyed_11471(final_order_17, last_0_0_9, parent_0_0_12, root_0_0_9, scope_0_0_9, placed_0_1);
    });
  }
  else {
    return _mlift_reconcile_keyed_11471(final_order_17, last_0_0_9, parent_0_0_12, root_0_0_9, scope_0_0_9, x_40_11974);
  }
}
 
 
// monadic lift
export function _mlift_reconcile_keyed_11476(final_order_18, final_updates_20, first_0_0_7, last_0_0_10, move_phase_6, parent_0_0_13, root_0_0_10, scope_0_0_10, _y_x10620) /* forall<_e,a,b,e1> (final-order : list<keyed-row<e1,a,b>>, final-updates : list<keyed-update<e1,a,b>>, first@0@0 : node, last@0@0 : node, move-phase : ref<global,bool>, parent@0@0 : node, root@0@0 : kokaine/reactive/root<ui>, scope@0@0 : kokaine/reactive/integration/lifetime-scope<ui>, bool) -> <ui,exn> () */  {
  ...
  if (order_changed_0) {
    ...
    var x_42_11979 = validate_keyed_move_lifecycles(parent_0_0_13, final_order_18);
    if ($std_core_hnd._yielding()) {
      var x_41_11977 = $std_core_hnd.yield_extend(function(wild___23_0 /* () */ ) {
        return _mlift_reconcile_keyed_11474(final_updates_20, first_0_0_7, last_0_0_10, move_phase_6, parent_0_0_13, wild___23_0);
      });
    }
    else {
      var x_41_11977 = _mlift_reconcile_keyed_11474(final_updates_20, first_0_0_7, last_0_0_10, move_phase_6, parent_0_0_13, x_42_11979);
    }
  }
  else {
    var x_41_11977 = $std_core_types.Unit;
  }
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(_c_x10624_0 /* () */ ) {
      return _mlift_reconcile_keyed_11475(final_order_18, first_0_0_7, last_0_0_10, parent_0_0_13, root_0_0_10, scope_0_0_10, _c_x10624_0);
    });
  }
  else {
    return _mlift_reconcile_keyed_11475(final_order_18, first_0_0_7, last_0_0_10, parent_0_0_13, root_0_0_10, scope_0_0_10, x_41_11977);
  }
}
 
 
// monadic lift
export function _mlift_reconcile_keyed_11477(final_order_19, final_updates_21, first_0_0_8, last_0_0_11, move_phase_7, parent_0_0_14, root_0_0_11, scope_0_0_11, current_cursor_0_0) /* forall<_e,a,b,e1> (final-order : list<keyed-row<e1,a,b>>, final-updates : list<keyed-update<e1,a,b>>, first@0@0 : node, last@0@0 : node, move-phase : ref<global,bool>, parent@0@0 : node, root@0@0 : kokaine/reactive/root<ui>, scope@0@0 : kokaine/reactive/integration/lifetime-scope<ui>, current-cursor@0 : node) -> <ui,exn> () */  {
   
  var x_43_11981 = keyed_order_matches(parent_0_0_14, last_0_0_11, current_cursor_0_0, final_order_19);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(_y_x10620_0 /* bool */ ) {
      return _mlift_reconcile_keyed_11476(final_order_19, final_updates_21, first_0_0_8, last_0_0_11, move_phase_7, parent_0_0_14, root_0_0_11, scope_0_0_11, _y_x10620_0);
    });
  }
  else {
    return _mlift_reconcile_keyed_11476(final_order_19, final_updates_21, first_0_0_8, last_0_0_11, move_phase_7, parent_0_0_14, root_0_0_11, scope_0_0_11, x_43_11981);
  }
}
 
 
// monadic lift
export function _mlift_reconcile_keyed_11478(enlisted, wild___28) /* forall<_e> (enlisted : ref<global,bool>, wild_@28 : ()) -> <kokaine/reactive/effects/signal-write,div,exn,ui> () */  {
  return ((enlisted).value = true);
}
 
 
// monadic lift
export function _mlift_reconcile_keyed_11479(committed_0_17, drafts_1, enlisted_0, final_index_16, final_order_20, final_updates_22, first_0_0_9, last_0_0_12, move_phase_8, old_order_0, parent_0_0_15, publication_transaction_14, root_0_0_12, scope_0_0_12, table_17, _y_x10618) /* forall<_e,_e1,a,b,e2> (committed@0 : ref<global,bool>, drafts : ref<global,list<keyed-row<e2,a,b>>>, enlisted : ref<global,bool>, final-index : kokaine/internal/key-index/key-index<b,keyed-row<e2,a,b>>, final-order : list<keyed-row<e2,a,b>>, final-updates : list<keyed-update<e2,a,b>>, first@0@0 : node, last@0@0 : node, move-phase : ref<global,bool>, old-order : list<keyed-row<e2,a,b>>, parent@0@0 : node, publication-transaction : kokaine/dom/internal/keyed-transaction/keyed-transaction, root@0@0 : kokaine/reactive/root<ui>, scope@0@0 : kokaine/reactive/integration/lifetime-scope<ui>, table : ref<global,keyed-table<e2,a,b>>, hnd/ev-index) -> <kokaine/reactive/effects/signal-write,div,exn,ui> () */  {
   
  var x_44_11983 = $std_core_hnd._mask_at(_y_x10618, false, function() {
      return $kokaine_dom_internal_keyed_dash_transaction.stage_keyed_publication(publication_transaction_14, function() {
          ...
          if (_x103) {
            var x_45_11985 = $std_core_hnd._open_none1(dom_attempt_value, result_8);
          }
          else {
            var x_45_11985 = $std_core_exn.$throw($std_core_types._lp__plus__plus__rp_("browser DOM exception: ", $std_core_hnd._open_none1(dom_attempt_message, result_8)));
          }
          if ($std_core_hnd._yielding()) {
            return $std_core_hnd.yield_extend(function(current_cursor_0_1 /* node */ ) {
              return _mlift_reconcile_keyed_11477(final_order_20, final_updates_22, first_0_0_9, last_0_0_12, move_phase_8, parent_0_0_15, root_0_0_12, scope_0_0_12, current_cursor_0_1);
            });
          }
          else {
            return _mlift_reconcile_keyed_11477(final_order_20, final_updates_22, first_0_0_9, last_0_0_12, move_phase_8, parent_0_0_15, root_0_0_12, scope_0_0_12, x_45_11985);
          }
        }, function() {
          ...
          var rows_1_10206 = drafts_1.value;
          return $std_core_hnd.finally_prompt(function() {
            ...
            }, exhaust_keyed_row_actions(rows_1_10206, function(row_1 /* keyed-row<10860,10858,10859> */ ) {
                 
                var scope_2_10208 = $std_core_hnd._open_none1(function(_this_4 /* keyed-row<10860,10858,10859> */ ) {
  ...
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(wild___28_0 /* () */ ) {
      return _mlift_reconcile_keyed_11478(enlisted_0, wild___28_0);
    });
  }
  else {
    return _mlift_reconcile_keyed_11478(enlisted_0, x_44_11983);
  }
}
 
 
// monadic lift
export function _mlift_reconcile_keyed_11480(committed_0_18, drafts_2, enlisted_1, final_index_17, final_order_21, final_updates_23, first_0_0_10, last_0_0_13, move_phase_9, old_order_1, parent_0_0_16, publication_transaction_15, root_0_0_13, scope_0_0_13, table_18, _c_x10617) /* forall<_e,_e1,a,b,e2> (committed@0 : ref<global,bool>, drafts : ref<global,list<keyed-row<e2,a,b>>>, enlisted : ref<global,bool>, final-index : kokaine/internal/key-index/key-index<b,keyed-row<e2,a,b>>, final-order : list<keyed-row<e2,a,b>>, final-updates : list<keyed-update<e2,a,b>>, first@0@0 : node, last@0@0 : node, move-phase : ref<global,bool>, old-order : list<keyed-row<e2,a,b>>, parent@0@0 : node, publication-transaction : kokaine/dom/internal/keyed-transaction/keyed-transaction, root@0@0 : kokaine/reactive/root<ui>, scope@0@0 : kokaine/reactive/integration/lifetime-scope<ui>, table : ref<global,keyed-table<e2,a,b>>, ()) -> () */  {
   
  var x_46_11990 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_write_fs__tag);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(_y_x10618_0 /* hnd/ev-index */ ) {
      return _mlift_reconcile_keyed_11479(committed_0_18, drafts_2, enlisted_1, final_index_17, final_order_21, final_updates_23, first_0_0_10, last_0_0_13, move_phase_9, old_order_1, parent_0_0_16, publication_transaction_15, root_0_0_13, scope_0_0_13, table_18, _y_x10618_0);
    });
  }
  else {
    return _mlift_reconcile_keyed_11479(committed_0_18, drafts_2, enlisted_1, final_index_17, final_order_21, final_updates_23, first_0_0_10, last_0_0_13, move_phase_9, old_order_1, parent_0_0_16, publication_transaction_15, root_0_0_13, scope_0_0_13, table_18, x_46_11990);
  }
}
 
 
// monadic lift
export function _mlift_reconcile_keyed_11481(committed_0_19, drafts_3, enlisted_2, final_index_18, final_updates_24, first_0_0_11, last_0_0_14, move_phase_10, old_order_2, owns_provision, parent_0_0_17, participation_13, publication_transaction_16, renderer_0_1, root_0_0_14, scope_0_0_14, staged_retirements_17, stale_8, table_19, final_order_22) /* forall<_e,_e1,a,b,e2> (committed@0 : ref<global,bool>, drafts : ref<global,list<keyed-row<e2,a,b>>>, enlisted : ref<global,bool>, final-index : kokaine/internal/key-index/key-index<b,keyed-row<e2,a,b>>, final-updates : list<keyed-update<e2,a,b>>, first@0@0 : node, last@0@0 : node, move-phase : ref<global,bool>, old-order : list<keyed-row<e2,a,b>>, owns-provision : bool, parent@0@0 : node, participation : keyed-participation, publication-transaction : kokaine/dom/internal/keyed-transaction/keyed-transaction, renderer@0 : kokaine/dom/internal/keyed-transaction/keyed-context, root@0@0 : kokaine/reactive/root<ui>, scope@0@0 : kokaine/reactive/integration/lifetime-scope<ui>, staged-retirements : ref<global,list<keyed-retirement<e2,a,b>>>, stale : list<keyed-row<e2,a,b>>, table : ref<global,keyed-table<e2,a,b>>, final-order : list<keyed-row<e2,a,b>>) -> <div,exn,kokaine/reactive/effects/signal-write,ui> () */  {
  if (owns_provision) {
     
    var x_47_11992 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_write_fs__tag);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_y_x10575_0 /* hnd/ev-index */ ) {
        return _mlift_reconcile_keyed_11469(committed_0_19, final_index_18, final_order_22, final_updates_24, first_0_0_11, last_0_0_14, move_phase_10, parent_0_0_17, participation_13, publication_transaction_16, renderer_0_1, root_0_0_14, scope_0_0_14, staged_retirements_17, stale_8, table_19, _y_x10575_0);
      });
    }
    else {
      return _mlift_reconcile_keyed_11469(committed_0_19, final_index_18, final_order_22, final_updates_24, first_0_0_11, last_0_0_14, move_phase_10, parent_0_0_17, participation_13, publication_transaction_16, renderer_0_1, root_0_0_14, scope_0_0_14, staged_retirements_17, stale_8, table_19, x_47_11992);
    }
  }
  else {
     
    var _x_x1_31_11292 = $std_core_hnd._open_none1(function(list /* list<keyed-row<10860,10858,10859>> */ ) {
        return (list === null);
      }, old_order_2);
    ...
    if (_x103) {
      var x_48_11994 = $std_core_hnd._open_at2(0, $std_core_exn.$throw, "joined keyed reconciliation must be initial construction");
    }
    else {
       
      var _x_x1_34_11296 = $std_core_hnd._open_none1(function(list_0 /* list<keyed-row<10860,10858,10859>> */ ) {
          return (list_0 === null);
        }, stale_8);
      ...
      if (_x104) {
        ...
        var x_48_11994 = $std_core_types.Unit;
      }
    }
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_c_x10617_0 /* () */ ) {
        return _mlift_reconcile_keyed_11480(committed_0_19, drafts_3, enlisted_2, final_index_18, final_order_22, final_updates_24, first_0_0_11, last_0_0_14, move_phase_10, old_order_2, parent_0_0_17, publication_transaction_16, root_0_0_14, scope_0_0_14, table_19, _c_x10617_0);
      });
    }
    else {
      return _mlift_reconcile_keyed_11480(committed_0_19, drafts_3, enlisted_2, final_index_18, final_order_22, final_updates_24, first_0_0_11, last_0_0_14, move_phase_10, old_order_2, parent_0_0_17, publication_transaction_16, root_0_0_14, scope_0_0_14, table_19, x_48_11994);
    }
  }
}
...
// monadic lift
export function _mlift_reconcile_keyed_11482(current_index, existing, item_changed, item_0_0, position, updates, _c_x10567) /* forall<_e,_e1,a,b,e2> (current-index : int, existing : keyed-row<e2,a,b>, item-changed : bool, item@0@0 : a, position : ref<global,int>, updates : ref<global,list<keyed-update<e2,a,b>>>, ()) -> () */  {
   
  var value_39_0_10964 = $std_core_hnd._open_none1(function(_this_1 /* keyed-row<10860,10858,10859> */ ) {
      return _this_1.row_current_index;
    }, existing);
   
  var update = Keyed_update(existing, item_0_0, current_index, item_changed, $std_core_types._int_ne((value_39_0_10964.value),current_index));
   
  var value_40_10967 = $std_core_types.Cons(update, updates.value);
   
  ((updates).value = value_40_10967);
   
  var value_42_10970 = $std_core_types._int_add(current_index,1);
  return ((position).value = value_42_10970);
}
 
 
// monadic lift
export function _mlift_reconcile_keyed_11483(current_index_0, draft, item_0_0_0, position_0, updates_0, _c_x10570) /* forall<_e,_e1,a,b,e2> (current-index : int, draft : keyed-row<e2,a,b>, item@0@0 : a, position : ref<global,int>, updates : ref<global,list<keyed-update<e2,a,b>>>, ()) -> () */  {
   
  var value_46_0_10981 = $std_core_hnd._open_none1(function(_this_2 /* keyed-row<10860,10858,10859> */ ) {
      return _this_2.row_current_index;
    }, draft);
   
  var update_0 = Keyed_update(draft, item_0_0_0, current_index_0, false, $std_core_types._int_ne((value_46_0_10981.value),current_index_0));
   
  var value_47_10984 = $std_core_types.Cons(update_0, updates_0.value);
   
  ((updates_0).value = value_47_10984);
   
  var value_49_10987 = $std_core_types._int_add(current_index_0,1);
  return ((position_0).value = value_49_10987);
}
 
 
// monadic lift
export function _mlift_reconcile_keyed_11484(compare, current_index_1, drafts_4, identity_0_0, item_0_0_1, next_index, position_1, updates_1, draft_0) /* forall<_e,_e1,a,b,e2> (compare : (b, b) -> order, current-index : int, drafts : ref<global,list<keyed-row<e2,a,b>>>, identity@0@0 : b, item@0@0 : a, next-index : ref<global,kokaine/internal/key-index/key-index<b,keyed-row<e2,a,b>>>, position : ref<global,int>, updates : ref<global,list<keyed-update<e2,a,b>>>, draft : keyed-row<e2,a,b>) -> <pure,kokaine/reactive/effects/signal-write,ui> () */  {
   
  var value_43_10974 = $std_core_types.Cons(draft_0, drafts_4.value);
   
  ((drafts_4).value = value_43_10974);
   
  var _x_x1_16_11256 = next_index.value;
   
  var _x103 = $std_core_hnd._open_none4($kokaine_internal_key_dash_index.insert, _x_x1_16_11256, identity_0_0, draft_0, compare);
  if (_x103._tag === 2) {
    var x_49_11996 = $std_core_hnd._open_at2(0, $std_core_exn.$throw, "duplicate key in keyed For");
  }
  else {
    var x_49_11996 = ((next_index).value = (_x103.index));
  }
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(_c_x10570_0 /* () */ ) {
      return _mlift_reconcile_keyed_11483(current_index_1, draft_0, item_0_0_1, position_1, updates_1, _c_x10570_0);
    });
  }
  else {
    return _mlift_reconcile_keyed_11483(current_index_1, draft_0, item_0_0_1, position_1, updates_1, x_49_11996);
  }
}
 
 
// monadic lift
export function _mlift_reconcile_keyed_11485(committed_0_20, compare_0, drafts_5, enlisted_3, first_0_0_12, last_0_0_15, move_phase_11, next_index_0, old_order_3, owns_provision_0, parent_0_0_18, participation_14, publication_transaction_17, renderer_0_2, root_0_0_15, scope_0_0_15, staged_retirements_18, table_20, updates_2, wild___7) /* forall<_e,_e1,a,b,e2> (committed@0 : ref<global,bool>, compare : (b, b) -> order, drafts : ref<global,list<keyed-row<e2,a,b>>>, enlisted : ref<global,bool>, first@0@0 : node, last@0@0 : node, move-phase : ref<global,bool>, next-index : ref<global,kokaine/internal/key-index/key-index<b,keyed-row<e2,a,b>>>, old-order : list<keyed-row<e2,a,b>>, owns-provision : bool, parent@0@0 : node, participation : keyed-participation, publication-transaction : kokaine/dom/internal/keyed-transaction/keyed-transaction, renderer@0 : kokaine/dom/internal/keyed-transaction/keyed-context, root@0@0 : kokaine/reactive/root<ui>, scope@0@0 : kokaine/reactive/integration/lifetime-scope<ui>, staged-retirements : ref<global,list<keyed-retirement<e2,a,b>>>, table : ref<global,keyed-table<e2,a,b>>, updates : ref<global,list<keyed-update<e2,a,b>>>, wild_@7 : ()) -> <div,exn,kokaine/reactive/effects/signal-write,ui> () */  {
   
  var xs_0_10990 = updates_2.value;
   
  var final_updates_25 = $std_core_list.reverse_acc($std_core_types.Nil, xs_0_10990);
  ...
  var x_50_11998 = $std_core_list.map(final_updates_25, function(update_0_0 /* keyed-update<10860,10858,10859> */ ) {
      return $std_core_hnd._open_none1(function(_this_3 /* keyed-update<10860,10858,10859> */ ) {
          return _this_3.update_row;
        }, update_0_0);
    });
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(final_order_23 /* list<keyed-row<10860,10858,10859>> */ ) {
      return _mlift_reconcile_keyed_11481(committed_0_20, drafts_5, enlisted_3, final_index_19, final_updates_25, first_0_0_12, last_0_0_15, move_phase_11, old_order_3, owns_provision_0, parent_0_0_18, participation_14, publication_transaction_17, renderer_0_2, root_0_0_15, scope_0_0_15, staged_retirements_18, stale_9, table_20, final_order_23);
    });
  }
  else {
    return _mlift_reconcile_keyed_11481(committed_0_20, drafts_5, enlisted_3, final_index_19, final_updates_25, first_0_0_12, last_0_0_15, move_phase_11, old_order_3, owns_provision_0, parent_0_0_18, participation_14, publication_transaction_17, renderer_0_2, root_0_0_15, scope_0_0_15, staged_retirements_18, stale_9, table_20, x_50_11998);
...
export function _mlift_reconcile_keyed_11486(children_0_0, committed_0_21, compare_1, drafts_6, enlisted_4, first_0_0_13, item_equals, keyed_items, last_0_0_16, move_phase_12, next_index_1, old_index, old_order_4, owns_provision_1, parent_0_0_19, participation_15, position_2, publication_transaction_18, renderer_0_3, root_0_0_16, scope_0_0_16, staged_retirements_19, table_21, updates_3, wild___3_0_0) /* forall<_e,_e1,a,b,e2> (children@0 : (item : kokaine/html/accessor<a>, index : kokaine/html/accessor<int>) -> <kokaine/html/html<e2>,kokaine/reactive/effects/signal-read> (), committed@0 : ref<global,bool>, compare : (b, b) -> order, drafts : ref<global,list<keyed-row<e2,a,b>>>, enlisted : ref<global,bool>, first@0@0 : node, item-equals : (a, a) -> bool, keyed-items : ref<global,list<(a, b)>>, last@0@0 : node, move-phase : ref<global,bool>, next-index : ref<global,kokaine/internal/key-index/key-index<b,keyed-row<e2,a,b>>>, old-index : kokaine/internal/key-index/key-index<b,keyed-row<e2,a,b>>, old-order : list<keyed-row<e2,a,b>>, owns-provision : bool, parent@0@0 : node, participation : keyed-participation, position : ref<global,int>, publication-transaction : kokaine/dom/internal/keyed-transaction/keyed-transaction, renderer@0 : kokaine/dom/internal/keyed-transaction/keyed-context, root@0@0 : kokaine/reactive/root<ui>, scope@0@0 : kokaine/reactive/integration/lifetime-scope<ui>, staged-retirements : ref<global,list<keyed-retirement<e2,a,b>>>, table : ref<global,keyed-table<e2,a,b>>, updates : ref<global,list<keyed-update<e2,a,b>>>, wild_@3@0 : ()) -> <exn,div,kokaine/reactive/effects/signal-write,ui> () */  {
  ...
  var x_51_12000 = $std_core_list.foreach($std_core_list.reverse_acc($std_core_types.Nil, xs_10951), function(keyed_item /* (10858, 10859) */ ) {
      ...
      if (_x103 !== null) {
        ...
        var value_37_10957 = $std_core_hnd._open_none1(function(_this_0 /* keyed-row<10860,10858,10859> */ ) {
            return _this_0.row_current_item;
          }, _x103.value);
         
        var _x_x1_11_11247 = value_37_10957.value;
         
        var _x_x1_10_11245 = $std_core_hnd._open_none2(item_equals, _x_x1_11_11247, keyed_item.fst);
         
        var item_changed_0 = $std_core_hnd._open_none1(function(b_0 /* bool */ ) {
            return (b_0) ? false : true;
          }, _x_x1_10_11245);
         
        var _x_x1_13_11249 = next_index_1.value;
         
        var _x104 = $std_core_hnd._open_none4($kokaine_internal_key_dash_index.insert, _x_x1_13_11249, keyed_item.snd, _x103.value, compare_1);
        if (_x104._tag === 2) {
          var x_52_12002 = $std_core_hnd._open_at2(0, $std_core_exn.$throw, "duplicate key in keyed For");
        }
        else {
          var x_52_12002 = ((next_index_1).value = (_x104.index));
        }
        if ($std_core_hnd._yielding()) {
          return $std_core_hnd.yield_extend(function(_c_x10567_0 /* () */ ) {
            return _mlift_reconcile_keyed_11482(current_index_2, _x103.value, item_changed_0, keyed_item.fst, position_2, updates_3, _c_x10567_0);
          });
        }
        else {
          return _mlift_reconcile_keyed_11482(current_index_2, _x103.value, item_changed_0, keyed_item.fst, position_2, updates_3, x_52_12002);
        }
      }
      else {
         
        var x_53_12004 = create_keyed_row(renderer_0_3, root_0_0_16, parent_0_0_19, last_0_0_16, keyed_item.snd, keyed_item.fst, current_index_2, children_0_0);
        if ($std_core_hnd._yielding()) {
          return $std_core_hnd.yield_extend(function(draft_1 /* keyed-row<10860,10858,10859> */ ) {
            return _mlift_reconcile_keyed_11484(compare_1, current_index_2, drafts_6, keyed_item.snd, keyed_item.fst, next_index_1, position_2, updates_3, draft_1);
          });
        }
        else {
          return _mlift_reconcile_keyed_11484(compare_1, current_index_2, drafts_6, keyed_item.snd, keyed_item.fst, next_index_1, position_2, updates_3, x_53_12004);
        }
      }
    });
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(wild___7_0 /* () */ ) {
      return _mlift_reconcile_keyed_11485(committed_0_21, compare_1, drafts_6, enlisted_4, first_0_0_13, last_0_0_16, move_phase_12, next_index_1, old_order_4, owns_provision_1, parent_0_0_19, participation_15, publication_transaction_18, renderer_0_3, root_0_0_16, scope_0_0_16, staged_retirements_19, table_21, updates_3, wild___7_0);
    });
  }
  else {
    return _mlift_reconcile_keyed_11485(committed_0_21, compare_1, drafts_6, enlisted_4, first_0_0_13, last_0_0_16, move_phase_12, next_index_1, old_order_4, owns_provision_1, parent_0_0_19, participation_15, publication_transaction_18, renderer_0_3, root_0_0_16, scope_0_0_16, staged_retirements_19, table_21, updates_3, x_51_12000);
  }
}
 
 
// monadic lift
export function _mlift_reconcile_keyed_11487(children_0_1, committed_0_22, compare_2, drafts_7, enlisted_5, first_0_0_14, item_equals_0, items, key, last_0_0_17, move_phase_13, next_index_2, old_index_0, old_order_5, owns_provision_2, parent_0_0_20, participation_16, position_3, publication_transaction_19, renderer_0_4, root_0_0_17, scope_0_0_17, staged_retirements_20, table_22, updates_4, wild___1_0_0) /* forall<_e,_e1,_e2,a,b,e3> (children@0 : (item : kokaine/html/accessor<a>, index : kokaine/html/accessor<int>) -> <kokaine/html/html<e3>,kokaine/reactive/effects/signal-read> (), committed@0 : ref<global,bool>, compare : (b, b) -> order, drafts : ref<global,list<keyed-row<e3,a,b>>>, enlisted : ref<global,bool>, first@0@0 : node, item-equals : (a, a) -> bool, items : list<a>, key : (a) -> b, last@0@0 : node, move-phase : ref<global,bool>, next-index : ref<global,kokaine/internal/key-index/key-index<b,keyed-row<e3,a,b>>>, old-index : kokaine/internal/key-index/key-index<b,keyed-row<e3,a,b>>, old-order : list<keyed-row<e3,a,b>>, owns-provision : bool, parent@0@0 : node, participation : keyed-participation, position : ref<global,int>, publication-transaction : kokaine/dom/internal/keyed-transaction/keyed-transaction, renderer@0 : kokaine/dom/internal/keyed-transaction/keyed-context, root@0@0 : kokaine/reactive/root<ui>, scope@0@0 : kokaine/reactive/integration/lifetime-scope<ui>, staged-retirements : ref<global,list<keyed-retirement<e3,a,b>>>, table : ref<global,keyed-table<e3,a,b>>, updates : ref<global,list<keyed-update<e3,a,b>>>, wild_@1@0 : ()) -> <exn,ui,div,kokaine/reactive/effects/signal-write> () */  {
   
  var seen_identities = { value: ($kokaine_internal_key_dash_index.Key_index_empty) };
   
  var keyed_items_0 = { value: ($std_core_types.Nil) };
   
  var x_54_12006 = $std_core_list.foreach(items, function(item_0_1 /* 10858 */ ) {
       
      var identity_0_1 = $std_core_hnd._open_none1(key, item_0_1);
       
      var _x_x1_7_11236 = seen_identities.value;
      var _x103 = $std_core_hnd._open_none4($kokaine_internal_key_dash_index.insert, _x_x1_7_11236, identity_0_1, identity_0_1, compare_2);
      if (_x103._tag === 2) {
...
export function _mlift_reconcile_keyed_11489(children_0_3, compare_4, first_0_0_16, item_equals_2, items_1, key_1, last_0_0_19, old_index_2, old_order_7, parent_0_0_22, renderer_0_6, root_0_0_19, scope_0_0_19, table_24, participation_18) /* forall<_e,_e1,_e2,a,b,e3> (children@0 : (item : kokaine/html/accessor<a>, index : kokaine/html/accessor<int>) -> <kokaine/html/html<e3>,kokaine/reactive/effects/signal-read> (), compare : (b, b) -> order, first@0@0 : node, item-equals : (a, a) -> bool, items : list<a>, key : (a) -> b, last@0@0 : node, old-index : kokaine/internal/key-index/key-index<b,keyed-row<e3,a,b>>, old-order : list<keyed-row<e3,a,b>>, parent@0@0 : node, renderer@0 : kokaine/dom/internal/keyed-transaction/keyed-context, root@0@0 : kokaine/reactive/root<ui>, scope@0@0 : kokaine/reactive/integration/lifetime-scope<ui>, table : ref<global,keyed-table<e3,a,b>>, participation : keyed-participation) -> <kokaine/reactive/effects/signal-write,div,exn,ui> () */  {
  ...
  var x_57_12014 = $std_core_hnd._open_at3(0, function(parent_1_0 /* node */ , first_3_0 /* node */ , last_3 /* node */ ) {
  ...
  if ($std_core_hnd._yielding()) {
    var _x105 = $std_core_hnd.yield_extend(function(old_cursor_0 /* node */ ) {
      return _mlift_reconcile_keyed_11488(children_0_3, committed_0_24, compare_4, drafts_9, enlisted_7, first_0_0_16, item_equals_2, items_1, key_1, last_0_0_19, move_phase_15, next_index_4, old_index_2, old_order_7, owns_provision_4, parent_0_0_22, participation_18, position_5, publication_transaction_21, renderer_0_6, root_0_0_19, scope_0_0_19, staged_retirements_22, table_24, updates_6, old_cursor_0);
    });
  }
  else {
    var _x105 = _mlift_reconcile_keyed_11488(children_0_3, committed_0_24, compare_4, drafts_9, enlisted_7, first_0_0_16, item_equals_2, items_1, key_1, last_0_0_19, move_phase_15, next_index_4, old_index_2, old_order_7, owns_provision_4, parent_0_0_22, participation_18, position_5, publication_transaction_21, renderer_0_6, root_0_0_19, scope_0_0_19, staged_retirements_22, table_24, updates_6, x_57_12014);
  }
  return $std_core_hnd.finally_prompt(function() {
      ...
      if (_x103) {
        ...
        if (_x104) {
          ...
          var x_56_12012 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_write_fs__tag);
          if ($std_core_hnd._yielding()) {
            return $std_core_hnd.yield_extend(function(_y_x10547_0 /* hnd/ev-index */ ) {
              return _mlift_reconcile_keyed_11447(drafts_9, last_0_0_19, move_phase_15, old_order_7, parent_0_0_22, participation_18, staged_retirements_22, _y_x10547_0);
            });
          }
          else {
            return _mlift_reconcile_keyed_11447(drafts_9, last_0_0_19, move_phase_15, old_order_7, parent_0_0_22, participation_18, staged_retirements_22, x_56_12012);
          }
        }
      }
    }, _x105);
...
// monadic lift
export function _mlift_reconcile_keyed_11490(children_0_4, compare_5, first_0_0_17, item_equals_3, items_2, key_2, last_0_0_20, old_index_3, old_order_8, parent_0_0_23, renderer_0_7, root_0_0_20, scope_0_0_20, table_25, _y_x10544) /* forall<_e,_e1,_e2,a,b,e3> (children@0 : (item : kokaine/html/accessor<a>, index : kokaine/html/accessor<int>) -> <kokaine/html/html<e3>,kokaine/reactive/effects/signal-read> (), compare : (b, b) -> order, first@0@0 : node, item-equals : (a, a) -> bool, items : list<a>, key : (a) -> b, last@0@0 : node, old-index : kokaine/internal/key-index/key-index<b,keyed-row<e3,a,b>>, old-order : list<keyed-row<e3,a,b>>, parent@0@0 : node, renderer@0 : kokaine/dom/internal/keyed-transaction/keyed-context, root@0@0 : kokaine/reactive/root<ui>, scope@0@0 : kokaine/reactive/integration/lifetime-scope<ui>, table : ref<global,keyed-table<e3,a,b>>, hnd/ev-index) -> <kokaine/reactive/effects/signal-write,div,exn,ui> () */  {
   
  var x_58_12017 = $std_core_hnd._mask_at(_y_x10544, false, function() {
  ...
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(participation_19 /* keyed-participation */ ) {
      return _mlift_reconcile_keyed_11489(children_0_4, compare_5, first_0_0_17, item_equals_3, items_2, key_2, last_0_0_20, old_index_3, old_order_8, parent_0_0_23, renderer_0_7, root_0_0_20, scope_0_0_20, table_25, participation_19);
    });
  }
  else {
    return _mlift_reconcile_keyed_11489(children_0_4, compare_5, first_0_0_17, item_equals_3, items_2, key_2, last_0_0_20, old_index_3, old_order_8, parent_0_0_23, renderer_0_7, root_0_0_20, scope_0_0_20, table_25, x_58_12017);
  }
}
 
 
// monadic lift
export function _mlift_reconcile_keyed_11491(children_0_5, compare_6, first_0_0_18, item_equals_4, items_3, key_3, last_0_0_21, parent_0_0_24, renderer_0_8, root_0_0_21, scope_0_0_21, table_26, wild___5) /* forall<_e,_e1,_e2,a,b,e3> (children@0 : (item : kokaine/html/accessor<a>, index : kokaine/html/accessor<int>) -> <kokaine/html/html<e3>,kokaine/reactive/effects/signal-read> (), compare : (b, b) -> order, first@0@0 : node, item-equals : (a, a) -> bool, items : list<a>, key : (a) -> b, last@0@0 : node, parent@0@0 : node, renderer@0 : kokaine/dom/internal/keyed-transaction/keyed-context, root@0@0 : kokaine/reactive/root<ui>, scope@0@0 : kokaine/reactive/integration/lifetime-scope<ui>, table : ref<global,keyed-table<e3,a,b>>, wild_@5 : ()) -> <kokaine/reactive/effects/signal-write,div,exn,ui> () */  {
  var _x106 = table_26.value;
   
  var x_59_12019 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_write_fs__tag);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(_y_x10544_0 /* hnd/ev-index */ ) {
      return _mlift_reconcile_keyed_11490(children_0_5, compare_6, first_0_0_18, item_equals_4, items_3, key_3, last_0_0_21, _x106.table_index, _x106.table_order, parent_0_0_24, renderer_0_8, root_0_0_21, scope_0_0_21, table_26, _y_x10544_0);
    });
  }
  else {
    return _mlift_reconcile_keyed_11490(children_0_5, compare_6, first_0_0_18, item_equals_4, items_3, key_3, last_0_0_21, _x106.table_index, _x106.table_order, parent_0_0_24, renderer_0_8, root_0_0_21, scope_0_0_21, table_26, x_59_12019);
  }
}
 
 
// monadic lift
export function _mlift_reconcile_keyed_11492(children_0_6, compare_7, first_0_0_19, item_equals_5, items_4, key_4, last_0_0_22, parent_0_0_25, renderer_0_9, root_0_0_22, scope_0_0_22, table_27, _y_x10540) /* forall<_e,_e1,_e2,a,b,e3> (children@0 : (item : kokaine/html/accessor<a>, index : kokaine/html/accessor<int>) -> <kokaine/html/html<e3>,kokaine/reactive/effects/signal-read> (), compare : (b, b) -> order, first@0@0 : node, item-equals : (a, a) -> bool, items : list<a>, key : (a) -> b, last@0@0 : node, parent@0@0 : node, renderer@0 : kokaine/dom/internal/keyed-transaction/keyed-context, root@0@0 : kokaine/reactive/root<ui>, scope@0@0 : kokaine/reactive/integration/lifetime-scope<ui>, table : ref<global,keyed-table<e3,a,b>>, hnd/ev-index) -> <kokaine/reactive/effects/signal-write,div,exn,ui> () */  {
   
  var x_60_12021 = $std_core_hnd._mask_at(_y_x10540, false, function() {
      return drain_keyed_retirements(table_27);
    });
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(wild___5_0 /* () */ ) {
      return _mlift_reconcile_keyed_11491(children_0_6, compare_7, first_0_0_19, item_equals_5, items_4, key_4, last_0_0_22, parent_0_0_25, renderer_0_9, root_0_0_22, scope_0_0_22, table_27, wild___5_0);
    });
  }
  else {
    return _mlift_reconcile_keyed_11491(children_0_6, compare_7, first_0_0_19, item_equals_5, items_4, key_4, last_0_0_22, parent_0_0_25, renderer_0_9, root_0_0_22, scope_0_0_22, table_27, x_60_12021);
  }
}
 
 
// monadic lift
export function _mlift_mount_keyed_fields_11493(scope_1_0, _y_x10641) /* (scope@1@0 : kokaine/reactive/integration/lifetime-scope<ui>, hnd/ev-index) -> <kokaine/reactive/effects/signal-write,div,exn,ui> () */  {
  return $std_core_hnd._mask_at(_y_x10641, false, function() {
...
// monadic lift
export function _mlift_mount_keyed_fields_11494(first_1_0_0, last_1_0, _y_x10648) /* (first@1@0 : node, last@1@0 : node, hnd/ev-index) -> <kokaine/reactive/effects/signal-write,div,exn,ui> () */  {
...
// monadic lift
export function _mlift_mount_keyed_fields_11495(read, _y_x10661) /* forall<a> (read : () -> kokaine/reactive/effects/signal-read a, hnd/ev-index) -> <exn,div,kokaine/reactive/effects/signal-read> a */  {
  return $std_core_hnd._mask_at(_y_x10661, false, read);
}
 
 
// monadic lift
export function _mlift_mount_keyed_fields_11496(children_1_0, compare_0_0, first_1_0_1, item_equals_0_0, items_0_0, key_0_0, last_1_0_0, parent_1_0_0, renderer_1_0, root_1_0_0, scope_1_0_0, table_0_0, wild___3_1) /* forall<_e,a,b,e1> (children@1 : (item : kokaine/html/accessor<a>, index : kokaine/html/accessor<int>) -> <kokaine/html/html<e1>,kokaine/reactive/effects/signal-read> (), compare@0 : (b, b) -> order, first@1@0 : node, item-equals@0 : (a, a) -> bool, items@0 : ref<global,list<a>>, key@0 : (a) -> b, last@1@0 : node, parent@1@0 : node, renderer@1 : kokaine/dom/internal/keyed-transaction/keyed-context, root@1@0 : kokaine/reactive/root<ui>, scope@1@0 : kokaine/reactive/integration/lifetime-scope<ui>, table@0 : ref<global,keyed-table<e1,a,b>>, wild_@3@1 : ()) -> <div,exn,kokaine/reactive/effects/signal-write,ui> () */  {
   
  var xs_2_11056 = items_0_0.value;
  return reconcile_keyed(renderer_1_0, root_1_0_0, parent_1_0_0, first_1_0_1, last_1_0_0, scope_1_0_0, table_0_0, $std_core_list.reverse_acc($std_core_types.Nil, xs_2_11056), key_0_0, compare_0_0, item_equals_0_0, children_1_0);
}
 
 
// monadic lift
export function _mlift_mount_keyed_fields_11497(committed_1_0, _y_x10667) /* forall<_e> (committed@1 : ref<global,bool>, kokaine/reactive/disposer<ui>) -> <kokaine/reactive/effects/signal-write,pure> () */  {
...
// monadic lift
export function _mlift_mount_keyed_fields_11498(_pat_38_0) /* (kokaine/reactive/internal/model/cleanup-registration<ui>) -> exn () */  {
  return $std_core_types.Unit;
}
 
 
// monadic lift
export function _mlift_mount_keyed_fields_11499(first_1_0_2, last_1_0_1, _y_x10656) /* (first@1@0 : node, last@1@0 : node, hnd/ev-index) -> <kokaine/reactive/effects/signal-write,div,exn,ui> () */  {
  return $std_core_hnd._mask_at(_y_x10656, false, function() {
...
export function _mlift_mount_keyed_fields_11500(children_1_1, committed_1_1, compare_0_1, first_1_0_3, item_equals_0_1, key_0_1, last_1_0_2, parent_1_0_1, range_owned_0_0, read_0, renderer_1_1, root_1_0_1, scope_1_0_1, walk, wild___1_1) /* forall<_e,_e1,_e2,a,b,c,e3> (children@1 : (item : kokaine/html/accessor<b>, index : kokaine/html/accessor<int>) -> <kokaine/html/html<e3>,kokaine/reactive/effects/signal-read> (), committed@1 : ref<global,bool>, compare@0 : (c, c) -> order, first@1@0 : node, item-equals@0 : (b, b) -> bool, key@0 : (b) -> c, last@1@0 : node, parent@1@0 : node, range-owned@0 : ref<global,bool>, read : () -> kokaine/reactive/effects/signal-read a, renderer@1 : kokaine/dom/internal/keyed-transaction/keyed-context, root@1@0 : kokaine/reactive/root<ui>, scope@1@0 : kokaine/reactive/integration/lifetime-scope<ui>, walk : forall<e4> (a, (b) -> e4 ()) -> e4 (), wild_@1@1 : ()) -> <exn,div,kokaine/reactive/effects/signal-write,ui> () */  {
  ...
  var x_61_12030 = $kokaine_reactive.create_effect(root_1_0_1, function() {
       
      var x_62_12032 = $std_core_hnd._evv_index($std_core_exn.exn_fs__tag);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_y_x10661_0 /* hnd/ev-index */ ) {
          return _mlift_mount_keyed_fields_11495(read_0, _y_x10661_0);
        });
      }
      else {
        return _mlift_mount_keyed_fields_11495(read_0, x_62_12032);
      }
    }, function(snapshot_0 /* 10877 */ ) {
      return $kokaine_reactive_integration.with_lifetime_scope(root_1_0_1, scope_1_0_1, function() {
          ...
          var x_63_12034 = walk(snapshot_0, function(item_1_0 /* 10878 */ ) {
               
              var value_76_11054 = $std_core_types.Cons(item_1_0, items_0_1.value);
              return ((items_0_1).value = value_76_11054);
            });
          if ($std_core_hnd._yielding()) {
            return $std_core_hnd.yield_extend(function(wild___3_1_0 /* () */ ) {
              return _mlift_mount_keyed_fields_11496(children_1_1, compare_0_1, first_1_0_3, item_equals_0_1, items_0_1, key_0_1, last_1_0_2, parent_1_0_1, renderer_1_1, root_1_0_1, scope_1_0_1, table_0_1, wild___3_1_0);
            });
          }
          else {
            return _mlift_mount_keyed_fields_11496(children_1_1, compare_0_1, first_1_0_3, item_equals_0_1, items_0_1, key_0_1, last_1_0_2, parent_1_0_1, renderer_1_1, root_1_0_1, scope_1_0_1, table_0_1, x_63_12034);
          }
        });
    });
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(_y_x10667_0 /* kokaine/reactive/disposer<ui> */ ) {
      return _mlift_mount_keyed_fields_11497(committed_1_1, _y_x10667_0);
    });
  }
  else {
    return _mlift_mount_keyed_fields_11497(committed_1_1, x_61_12030);
  }
}
 
 
// monadic lift
export function _mlift_mount_keyed_fields_11501(children_1_2, committed_1_2, compare_0_2, first_1_0_4, installed_0_0, item_equals_0_2, key_0_2, last_1_0_3, parent_1_0_2, range_owned_0_1, read_1, renderer_1_2, root_1_0_2, scope_1_0_2, walk_0, wild___29) /* forall<_e,_e1,_e2,a,b,c,e3> (children@1 : (item : kokaine/html/accessor<b>, index : kokaine/html/accessor<int>) -> <kokaine/html/html<e3>,kokaine/reactive/effects/signal-read> (), committed@1 : ref<global,bool>, compare@0 : (c, c) -> order, first@1@0 : node, installed@0 : ref<global,bool>, item-equals@0 : (b, b) -> bool, key@0 : (b) -> c, last@1@0 : node, parent@1@0 : node, range-owned@0 : ref<global,bool>, read : () -> kokaine/reactive/effects/signal-read a, renderer@1 : kokaine/dom/internal/keyed-transaction/keyed-context, root@1@0 : kokaine/reactive/root<ui>, scope@1@0 : kokaine/reactive/integration/lifetime-scope<ui>, walk : forall<e4> (a, (b) -> e4 ()) -> e4 (), wild_@29 : ()) -> <exn,ui,div,kokaine/reactive/effects/signal-write> () */  {
   
  ((installed_0_0).value = true);
   
  var x_64_12036 = $std_core_hnd._open_at2(0, function(root_6_0 /* kokaine/reactive/root<ui> */ , cleanup_0 /* () -> <kokaine/reactive/effects/signal-write,pure,ui> () */ ) {
       
      var root_0_10046_0 = $std_core_hnd._open_none1(function(value_72 /* kokaine/reactive/root<ui> */ ) {
          return value_72;
        }, root_6_0);
       
      var x_65_12038 = $kokaine_reactive_internal_runtime.register_cleanup(root_0_10046_0, cleanup_0);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(_mlift_mount_keyed_fields_11498);
      }
      else {
        return _mlift_mount_keyed_fields_11498(x_65_12038);
      }
    }, root_1_0_2, function() {
       
      var x_66_12040 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_write_fs__tag);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_y_x10656_0 /* hnd/ev-index */ ) {
          return _mlift_mount_keyed_fields_11499(first_1_0_4, last_1_0_3, _y_x10656_0);
        });
      }
      else {
        return _mlift_mount_keyed_fields_11499(first_1_0_4, last_1_0_3, x_66_12040);
      }
    });
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(wild___1_1_0 /* () */ ) {
      return _mlift_mount_keyed_fields_11500(children_1_2, committed_1_2, compare_0_2, first_1_0_4, item_equals_0_2, key_0_2, last_1_0_3, parent_1_0_2, range_owned_0_1, read_1, renderer_1_2, root_1_0_2, scope_1_0_2, walk_0, wild___1_1_0);
    });
  }
  else {
    return _mlift_mount_keyed_fields_11500(children_1_2, committed_1_2, compare_0_2, first_1_0_4, item_equals_0_2, key_0_2, last_1_0_3, parent_1_0_2, range_owned_0_1, read_1, renderer_1_2, root_1_0_2, scope_1_0_2, walk_0, x_64_12036);
  }
}
 
 
// monadic lift
export function _mlift_mount_keyed_fields_11502(before_0, children_1_3, committed_1_3, compare_0_3, first_1_0_5, installed_0_1, item_equals_0_3, key_0_3, parent_1_0_3, range_owned_0_2, read_2, renderer_1_3, root_1_0_3, scope_1_0_3, walk_1, last_1_0_4) /* forall<_e,_e1,_e2,a,b,c,e3> (before@0 : maybe<node>, children@1 : (item : kokaine/html/accessor<b>, index : kokaine/html/accessor<int>) -> <kokaine/html/html<e3>,kokaine/reactive/effects/signal-read> (), committed@1 : ref<global,bool>, compare@0 : (c, c) -> order, first@1@0 : node, installed@0 : ref<global,bool>, item-equals@0 : (b, b) -> bool, key@0 : (b) -> c, parent@1@0 : node, range-owned@0 : ref<global,bool>, read : () -> kokaine/reactive/effects/signal-read a, renderer@1 : kokaine/dom/internal/keyed-transaction/keyed-context, root@1@0 : kokaine/reactive/root<ui>, scope@1@0 : kokaine/reactive/integration/lifetime-scope<ui>, walk : forall<e4> (a, (b) -> e4 ()) -> e4 (), last@1@0 : node) -> <exn,ui,div,kokaine/reactive/effects/signal-write> () */  {
   
  var x_68_12046 = $std_core_hnd._open_at4(0, insert_marker_pair, parent_1_0_3, before_0, first_1_0_5, last_1_0_4);
  if ($std_core_hnd._yielding()) {
    var _x111 = $std_core_hnd.yield_extend(function(wild___29_0 /* () */ ) {
      return _mlift_mount_keyed_fields_11501(children_1_3, committed_1_3, compare_0_3, first_1_0_5, installed_0_1, item_equals_0_3, key_0_3, last_1_0_4, parent_1_0_3, range_owned_0_2, read_2, renderer_1_3, root_1_0_3, scope_1_0_3, walk_1, wild___29_0);
    });
  }
  else {
    var _x111 = _mlift_mount_keyed_fields_11501(children_1_3, committed_1_3, compare_0_3, first_1_0_5, installed_0_1, item_equals_0_3, key_0_3, last_1_0_4, parent_1_0_3, range_owned_0_2, read_2, renderer_1_3, root_1_0_3, scope_1_0_3, walk_1, x_68_12046);
  }
  return $std_core_hnd.finally_prompt(function() {
      var _x109 = installed_0_1.value;
      if (_x109) {
         
        var _x_x1_4_11308 = range_owned_0_2.value;
        var _x110 = $std_core_hnd._open_none1(function(b_5 /* bool */ ) {
            return (b_5) ? false : true;
          }, _x_x1_4_11308);
        if (_x110) {
           
          var x_67_12044 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_write_fs__tag);
          if ($std_core_hnd._yielding()) {
            return $std_core_hnd.yield_extend(function(_y_x10648_0 /* hnd/ev-index */ ) {
              return _mlift_mount_keyed_fields_11494(first_1_0_5, last_1_0_4, _y_x10648_0);
            });
          }
          else {
            return _mlift_mount_keyed_fields_11494(first_1_0_5, last_1_0_4, x_67_12044);
          }
        }
        else {
          return $std_core_types.Unit;
...
// monadic lift
export function _mlift_mount_keyed_fields_11503(before_0_0, children_1_4, committed_1_4, compare_0_4, installed_0_2, item_equals_0_4, key_0_4, parent_1_0_4, range_owned_0_3, read_3, renderer_1_4, root_1_0_4, scope_1_0_4, walk_2, first_1_0_6) /* forall<_e,_e1,_e2,a,b,c,e3> (before@0 : maybe<node>, children@1 : (item : kokaine/html/accessor<b>, index : kokaine/html/accessor<int>) -> <kokaine/html/html<e3>,kokaine/reactive/effects/signal-read> (), committed@1 : ref<global,bool>, compare@0 : (c, c) -> order, installed@0 : ref<global,bool>, item-equals@0 : (b, b) -> bool, key@0 : (b) -> c, parent@1@0 : node, range-owned@0 : ref<global,bool>, read : () -> kokaine/reactive/effects/signal-read a, renderer@1 : kokaine/dom/internal/keyed-transaction/keyed-context, root@1@0 : kokaine/reactive/root<ui>, scope@1@0 : kokaine/reactive/integration/lifetime-scope<ui>, walk : forall<e4> (a, (b) -> e4 ()) -> e4 (), first@1@0 : node) -> <exn,ui,div,kokaine/reactive/effects/signal-write> () */  {
   
  var x_69_12048 = $std_core_hnd._open_at1(0, dom_attempt, function() {
      return dom_create_comment("/kokaine:for");
    });
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(last_1_0_5 /* node */ ) {
      return _mlift_mount_keyed_fields_11502(before_0_0, children_1_4, committed_1_4, compare_0_4, first_1_0_6, installed_0_2, item_equals_0_4, key_0_4, parent_1_0_4, range_owned_0_3, read_3, renderer_1_4, root_1_0_4, scope_1_0_4, walk_2, last_1_0_5);
    });
  }
  else {
    return _mlift_mount_keyed_fields_11502(before_0_0, children_1_4, committed_1_4, compare_0_4, first_1_0_6, installed_0_2, item_equals_0_4, key_0_4, parent_1_0_4, range_owned_0_3, read_3, renderer_1_4, root_1_0_4, scope_1_0_4, walk_2, x_69_12048);
  }
}
 
 
// monadic lift
export function _mlift_mount_keyed_fields_11504(_y_x10639) /* (kokaine/reactive/integration/internal/lifetime-scope/lifetime-scope<ui>) -> exn kokaine/reactive/integration/lifetime-scope<ui> */  {
  return _y_x10639;
}
 
 
// monadic lift
export function _mlift_mount_keyed_fields_11505(before_0_1, children_1_5, compare_0_5, item_equals_0_5, key_0_5, parent_1_0_5, read_4, renderer_1_5, root_1_0_5, walk_3, scope_1_0_5) /* forall<_e,_e1,_e2,a,b,c,e3> (before@0 : maybe<node>, children@1 : (item : kokaine/html/accessor<b>, index : kokaine/html/accessor<int>) -> <kokaine/html/html<e3>,kokaine/reactive/effects/signal-read> (), compare@0 : (c, c) -> order, item-equals@0 : (b, b) -> bool, key@0 : (b) -> c, parent@1@0 : node, read : () -> kokaine/reactive/effects/signal-read a, renderer@1 : kokaine/dom/internal/keyed-transaction/keyed-context, root@1@0 : kokaine/reactive/root<ui>, walk : forall<e4> (a, (b) -> e4 ()) -> e4 (), scope@1@0 : kokaine/reactive/integration/lifetime-scope<ui>) -> <exn,div,kokaine/reactive/effects/signal-write,ui> () */  {
  ...
  return $std_core_hnd.finally_prompt(function() {
      ...
      if (_x112) {
        ...
        var x_70_12052 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_write_fs__tag);
        if ($std_core_hnd._yielding()) {
          return $std_core_hnd.yield_extend(function(_y_x10641_0 /* hnd/ev-index */ ) {
            return _mlift_mount_keyed_fields_11493(scope_1_0_5, _y_x10641_0);
          });
        }
        else {
          return _mlift_mount_keyed_fields_11493(scope_1_0_5, x_70_12052);
        }
      }
    }, $kokaine_reactive_integration.with_lifetime_scope(root_1_0_5, scope_1_0_5, function() {
         
        var x_71_12054 = $std_core_hnd._open_at1(0, dom_attempt, function() {
            return dom_create_comment("kokaine:for");
          });
        if ($std_core_hnd._yielding()) {
          return $std_core_hnd.yield_extend(function(first_1_0_7 /* node */ ) {
            return _mlift_mount_keyed_fields_11503(before_0_1, children_1_5, committed_1_5, compare_0_5, installed_0_3, item_equals_0_5, key_0_5, parent_1_0_5, range_owned_0_4, read_4, renderer_1_5, root_1_0_5, scope_1_0_5, walk_3, first_1_0_7);
          });
        }
        else {
          return _mlift_mount_keyed_fields_11503(before_0_1, children_1_5, committed_1_5, compare_0_5, installed_0_3, item_equals_0_5, key_0_5, parent_1_0_5, range_owned_0_4, read_4, renderer_1_5, root_1_0_5, scope_1_0_5, walk_3, x_71_12054);
        }
      }));
}
...
// monadic lift
export function _mlift_mount_view_11506(before_1, parent_3_0_0, target_20) /* (before@1 : maybe<node>, parent@3@0 : node, target@20 : node) -> <exn,ui,div,kokaine/reactive/effects/signal-write> () */  {
  return $std_core_hnd._open_at3(0, insert, parent_3_0_0, before_1, target_20);
}
 
 
// monadic lift
export function _mlift_mount_view_11507(read_1_0, _y_x10678) /* (read@1 : () -> kokaine/reactive/effects/signal-read string, hnd/ev-index) -> <exn,div,kokaine/reactive/effects/signal-read> string */  {
  return $std_core_hnd._mask_at(_y_x10678, false, read_1_0);
}
 
 
// monadic lift
export function _mlift_mount_view_11508(target_0_0, value_80, _y_x10681) /* (target@0@0 : node, value@80 : string, hnd/ev-index) -> <kokaine/reactive/effects/signal-write,div,exn,ui> () */  {
  return $std_core_hnd._mask_at(_y_x10681, false, function() {
       
      var result_12 = $std_core_hnd._open_none1(dom_attempt_raw, function() {
          return dom_set_text(target_0_0, value_80);
        });
...
// monadic lift
export function _mlift_mount_view_11509(_y_x10685) /* (kokaine/reactive/disposer<ui>) -> <kokaine/reactive/effects/signal-write,pure> () */  {
  return $std_core_types.Unit;
}
 
 
// monadic lift
export function _mlift_mount_view_11510(read_1_1, root_3_0, target_0_0_0, wild___30) /* (read@1 : () -> kokaine/reactive/effects/signal-read string, root@3@0 : kokaine/reactive/root<ui>, target@0@0 : node, wild_@30 : ()) -> <exn,ui,div,kokaine/reactive/effects/signal-write> () */  {
   
  var x_72_12059 = $kokaine_reactive.create_effect(root_3_0, function() {
       
      var x_73_12061 = $std_core_hnd._evv_index($std_core_exn.exn_fs__tag);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_y_x10678_0 /* hnd/ev-index */ ) {
          return _mlift_mount_view_11507(read_1_1, _y_x10678_0);
        });
      }
      else {
        return _mlift_mount_view_11507(read_1_1, x_73_12061);
      }
    }, function(value_80_0 /* string */ ) {
       
      var x_74_12063 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_write_fs__tag);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_y_x10681_0 /* hnd/ev-index */ ) {
          return _mlift_mount_view_11508(target_0_0_0, value_80_0, _y_x10681_0);
        });
      }
      else {
        return _mlift_mount_view_11508(target_0_0_0, value_80_0, x_74_12063);
      }
    });
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(_mlift_mount_view_11509);
  }
  else {
    return _mlift_mount_view_11509(x_72_12059);
  }
}
 
 
// monadic lift
export function _mlift_mount_view_11511(before_1_0, parent_3_0_1, read_1_2, root_3_0_0, target_0_0_1) /* (before@1 : maybe<node>, parent@3@0 : node, read@1 : () -> kokaine/reactive/effects/signal-read string, root@3@0 : kokaine/reactive/root<ui>, target@0@0 : node) -> <exn,ui,div,kokaine/reactive/effects/signal-write> () */  {
   
  var x_75_12065 = $std_core_hnd._open_at3(0, insert, parent_3_0_1, before_1_0, target_0_0_1);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(wild___30_0 /* () */ ) {
      return _mlift_mount_view_11510(read_1_2, root_3_0_0, target_0_0_1, wild___30_0);
    });
  }
  else {
    return _mlift_mount_view_11510(read_1_2, root_3_0_0, target_0_0_1, x_75_12065);
  }
}
 
 
// monadic lift
export function _mlift_mount_view_11512(before_1_1, parent_3_0_2, target_1_0, wild___2_2) /* (before@1 : maybe<node>, parent@3@0 : node, target@1@0 : element, wild_@2@2 : ()) -> <div,exn,kokaine/reactive/effects/signal-write,ui> () */  {
   
  var _x_x3_1_11333 = $std_core_hnd._open_none1(element_node, target_1_0);
...
export function _mlift_mount_view_11513(before_1_2, children_3_0, parent_3_0_3, renderer_3_0, root_3_0_1, target_1_0_0, wild___1_2) /* forall<e> (before@1 : maybe<node>, children@3 : list<kokaine/html/view<e>>, parent@3@0 : node, renderer@3 : kokaine/dom/internal/keyed-transaction/keyed-context, root@3@0 : kokaine/reactive/root<ui>, target@1@0 : element, wild_@1@2 : ()) -> <div,exn,kokaine/reactive/effects/signal-write,ui> () */  {
  ...
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(wild___2_2_0 /* () */ ) {
      return _mlift_mount_view_11512(before_1_2, parent_3_0_3, target_1_0_0, wild___2_2_0);
    });
  }
  else {
    return _mlift_mount_view_11512(before_1_2, parent_3_0_3, target_1_0_0, x_76_12069);
  }
}
 
 
// monadic lift
export function _mlift_mount_view_11514(attributes, before_1_3, children_3_1, parent_3_0_4, renderer_3_1, root_3_0_2, target_1_0_1, wild___0_2) /* forall<e> (attributes : list<kokaine/html/attribute<e>>, before@1 : maybe<node>, children@3 : list<kokaine/html/view<e>>, parent@3@0 : node, renderer@3 : kokaine/dom/internal/keyed-transaction/keyed-context, root@3@0 : kokaine/reactive/root<ui>, target@1@0 : element, wild_@0@2 : ()) -> <pure,kokaine/reactive/effects/signal-write,ui> () */  {
   
  var x_77_12071 = $std_core_list.foreach(attributes, function(attribute /* kokaine/html/attribute<10906> */ ) {
      return mount_attribute(root_3_0_2, target_1_0_1, attribute);
    });
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(wild___1_2_0 /* () */ ) {
      return _mlift_mount_view_11513(before_1_3, children_3_1, parent_3_0_4, renderer_3_1, root_3_0_2, target_1_0_1, wild___1_2_0);
    });
  }
  else {
    return _mlift_mount_view_11513(before_1_3, children_3_1, parent_3_0_4, renderer_3_1, root_3_0_2, target_1_0_1, x_77_12071);
  }
}
 
 
// monadic lift
export function _mlift_mount_view_11515(attributes_0, before_1_4, children_3_2, parent_3_0_5, renderer_3_2, root_3_0_3, target_1_0_2) /* forall<e> (attributes : list<kokaine/html/attribute<e>>, before@1 : maybe<node>, children@3 : list<kokaine/html/view<e>>, parent@3@0 : node, renderer@3 : kokaine/dom/internal/keyed-transaction/keyed-context, root@3@0 : kokaine/reactive/root<ui>, target@1@0 : element) -> <exn,ui,div,kokaine/reactive/effects/signal-write> () */  {
   
  var x_78_12073 = record_owner(root_3_0_3, $std_core_hnd._open_none1(element_node, target_1_0_2));
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(wild___0_2_0 /* () */ ) {
      return _mlift_mount_view_11514(attributes_0, before_1_4, children_3_2, parent_3_0_5, renderer_3_2, root_3_0_3, target_1_0_2, wild___0_2_0);
    });
  }
  else {
    return _mlift_mount_view_11514(attributes_0, before_1_4, children_3_2, parent_3_0_5, renderer_3_2, root_3_0_3, target_1_0_2, x_78_12073);
  }
}
 
 
// monadic lift
export function _mlift_mount_view_11516(read_0_0_0, _y_x10703) /* forall<e> (read@0@0@0 : () -> kokaine/reactive/effects/signal-read kokaine/html/view<e>, hnd/ev-index) -> <exn,div,kokaine/reactive/effects/signal-read> kokaine/html/view<e> */  {
  return $std_core_hnd._mask_at(_y_x10703, false, read_0_0_0);
}
 
 
// monadic lift
export function _mlift_mount_view_11517(_pat_41_0) /* (kokaine/reactive/internal/model/cleanup-registration<ui>) -> exn () */  {
  return $std_core_types.Unit;
}
 
 
// monadic lift
export function _mlift_mount_view_11518(first_2_0, last_2_0, _y_x10707) /* (first@2@0 : node, last@2@0 : node, hnd/ev-index) -> <kokaine/reactive/effects/signal-write,div,exn,ui> () */  {
  return $std_core_hnd._mask_at(_y_x10707, false, function() {
...
// monadic lift
export function _mlift_mount_view_11519(last_2_0_0, next_1_0, parent_3_0_6, renderer_3_3, root_3_0_4, wild___4_2) /* forall<e> (last@2@0 : node, next@1 : kokaine/html/view<e>, parent@3@0 : node, renderer@3 : kokaine/dom/internal/keyed-transaction/keyed-context, root@3@0 : kokaine/reactive/root<ui>, wild_@4@2 : ()) -> <exn,div,kokaine/reactive/effects/signal-write,ui> () */  {
  return mount_view(renderer_3_3, root_3_0_4, parent_3_0_6, $std_core_types.Just(last_2_0_0), next_1_0);
}
 
 
// monadic lift
export function _mlift_mount_view_11520(_y_x10713) /* (kokaine/reactive/disposer<ui>) -> <kokaine/reactive/effects/signal-write,pure> () */  {
  return $std_core_types.Unit;
}
 
 
// monadic lift
export function _mlift_mount_view_11521(first_2_0_0, last_2_0_1, parent_3_0_7, read_0_0_0_0, renderer_3_4, root_3_0_5, wild___3_2) /* forall<e> (first@2@0 : node, last@2@0 : node, parent@3@0 : node, read@0@0@0 : () -> kokaine/reactive/effects/signal-read kokaine/html/view<e>, renderer@3 : kokaine/dom/internal/keyed-transaction/keyed-context, root@3@0 : kokaine/reactive/root<ui>, wild_@3@2 : ()) -> <exn,ui,div,kokaine/reactive/effects/signal-write> () */  {
   
  var x_79_12078 = $kokaine_reactive.create_effect(root_3_0_5, function() {
       
      var x_80_12080 = $std_core_hnd._evv_index($std_core_exn.exn_fs__tag);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_y_x10703_0 /* hnd/ev-index */ ) {
          return _mlift_mount_view_11516(read_0_0_0_0, _y_x10703_0);
        });
      }
      else {
        return _mlift_mount_view_11516(read_0_0_0_0, x_80_12080);
      }
    }, function(next_1_1 /* kokaine/html/view<10906> */ ) {
       
      var x_81_12082 = $std_core_hnd._open_at2(0, function(root_7_0 /* kokaine/reactive/root<ui> */ , cleanup_1 /* () -> <kokaine/reactive/effects/signal-write,pure,ui> () */ ) {
           
          var root_0_10046_1 = $std_core_hnd._open_none1(function(value_81 /* kokaine/reactive/root<ui> */ ) {
              return value_81;
            }, root_7_0);
           
          var x_82_12084 = $kokaine_reactive_internal_runtime.register_cleanup(root_0_10046_1, cleanup_1);
          if ($std_core_hnd._yielding()) {
            return $std_core_hnd.yield_extend(_mlift_mount_view_11517);
          }
          else {
            return _mlift_mount_view_11517(x_82_12084);
          }
        }, root_3_0_5, function() {
           
          var x_83_12086 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_write_fs__tag);
          if ($std_core_hnd._yielding()) {
            return $std_core_hnd.yield_extend(function(_y_x10707_0 /* hnd/ev-index */ ) {
              return _mlift_mount_view_11518(first_2_0_0, last_2_0_1, _y_x10707_0);
            });
          }
          else {
            return _mlift_mount_view_11518(first_2_0_0, last_2_0_1, x_83_12086);
          }
        });
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(wild___4_2_0 /* () */ ) {
          return _mlift_mount_view_11519(last_2_0_1, next_1_1, parent_3_0_7, renderer_3_4, root_3_0_5, wild___4_2_0);
        });
      }
      else {
        return _mlift_mount_view_11519(last_2_0_1, next_1_1, parent_3_0_7, renderer_3_4, root_3_0_5, x_81_12082);
      }
    });
  if ($std_core_hnd._yielding()) {
    ...
    return _mlift_mount_view_11520(x_79_12078);
  }
}
 
 
// monadic lift
export function _mlift_mount_view_11522(before_1_5, first_2_0_1, parent_3_0_8, read_0_0_0_1, renderer_3_5, root_3_0_6, last_2_0_2) /* forall<e> (before@1 : maybe<node>, first@2@0 : node, parent@3@0 : node, read@0@0@0 : () -> kokaine/reactive/effects/signal-read kokaine/html/view<e>, renderer@3 : kokaine/dom/internal/keyed-transaction/keyed-context, root@3@0 : kokaine/reactive/root<ui>, last@2@0 : node) -> <exn,ui,div,kokaine/reactive/effects/signal-write> () */  {
   
  var x_84_12088 = $std_core_hnd._open_at4(0, insert_marker_pair, parent_3_0_8, before_1_5, first_2_0_1, last_2_0_2);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(wild___3_2_0 /* () */ ) {
      return _mlift_mount_view_11521(first_2_0_1, last_2_0_2, parent_3_0_8, read_0_0_0_1, renderer_3_5, root_3_0_6, wild___3_2_0);
    });
  }
  else {
    return _mlift_mount_view_11521(first_2_0_1, last_2_0_2, parent_3_0_8, read_0_0_0_1, renderer_3_5, root_3_0_6, x_84_12088);
  }
}
 
 
// monadic lift
export function _mlift_mount_view_11523(before_1_6, parent_3_0_9, read_0_0_0_2, renderer_3_6, root_3_0_7, first_2_0_2) /* forall<e> (before@1 : maybe<node>, parent@3@0 : node, read@0@0@0 : () -> kokaine/reactive/effects/signal-read kokaine/html/view<e>, renderer@3 : kokaine/dom/internal/keyed-transaction/keyed-context, root@3@0 : kokaine/reactive/root<ui>, first@2@0 : node) -> <exn,ui,div,kokaine/reactive/effects/signal-write> () */  {
   
  var x_85_12090 = $std_core_hnd._open_at1(0, dom_attempt, function() {
      return dom_create_comment("/kokaine:region");
    });
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(last_2_0_3 /* node */ ) {
      return _mlift_mount_view_11522(before_1_6, first_2_0_2, parent_3_0_9, read_0_0_0_2, renderer_3_6, root_3_0_7, last_2_0_3);
    });
  }
  else {
    return _mlift_mount_view_11522(before_1_6, first_2_0_2, parent_3_0_9, read_0_0_0_2, renderer_3_6, root_3_0_7, x_85_12090);
  }
}
...
export function create_keyed_row(renderer_9, root_9, parent_9, last_7, identity_9, item_9, index_9, children_7) /* forall<a,b,e> (renderer : kokaine/dom/internal/keyed-transaction/keyed-context, root : kokaine/reactive/root<ui>, parent : node, last : node, identity : a, item : b, index : int, children : (item : kokaine/html/accessor<b>, index : kokaine/html/accessor<int>) -> <kokaine/html/html<e>,kokaine/reactive/effects/signal-read> ()) -> <pure,kokaine/reactive/effects/signal-write,ui> keyed-row<e,b,a> */  {
  ...
  var x_86_12092 = $std_core_hnd._open_at1(0, function(root_0_1 /* kokaine/reactive/root<ui> */ ) {
       
      var x_87_12095 = $kokaine_reactive_integration_internal_lifetime_dash_scope.open_lifetime_scope($std_core_hnd._open_none1(function(value_0 /* kokaine/reactive/root<ui> */ ) {
          return value_0;
        }, root_0_1));
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(_mlift_create_keyed_row_11444);
      }
      else {
        return _mlift_create_keyed_row_11444(x_87_12095);
      }
    }, root_9);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(scope_10 /* kokaine/reactive/integration/lifetime-scope<ui> */ ) {
      return _mlift_create_keyed_row_11445(children_7, identity_9, index_9, item_9, last_7, parent_9, renderer_9, root_9, scope_10);
    });
  }
  else {
    ...
    return $std_core_hnd.finally_prompt(function() {
        ...
        if (_x117) {
          ...
          var x_88_12099 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_write_fs__tag);
          if ($std_core_hnd._yielding()) {
            return $std_core_hnd.yield_extend(function(_y_x10500_1 /* hnd/ev-index */ ) {
              return _mlift_create_keyed_row_11428(x_86_12092, _y_x10500_1);
            });
          }
          else {
            return _mlift_create_keyed_row_11428(x_86_12092, x_88_12099);
          }
        }
      }, $kokaine_reactive_integration.with_lifetime_scope(root_9, x_86_12092, function() {
           
          var x_89_12101 = $std_core_hnd._open_at1(0, dom_attempt, function() {
              return dom_create_comment("kokaine:for-row");
            });
          if ($std_core_hnd._yielding()) {
            return $std_core_hnd.yield_extend(function(first_11 /* node */ ) {
              return _mlift_create_keyed_row_11443(children_7, committed_9, identity_9, index_9, installed_3, item_9, last_7, parent_9, range_owned_4, renderer_9, root_9, x_86_12092, first_11);
            });
          }
          else {
            return _mlift_create_keyed_row_11443(children_7, committed_9, identity_9, index_9, installed_3, item_9, last_7, parent_9, range_owned_4, renderer_9, root_9, x_86_12092, x_89_12101);
          }
        }));
  }
}
...
export function reconcile_keyed(renderer_0_10, root_0_0_23, parent_0_0_26, first_0_0_20, last_0_0_23, scope_0_0_23, table_28, items_5, key_5, compare_8, item_equals_6, children_0_7) /* forall<a,b,e> (renderer : kokaine/dom/internal/keyed-transaction/keyed-context, root : kokaine/reactive/root<ui>, parent : node, first : node, last : node, scope : kokaine/reactive/integration/lifetime-scope<ui>, table : ref<global,keyed-table<e,a,b>>, items : list<a>, key : (a) -> b, compare : (b, b) -> order, item-equals : (a, a) -> bool, children : (item : kokaine/html/accessor<a>, index : kokaine/html/accessor<int>) -> <kokaine/html/html<e>,kokaine/reactive/effects/signal-read> ()) -> <pure,kokaine/reactive/effects/signal-write,ui> () */  {
  ...
  var x_90_12103 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_write_fs__tag);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(_y_x10540_0 /* hnd/ev-index */ ) {
      return _mlift_reconcile_keyed_11492(children_0_7, compare_8, first_0_0_20, item_equals_6, items_5, key_5, last_0_0_23, parent_0_0_26, renderer_0_10, root_0_0_23, scope_0_0_23, table_28, _y_x10540_0);
    });
  }
  else {
     
    var x_91_12106 = $std_core_hnd._mask_at(x_90_12103, false, function() {
        return drain_keyed_retirements(table_28);
      });
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(wild___5_1 /* () */ ) {
        return _mlift_reconcile_keyed_11491(children_0_7, compare_8, first_0_0_20, item_equals_6, items_5, key_5, last_0_0_23, parent_0_0_26, renderer_0_10, root_0_0_23, scope_0_0_23, table_28, wild___5_1);
      });
    }
    else {
      var _x118 = table_28.value;
       
      var x_92_12110 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_write_fs__tag);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_y_x10544_1 /* hnd/ev-index */ ) {
          return _mlift_reconcile_keyed_11490(children_0_7, compare_8, first_0_0_20, item_equals_6, items_5, key_5, last_0_0_23, _x118.table_index, _x118.table_order, parent_0_0_26, renderer_0_10, root_0_0_23, scope_0_0_23, table_28, _y_x10544_1);
        });
      }
      else {
         
        var x_93_12113 = $std_core_hnd._mask_at(x_92_12110, false, function() {
        ...
        if ($std_core_hnd._yielding()) {
          return $std_core_hnd.yield_extend(function(participation_20 /* keyed-participation */ ) {
            return _mlift_reconcile_keyed_11489(children_0_7, compare_8, first_0_0_20, item_equals_6, items_5, key_5, last_0_0_23, _x118.table_index, _x118.table_order, parent_0_0_26, renderer_0_10, root_0_0_23, scope_0_0_23, table_28, participation_20);
          });
        }
        else {
          ...
          var x_95_12120 = $std_core_hnd._open_at3(0, function(parent_1_1 /* node */ , first_3_1 /* node */ , last_3_0 /* node */ ) {
          ...
          if ($std_core_hnd._yielding()) {
            var _x121 = $std_core_hnd.yield_extend(function(old_cursor_1 /* node */ ) {
              return _mlift_reconcile_keyed_11488(children_0_7, committed_0_25, compare_8, drafts_10, enlisted_8, first_0_0_20, item_equals_6, items_5, key_5, last_0_0_23, move_phase_16, next_index_5, _x118.table_index, _x118.table_order, owns_provision_5, parent_0_0_26, x_93_12113, position_6, publication_transaction_22, renderer_0_10, root_0_0_23, scope_0_0_23, staged_retirements_23, table_28, updates_7, old_cursor_1);
            });
          }
          else {
            var _x121 = _mlift_reconcile_keyed_11488(children_0_7, committed_0_25, compare_8, drafts_10, enlisted_8, first_0_0_20, item_equals_6, items_5, key_5, last_0_0_23, move_phase_16, next_index_5, _x118.table_index, _x118.table_order, owns_provision_5, parent_0_0_26, x_93_12113, position_6, publication_transaction_22, renderer_0_10, root_0_0_23, scope_0_0_23, staged_retirements_23, table_28, updates_7, x_95_12120);
          }
          return $std_core_hnd.finally_prompt(function() {
              ...
              if (_x119) {
                ...
                if (_x120) {
                  ...
                  var x_94_12118 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_write_fs__tag);
                  if ($std_core_hnd._yielding()) {
                    return $std_core_hnd.yield_extend(function(_y_x10547_1 /* hnd/ev-index */ ) {
                      return _mlift_reconcile_keyed_11447(drafts_10, last_0_0_23, move_phase_16, _x118.table_order, parent_0_0_26, x_93_12113, staged_retirements_23, _y_x10547_1);
                    });
                  }
                  else {
                    return _mlift_reconcile_keyed_11447(drafts_10, last_0_0_23, move_phase_16, _x118.table_order, parent_0_0_26, x_93_12113, staged_retirements_23, x_94_12118);
                  }
                }
              }
            }, _x121);
...
export function mount_keyed_fields(renderer_1_6, root_1_0_6, parent_1_0_6, before_0_2, read_5, walk_4, key_0_6, compare_0_6, item_equals_0_6, children_1_6) /* forall<a,b,c,e> (renderer : kokaine/dom/internal/keyed-transaction/keyed-context, root : kokaine/reactive/root<ui>, parent : node, before : maybe<node>, read : () -> kokaine/reactive/effects/signal-read a, walk : forall<e1> (a, (b) -> e1 ()) -> e1 (), key : (b) -> c, compare : (c, c) -> order, item-equals : (b, b) -> bool, children : (item : kokaine/html/accessor<b>, index : kokaine/html/accessor<int>) -> <kokaine/html/html<e>,kokaine/reactive/effects/signal-read> ()) -> <pure,kokaine/reactive/effects/signal-write,ui> () */  {
  ...
  var x_96_12123 = $std_core_hnd._open_at1(0, function(root_5_0 /* kokaine/reactive/root<ui> */ ) {
       
      var x_97_12126 = $kokaine_reactive_integration_internal_lifetime_dash_scope.open_lifetime_scope($std_core_hnd._open_none1(function(value_63 /* kokaine/reactive/root<ui> */ ) {
          return value_63;
        }, root_5_0));
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(_mlift_mount_keyed_fields_11504);
      }
      else {
        return _mlift_mount_keyed_fields_11504(x_97_12126);
      }
    }, root_1_0_6);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(scope_1_0_6 /* kokaine/reactive/integration/lifetime-scope<ui> */ ) {
      return _mlift_mount_keyed_fields_11505(before_0_2, children_1_6, compare_0_6, item_equals_0_6, key_0_6, parent_1_0_6, read_5, renderer_1_6, root_1_0_6, walk_4, scope_1_0_6);
    });
  }
  else {
    ...
    return $std_core_hnd.finally_prompt(function() {
        ...
        if (_x122) {
          ...
          var x_98_12130 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_write_fs__tag);
          if ($std_core_hnd._yielding()) {
            return $std_core_hnd.yield_extend(function(_y_x10641_1 /* hnd/ev-index */ ) {
              return _mlift_mount_keyed_fields_11493(x_96_12123, _y_x10641_1);
            });
          }
          else {
            return _mlift_mount_keyed_fields_11493(x_96_12123, x_98_12130);
          }
        }
      }, $kokaine_reactive_integration.with_lifetime_scope(root_1_0_6, x_96_12123, function() {
           
          var x_99_12132 = $std_core_hnd._open_at1(0, dom_attempt, function() {
              return dom_create_comment("kokaine:for");
            });
          if ($std_core_hnd._yielding()) {
            return $std_core_hnd.yield_extend(function(first_1_0_8 /* node */ ) {
              return _mlift_mount_keyed_fields_11503(before_0_2, children_1_6, committed_1_6, compare_0_6, installed_0_4, item_equals_0_6, key_0_6, parent_1_0_6, range_owned_0_5, read_5, renderer_1_6, root_1_0_6, x_96_12123, walk_4, first_1_0_8);
            });
          }
          else {
            return _mlift_mount_keyed_fields_11503(before_0_2, children_1_6, committed_1_6, compare_0_6, installed_0_4, item_equals_0_6, key_0_6, parent_1_0_6, range_owned_0_5, read_5, renderer_1_6, root_1_0_6, x_96_12123, walk_4, x_99_12132);
          }
        }));
  }
}
...
export function mount_view(renderer_3_7, root_3_0_8, parent_3_0_10, before_1_7, tree_0_0) /* forall<e> (renderer : kokaine/dom/internal/keyed-transaction/keyed-context, root : kokaine/reactive/root<ui>, parent : node, before : maybe<node>, tree : kokaine/html/view<e>) -> <pure,kokaine/reactive/effects/signal-write,ui> () */  {
  if (tree_0_0._tag === 1) {
    ...
    var x_100_12134 = $std_core_hnd._open_at1(0, dom_attempt, function() {
        return dom_create_text(tree_0_0.content);
      });
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(target_20_0 /* node */ ) {
        return _mlift_mount_view_11506(before_1_7, parent_3_0_10, target_20_0);
      });
    }
    else {
      return $std_core_hnd._open_at3(0, insert, parent_3_0_10, before_1_7, x_100_12134);
    }
  }
  else if (tree_0_0._tag === 3) {
     
    var x_101_12137 = $std_core_hnd._open_at1(0, dom_attempt, function() {
        return dom_create_text("");
      });
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(target_0_0_2 /* node */ ) {
        return _mlift_mount_view_11511(before_1_7, parent_3_0_10, tree_0_0.read, root_3_0_8, target_0_0_2);
      });
    }
    else {
       
      var x_102_12140 = $std_core_hnd._open_at3(0, insert, parent_3_0_10, before_1_7, x_101_12137);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(wild___30_1 /* () */ ) {
          return _mlift_mount_view_11510(tree_0_0.read, root_3_0_8, x_101_12137, wild___30_1);
        });
      }
      else {
         
        var x_103_12143 = $kokaine_reactive.create_effect(root_3_0_8, function() {
             
            var x_104_12146 = $std_core_hnd._evv_index($std_core_exn.exn_fs__tag);
            if ($std_core_hnd._yielding()) {
              return $std_core_hnd.yield_extend(function(_y_x10678_1 /* hnd/ev-index */ ) {
                return _mlift_mount_view_11507(tree_0_0.read, _y_x10678_1);
              });
            }
            else {
              return _mlift_mount_view_11507(tree_0_0.read, x_104_12146);
            }
          }, function(value_80_1 /* string */ ) {
             
            var x_105_12148 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_write_fs__tag);
            if ($std_core_hnd._yielding()) {
              return $std_core_hnd.yield_extend(function(_y_x10681_1 /* hnd/ev-index */ ) {
                return _mlift_mount_view_11508(x_101_12137, value_80_1, _y_x10681_1);
              });
            }
            else {
              return _mlift_mount_view_11508(x_101_12137, value_80_1, x_105_12148);
            }
          });
        if ($std_core_hnd._yielding()) {
          return $std_core_hnd.yield_extend(_mlift_mount_view_11509);
    ...
    var _x_x1_3_11324 = $std_core_hnd._open_none1($kokaine_html.is_valid_element_name, tree_0_0.name);
    var _x123 = $std_core_hnd._open_none1(function(b_6 /* bool */ ) {
        return (b_6) ? false : true;
      }, _x_x1_3_11324);
    if (_x123) {
       
      var _x_x1_5_11326 = $std_core_types._lp__plus__plus__rp_("invalid HTML element name: ", tree_0_0.name);
      return $std_core_hnd._open_at2(0, $std_core_exn.$throw, _x_x1_5_11326);
    }
    else {
       
      var x_106_12150 = $std_core_hnd._open_at1(0, dom_attempt, function() {
          return dom_create_element(parent_3_0_10, tree_0_0.name);
        });
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(target_1_0_3 /* element */ ) {
          return _mlift_mount_view_11515(tree_0_0.attributes, before_1_7, tree_0_0.children, parent_3_0_10, renderer_3_7, root_3_0_8, target_1_0_3);
        });
      }
      else {
         
        var x_107_12153 = record_owner(root_3_0_8, $std_core_hnd._open_none1(element_node, x_106_12150));
        if ($std_core_hnd._yielding()) {
          return $std_core_hnd.yield_extend(function(wild___0_2_1 /* () */ ) {
            return _mlift_mount_view_11514(tree_0_0.attributes, before_1_7, tree_0_0.children, parent_3_0_10, renderer_3_7, root_3_0_8, x_106_12150, wild___0_2_1);
          });
        }
        else {
           
          var x_108_12156 = $std_core_list.foreach(tree_0_0.attributes, function(attribute_0 /* kokaine/html/attribute<10906> */ ) {
              return mount_attribute(root_3_0_8, x_106_12150, attribute_0);
            });
          if ($std_core_hnd._yielding()) {
            return $std_core_hnd.yield_extend(function(wild___1_2_1 /* () */ ) {
              return _mlift_mount_view_11513(before_1_7, tree_0_0.children, parent_3_0_10, renderer_3_7, root_3_0_8, x_106_12150, wild___1_2_1);
            });
          }
          else {
             
            var x_109_12159 = $std_core_list.foreach(tree_0_0.children, function(child_1 /* kokaine/html/view<10906> */ ) {
                return mount_view(renderer_3_7, root_3_0_8, $std_core_hnd._open_none1(element_node, x_106_12150), $std_core_types.Nothing, child_1);
              });
            if ($std_core_hnd._yielding()) {
              return $std_core_hnd.yield_extend(function(wild___2_2_1 /* () */ ) {
                return _mlift_mount_view_11512(before_1_7, parent_3_0_10, x_106_12150, wild___2_2_1);
              });
            }
            else {
               
              var _x_x3_1_11333_0 = $std_core_hnd._open_none1(element_node, x_106_12150);
              return $std_core_hnd._open_at3(0, function(parent_8_0 /* node */ , before_2_0 /* maybe<node> */ , child_0_0 /* node */ ) {
                ...
                }, parent_3_0_10, before_1_7, _x_x3_1_11333_0);
            }
          }
        }
      }
    ...
    return $std_core_list.foreach(tree_0_0.children, function(child_0_0_0 /* kokaine/html/view<10906> */ ) {
        return mount_view(renderer_3_7, root_3_0_8, parent_3_0_10, before_1_7, child_0_0_0);
      });
  }
  else if (tree_0_0._tag === 6) {
     
    var x_110_12164 = $std_core_hnd._open_at1(0, dom_attempt, function() {
        return dom_create_comment("kokaine:region");
      });
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(first_2_0_3 /* node */ ) {
        return _mlift_mount_view_11523(before_1_7, parent_3_0_10, tree_0_0.read, renderer_3_7, root_3_0_8, first_2_0_3);
      });
    }
    else {
       
      var x_111_12167 = $std_core_hnd._open_at1(0, dom_attempt, function() {
          return dom_create_comment("/kokaine:region");
        });
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(last_2_0_4 /* node */ ) {
          return _mlift_mount_view_11522(before_1_7, x_110_12164, parent_3_0_10, tree_0_0.read, renderer_3_7, root_3_0_8, last_2_0_4);
        });
      }
      else {
         
        var x_112_12170 = $std_core_hnd._open_at4(0, insert_marker_pair, parent_3_0_10, before_1_7, x_110_12164, x_111_12167);
        if ($std_core_hnd._yielding()) {
          return $std_core_hnd.yield_extend(function(wild___3_2_1 /* () */ ) {
            return _mlift_mount_view_11521(x_110_12164, x_111_12167, parent_3_0_10, tree_0_0.read, renderer_3_7, root_3_0_8, wild___3_2_1);
          });
        }
        else {
           
          var x_113_12173 = $kokaine_reactive.create_effect(root_3_0_8, function() {
               
              var x_114_12176 = $std_core_hnd._evv_index($std_core_exn.exn_fs__tag);
              if ($std_core_hnd._yielding()) {
                return $std_core_hnd.yield_extend(function(_y_x10703_1 /* hnd/ev-index */ ) {
                  return _mlift_mount_view_11516(tree_0_0.read, _y_x10703_1);
                });
              }
              else {
                return _mlift_mount_view_11516(tree_0_0.read, x_114_12176);
              }
            }, function(next_1_2 /* kokaine/html/view<10906> */ ) {
               
              var x_115_12178 = $std_core_hnd._open_at2(0, function(root_7_1 /* kokaine/reactive/root<ui> */ , cleanup_1_0 /* () -> <kokaine/reactive/effects/signal-write,pure,ui> () */ ) {
                   
                  var root_0_10046_1_0 = $std_core_hnd._open_none1(function(value_81_0 /* kokaine/reactive/root<ui> */ ) {
                      return value_81_0;
                    }, root_7_1);
                   
                  var x_116_12180 = $kokaine_reactive_internal_runtime.register_cleanup(root_0_10046_1_0, cleanup_1_0);
                  if ($std_core_hnd._yielding()) {
                    return $std_core_hnd.yield_extend(_mlift_mount_view_11517);
                  }
                  else {
                    return _mlift_mount_view_11517(x_116_12180);
                  }
                }, root_3_0_8, function() {
                   
                  var x_117_12182 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_write_fs__tag);
                  if ($std_core_hnd._yielding()) {
                    return $std_core_hnd.yield_extend(function(_y_x10707_1 /* hnd/ev-index */ ) {
                      return _mlift_mount_view_11518(x_110_12164, x_111_12167, _y_x10707_1);
                    });
                  }
                  else {
                    return _mlift_mount_view_11518(x_110_12164, x_111_12167, x_117_12182);
                  }
                });
              if ($std_core_hnd._yielding()) {
                return $std_core_hnd.yield_extend(function(wild___4_2_1 /* () */ ) {
                  return _mlift_mount_view_11519(x_111_12167, next_1_2, parent_3_0_10, renderer_3_7, root_3_0_8, wild___4_2_1);
                });
              }
              else {
                return _mlift_mount_view_11519(x_111_12167, next_1_2, parent_3_0_10, renderer_3_7, root_3_0_8, x_115_12178);
              }
            });
          if ($std_core_hnd._yielding()) {
            return $std_core_hnd.yield_extend(_mlift_mount_view_11520);
...
// monadic lift
export function _mlift_mount_effect_11524(_y_x10718) /* (hnd/ev-index) -> <exn,div> () */  {
  return $std_core_hnd._mask_at(_y_x10718, false, function() {
      return $std_core_types.Unit;
    });
}
...
// monadic lift
export function _mlift_mount_effect_11525(_y_x10717) /* (hnd/ev-index) -> <kokaine/reactive/effects/signal-read,div,exn> () */  {
  return $std_core_hnd._mask_at(_y_x10717, false, function() {
       
      var x_12185 = $std_core_hnd._evv_index($std_core_exn.exn_fs__tag);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(_mlift_mount_effect_11524);
      }
      else {
        return $std_core_hnd._mask_at(x_12185, false, function() {
            return $std_core_types.Unit;
          });
      }
    });
...
// monadic lift
export function _mlift_mount_effect_11526(_pat_2) /* (kokaine/reactive/internal/model/cleanup-registration<ui>) -> exn () */  {
  return $std_core_types.Unit;
}
 
 
// monadic lift
export function _mlift_mount_effect_11527(first, last, _y_x10728) /* (first : node, last : node, hnd/ev-index) -> <kokaine/reactive/effects/signal-write,div,exn,ui> () */  {
  return $std_core_hnd._mask_at(_y_x10728, false, function() {
...
// monadic lift
export function _mlift_mount_effect_11528(last, parent, renderer, root, tree, wild___0) /* forall<e> (last : node, parent : node, renderer : kokaine/dom/internal/keyed-transaction/keyed-context, root : kokaine/reactive/root<ui>, tree : kokaine/html/view<e>, wild_@0 : ()) -> <exn,div,kokaine/reactive/effects/signal-write,ui> () */  {
  return mount_view(renderer, root, parent, $std_core_types.Just(last), tree);
}
 
 
// monadic lift
export function _mlift_mount_effect_11529(first, last, parent, renderer, root, tree, wild__) /* forall<e> (first : node, last : node, parent : node, renderer : kokaine/dom/internal/keyed-transaction/keyed-context, root : kokaine/reactive/root<ui>, tree : kokaine/html/view<e>, wild_ : ()) -> <exn,ui,div,kokaine/reactive/effects/signal-write> () */  {
   
  var x_12189 = $std_core_hnd._open_at2(0, function(root_0 /* kokaine/reactive/root<ui> */ , cleanup /* () -> <kokaine/reactive/effects/signal-write,pure,ui> () */ ) {
       
      var root_0_10046 = $std_core_hnd._open_none1(function(value /* kokaine/reactive/root<ui> */ ) {
          return value;
        }, root_0);
       
      var x_0_12191 = $kokaine_reactive_internal_runtime.register_cleanup(root_0_10046, cleanup);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(_mlift_mount_effect_11526);
      }
      else {
        return $std_core_types.Unit;
      }
      ...
      var x_1_12193 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_write_fs__tag);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_y_x10728 /* hnd/ev-index */ ) {
          return _mlift_mount_effect_11527(first, last, _y_x10728);
        });
      }
      else {
        return _mlift_mount_effect_11527(first, last, x_1_12193);
      }
    });
   
  function next_12190(wild___0) /* (()) -> <exn,div,kokaine/reactive/effects/signal-write,ui> () */  {
    return mount_view(renderer, root, parent, $std_core_types.Just(last), tree);
  }
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(next_12190);
  }
  else {
    return next_12190(x_12189);
  }
}
 
 
// monadic lift
export function _mlift_mount_effect_11530(first, parent, renderer, root, tree, last) /* forall<e> (first : node, parent : node, renderer : kokaine/dom/internal/keyed-transaction/keyed-context, root : kokaine/reactive/root<ui>, tree : kokaine/html/view<e>, last : node) -> <exn,ui,div,kokaine/reactive/effects/signal-write> () */  {
   
  var x_12201 = $std_core_hnd._open_at4(0, function(parent_0 /* node */ , before /* maybe<node> */ , first_0 /* node */ , last_0 /* node */ ) {
      if (before === null) {
  ...
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(wild__ /* () */ ) {
      return _mlift_mount_effect_11529(first, last, parent, renderer, root, tree, wild__);
    });
  }
  else {
    return _mlift_mount_effect_11529(first, last, parent, renderer, root, tree, x_12201);
  }
}
 
 
// monadic lift
export function _mlift_mount_effect_11531(parent, renderer, root, tree, first) /* forall<e> (parent : node, renderer : kokaine/dom/internal/keyed-transaction/keyed-context, root : kokaine/reactive/root<ui>, tree : kokaine/html/view<e>, first : node) -> <exn,ui,div,kokaine/reactive/effects/signal-write> () */  {
   
  var x_12205 = $std_core_hnd._open_at1(0, dom_attempt, function() {
      return dom_create_comment("/kokaine:mount");
    });
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(last /* node */ ) {
      return _mlift_mount_effect_11530(first, parent, renderer, root, tree, last);
    });
  }
  else {
    return _mlift_mount_effect_11530(first, parent, renderer, root, tree, x_12205);
  }
}
...
export function mount_effect(renderer, root, parent, tree) /* forall<e> (renderer : kokaine/dom/internal/keyed-transaction/keyed-context, root : kokaine/reactive/root<ui>, parent : node, tree : kokaine/html/view<e>) -> <kokaine/reactive/effects/signal-write,ui,pure> kokaine/reactive/disposer<ui> */  {
  return $kokaine_reactive.create_effect(root, function() {
       
      var x_12207 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_read_fs__tag);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(_mlift_mount_effect_11525);
      }
      else {
        return _mlift_mount_effect_11525(x_12207);
      }
    }, function(___wildcard_x1448__40 /* () */ ) {
       
      var x_0_12209 = $std_core_hnd._open_at1(0, dom_attempt, function() {
          return dom_create_comment("kokaine:mount");
        });
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(first /* node */ ) {
          return _mlift_mount_effect_11531(parent, renderer, root, tree, first);
        });
      }
      else {
        return _mlift_mount_effect_11531(parent, renderer, root, tree, x_0_12209);
      }
    });
}
...
// monadic lift
export function _mlift_mount_transaction_11532(pending, dispose_0) /* forall<_e> (pending : ref<global,maybe<() -> <exn,ui> ()>>, dispose@0 : () -> <exn,ui> ()) -> <kokaine/reactive/effects/signal-write,ui,pure> (() -> <exn,ui> ()) */  {
...
// monadic lift
export function _mlift_mount_transaction_11533(register, _y_x10746) /* (register : () -> <div,exn,kokaine/reactive/effects/signal-write,ui> (() -> <exn,ui> ()), hnd/ev-index) -> <kokaine/reactive/effects/signal-read,div,exn,kokaine/reactive/effects/signal-write,ui> (() -> <exn,ui> ()) */  {
  return $std_core_hnd._mask_at(_y_x10746, false, register);
}
 
 
// monadic lift
export function _mlift_mount_transaction_11534(register, root, _y_x10742) /* (register : () -> <div,exn,kokaine/reactive/effects/signal-write,ui> (() -> <exn,ui> ()), root : kokaine/reactive/root<ui>, owner-match) -> <exn,ui> (() -> <exn,ui> ()) */  {
  if (_y_x10742._tag === 1) {
  ...
  else if (_y_x10742._tag === 3) {
    return $std_core_exn.$throw("cannot mount into a retired Kokaine DOM generation");
  }
  else {
    return $kokaine_reactive_integration_internal_reentry.run_reentry($std_core_hnd._open_none1(function(value_0_0 /* kokaine/reactive/integration/reentry<ui> */ ) {
          return value_0_0;
        }, _y_x10742.owner_portal), function() {
         
        var x_12211 = $std_core_hnd._evv_index($kokaine_reactive_effects.signal_read_fs__tag);
        if ($std_core_hnd._yielding()) {
          return $std_core_hnd.yield_extend(function(_y_x10746 /* hnd/ev-index */ ) {
            return $std_core_hnd._mask_at(_y_x10746, false, register);
          });
        }
        else {
          return $std_core_hnd._mask_at(x_12211, false, register);
        }
      });
  }
}
...
// monadic lift
export function _mlift_mount_transaction_11535(committed, _c_x10750) /* forall<_e> (committed : ref<global,bool>, () -> <exn,ui> ()) -> (() -> <exn,ui> ()) */  {
...
// monadic lift
export function _mlift_mount_transaction_11536(inherit_owner, parent, root, tree, wild__) /* forall<_e,_e1,_e2,e3> (inherit-owner : bool, parent : node, root : kokaine/reactive/root<ui>, tree : kokaine/html/view<e3>, wild_ : ()) -> <ui,exn> (() -> <exn,ui> ()) */  {
  ...
  function register() /* () -> <div,exn,kokaine/reactive/effects/signal-write,ui> (() -> <exn,ui> ()) */  {
    ...
    var x_12217 = mount_effect(renderer, root, parent, tree);
     
    function next_12218(dispose_0) /* (kokaine/reactive/disposer<ui>) -> <kokaine/reactive/effects/signal-write,ui,pure> (() -> <exn,ui> ()) */  {
       
      ((pending).value = ($std_core_types.Just(dispose_0)));
      return dispose_0;
    }
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(next_12218);
    }
    else {
      return next_12218(x_12217);
    }
  }
  ...
  if (_x127) {
    ...
    var x_0_12221 = $kokaine_reactive_internal_runtime.update(inner_0, function() {
    ...
    var x_1_12223 = find_owner(root, parent);
    if ($std_core_hnd._yielding()) {
      var x_0_12221 = $std_core_hnd.yield_extend(function(_y_x10742 /* owner-match */ ) {
        return _mlift_mount_transaction_11534(register, root, _y_x10742);
      });
    }
    else {
      var x_0_12221 = _mlift_mount_transaction_11534(register, root, x_1_12223);
    }
  }
  if ($std_core_hnd._yielding()) {
    var _x129 = $std_core_hnd.yield_extend(function(_c_x10750 /* () -> <exn,ui> () */ ) {
...
export function mount_transaction(root, parent, tree, inherit_owner) /* forall<e> (root : kokaine/reactive/root<ui>, parent : node, tree : kokaine/html/view<e>, inherit-owner : bool) -> <ui,exn> kokaine/reactive/disposer<ui> */  {
  ...
  if (_x130) {
    var x_12227 = $std_core_hnd._open_none1(dom_attempt_value, result);
  }
  else {
    var x_12227 = $std_core_exn.$throw($std_core_types._lp__plus__plus__rp_("browser DOM exception: ", $std_core_hnd._open_none1(dom_attempt_message, result)));
  }
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(wild__ /* () */ ) {
      return _mlift_mount_transaction_11536(inherit_owner, parent, root, tree, wild__);
    });
  }
  else {
    ...
    var register = function() {
      ...
      var x_0_12233 = mount_effect(renderer, root, parent, tree);
       
      var next_0_12234 = function(dispose_0 /* () -> <exn,ui> () */ ) {
         
        ((pending).value = ($std_core_types.Just(dispose_0)));
        return dispose_0;
      };
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(next_0_12234);
      }
      else {
        return next_0_12234(x_0_12233);
      }
    };
    ...
    if (_x130) {
      ...
      var x_1_12237 = $kokaine_reactive_internal_runtime.update(inner_0, function() {
      ...
      var x_2_12239 = find_owner(root, parent);
      if ($std_core_hnd._yielding()) {
        var x_1_12237 = $std_core_hnd.yield_extend(function(_y_x10742 /* owner-match */ ) {
          return _mlift_mount_transaction_11534(register, root, _y_x10742);
        });
      }
      else {
        var x_1_12237 = _mlift_mount_transaction_11534(register, root, x_2_12239);
      }
    }
    if ($std_core_hnd._yielding()) {
      var _x132 = $std_core_hnd.yield_extend(function(_c_x10750 /* () -> <exn,ui> () */ ) {
